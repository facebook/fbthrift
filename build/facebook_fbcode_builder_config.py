...
'Facebook-specific additions to the fbcode_builder spec for Thrift'

config = read_fbcode_builder_config('fbcode_builder_config.py')
config['legocastle_opts'] = {
    'alias': 'thrift-oss-builder',
    'oncall': 'thrift_open_source',
    'build_name': 'Open-source build for Thrift',
