...
TEST_F(JSONProtocolTest, writeBool_false) {
  auto expected = "0";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeBool(false); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeBool(false); }));
}

TEST_F(JSONProtocolTest, writeBool_true) {
  auto expected = "1";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeBool(true); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeBool(true); }));
}

TEST_F(JSONProtocolTest, writeByte) {
  auto expected = "17";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeByte(17); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeByte(17); }));
}

TEST_F(JSONProtocolTest, writeI16) {
  auto expected = "1017";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeI16(1017); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeI16(1017); }));
}

TEST_F(JSONProtocolTest, writeI32) {
  auto expected = "100017";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeI32(100017); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeI32(100017); }));
}

TEST_F(JSONProtocolTest, writeI64) {
  auto expected = "5000000017";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeI64(5000000017); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeI64(5000000017); }));
}

TEST_F(JSONProtocolTest, writeDouble) {
  auto expected = "5.25";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeDouble(5.25); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeDouble(5.25); }));
}

TEST_F(JSONProtocolTest, writeFloat) {
  auto expected = "5.25";
  EXPECT_EQ(expected, writing_cpp1([](P1& p) { p.writeFloat(5.25f); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeFloat(5.25f); }));
}

TEST_F(JSONProtocolTest, writeString) {
  auto expected = R"("foobar")";
  EXPECT_EQ(
      expected, writing_cpp1([](P1& p) { p.writeString(string("foobar")); }));
  EXPECT_EQ(
      expected, writing_cpp2([](W2& p) { p.writeString(string("foobar")); }));
  EXPECT_EQ(expected, writing_cpp2([](W2& p) { p.writeString("foobar"); }));
}

TEST_F(JSONProtocolTest, writeBinary) {
  auto expected = R"("Zm9vYmFy")";
  EXPECT_EQ(
      expected, writing_cpp1([](P1& p) { p.writeBinary(string("foobar")); }));
  EXPECT_EQ(
      expected, writing_cpp2([](W2& p) { p.writeBinary(string("foobar")); }));
  EXPECT_EQ(
      expected, writing_cpp2([](W2& p) {
