...
/**
 * AcceptAllAdmissionStrategy always returns a AcceptAllAdmissionController
 * which basically admit all requests.
 * It's a way to disable the admission control mechanism while still using the
 * code.
 */
class AcceptAllAdmissionStrategy : public AdmissionStrategy {
 public:
  AcceptAllAdmissionStrategy()
      : admissionController_(std::make_shared<AcceptAllAdmissionController>()) {
  }
