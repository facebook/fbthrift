...
// create an instance of StreamingRequestCallback class instead of others.
// ThriftClient will handle instances of this class.
class StreamingRequestCallback : public ClientSyncCallback {
 public:
 ...
 public:
  // Even though it is a streaming request, we have various kinds of streaming
  // requests.
  RpcKind kind_;
