...
// This class extends the capabilities of ThriftClient with Streaming Support.
// When we want to add Streaming Support to the core we can just copy paste the
// functions to the parent class.
class RSThriftClient : public ThriftClient {
 public:
  ...
  explicit RSThriftClient(std::shared_ptr<ClientConnectionIf> connection);
  ...
  // The required Input and Output subscribers of the corresponding
  // channel should be set before calling this function.
