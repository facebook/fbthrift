...
cdef extern from "folly/Try.h" namespace "folly":
...
cdef extern from "folly/io/async/EventBase.h" namespace "folly":
    cdef cppclass cFollyEventBase "folly::EventBase":
        void loop() nogil
        void loopForever() nogil
        void terminateLoopSoon() nogil
