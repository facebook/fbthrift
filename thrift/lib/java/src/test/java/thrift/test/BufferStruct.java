...
public class BufferStruct
    implements TBase, java.io.Serializable, Cloneable, Comparable<BufferStruct> {
  private static final TStruct STRUCT_DESC = new TStruct("BufferStruct");
  private static final TField BIN_FIELD_FIELD_DESC = new TField("bin_field", TType.STRING,
      (short) 1);
  private static final TField IOBUF_PTR_FIELD_FIELD_DESC = new TField("iobuf_ptr_field",
      TType.STRING, (short) 2);
  private static final TField IOBUF_FIELD_FIELD_DESC = new TField("iobuf_field", TType.STRING,
      (short) 3);
  ...
  static {
    ...
    tmpMetaDataMap.put(IOBUF_PTR_FIELD,
        new FieldMetaData("iobuf_ptr_field", TFieldRequirementType.DEFAULT,
            new FieldValueMetaData(TType.STRING)));
  ...
  public int compareTo(BufferStruct other) {
    ...
    lastComparison = Boolean.valueOf(isSetIobuf_ptr_field())
        .compareTo(other.isSetIobuf_ptr_field());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    if (this.getBin_field() == null) {
      ...
      for (int i = 0; i < __bin_field_size; i++) {
        ...
        sb.append(Integer.toHexString(this.getBin_field()[i]).length() > 1 ? Integer.toHexString(
            this.getBin_field()[i])
            .substring(Integer.toHexString(this.getBin_field()[i]).length() - 2)
            .toUpperCase() : "0" + Integer.toHexString(this.getBin_field()[i]).toUpperCase());
      }
      if (this.getBin_field().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getIobuf_ptr_field() == null) {
      ...
      for (int i = 0; i < __iobuf_ptr_field_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getIobuf_ptr_field()[i]).length() > 1 ? Integer.toHexString(
                this.getIobuf_ptr_field()[i])
                .substring(Integer.toHexString(this.getIobuf_ptr_field()[i]).length() - 2)
                .toUpperCase() : "0" +
                Integer.toHexString(this.getIobuf_ptr_field()[i]).toUpperCase());
      }
      if (this.getIobuf_ptr_field().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getIobuf_field() == null) {
      ...
      for (int i = 0; i < __iobuf_field_size; i++) {
        ...
        sb.append(Integer.toHexString(this.getIobuf_field()[i]).length() > 1 ? Integer.toHexString(
            this.getIobuf_field()[i])
            .substring(Integer.toHexString(this.getIobuf_field()[i]).length() - 2)
            .toUpperCase() : "0" + Integer.toHexString(this.getIobuf_field()[i]).toUpperCase());
      }
      if (this.getIobuf_field().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
