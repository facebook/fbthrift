...
public class TestUnion extends TUnion<TestUnion> implements Comparable<TestUnion> {
  ...
  private static final TField STRUCT_FIELD_FIELD_DESC = new TField("struct_field", TType.STRUCT,
      (short) 3);
  private static final TField STRUCT_LIST_FIELD_DESC = new TField("struct_list", TType.LIST,
      (short) 4);
  private static final TField OTHER_I32_FIELD_FIELD_DESC = new TField("other_i32_field", TType.I32,
      (short) 5);
  ...
  static {
    ...
    tmpMetaDataMap.put(STRUCT_FIELD,
        new FieldMetaData("struct_field", TFieldRequirementType.DEFAULT,
    ...
    tmpMetaDataMap.put(OTHER_I32_FIELD,
        new FieldMetaData("other_i32_field", TFieldRequirementType.DEFAULT,
            new FieldValueMetaData(TType.I32)));
    ...
    switch (setField) {
      case STRING_FIELD:
        ...
        throw new ClassCastException(
            "Was expecting value of type String for field 'string_field', but got " +
      ...
      case I32_FIELD:
        ...
        throw new ClassCastException(
            "Was expecting value of type Integer for field 'i32_field', but got " +
                value.getClass().getSimpleName());
      case STRUCT_FIELD:
        ...
        throw new ClassCastException(
            "Was expecting value of type OneOfEach for field 'struct_field', but got " +
                value.getClass().getSimpleName());
      case STRUCT_LIST:
        ...
        throw new ClassCastException(
            "Was expecting value of type List<RandomStuff> for field 'struct_list', but got " +
                value.getClass().getSimpleName());
      case OTHER_I32_FIELD:
        ...
        throw new ClassCastException(
            "Was expecting value of type Integer for field 'other_i32_field', but got " +
                value.getClass().getSimpleName());
      default:
  ...
  public String getString_field() {
    if (getSetField() == STRING_FIELD) {
      ...
      throw new RuntimeException(
          "Cannot get field 'string_field' because union is currently set to " +
  ...
  public int getI32_field() {
    if (getSetField() == I32_FIELD) {
      ...
      throw new RuntimeException("Cannot get field 'i32_field' because union is currently set to " +
          getFieldDesc(getSetField()).name);
    }
  }
  ...
  public OneOfEach getStruct_field() {
    if (getSetField() == STRUCT_FIELD) {
      ...
      throw new RuntimeException(
          "Cannot get field 'struct_field' because union is currently set to " +
              getFieldDesc(getSetField()).name);
    }
  }
  ...
  public List<RandomStuff> getStruct_list() {
    if (getSetField() == STRUCT_LIST) {
      ...
      throw new RuntimeException(
          "Cannot get field 'struct_list' because union is currently set to " +
              getFieldDesc(getSetField()).name);
    }
  }
  ...
  public int getOther_i32_field() {
    if (getSetField() == OTHER_I32_FIELD) {
      ...
      throw new RuntimeException(
          "Cannot get field 'other_i32_field' because union is currently set to " +
              getFieldDesc(getSetField()).name);
    }
  }
