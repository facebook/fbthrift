...
public class ReverseOrderService {
  ...
  public static class Client extends EventHandlerBase implements Iface, TClientIf {
    ...
    public void send_myMethod(String first, short second, int third, long fourth)
        throws TException {
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void myMethod(String first,
        ...
        int third,
        long fourth,
        AsyncMethodCallback resultHandler593) throws TException {
      checkReady();
      myMethod_call method_call = new myMethod_call(first, second, third, fourth, resultHandler593,
    ...
    public static class myMethod_call extends TAsyncMethodCall {
      ...
      public myMethod_call(String first,
          short second,
          int third,
          long fourth,
          AsyncMethodCallback resultHandler594,
          TAsyncClient client590,
          TProtocolFactory protocolFactory591,
          TNonblockingTransport transport592) throws TException {
  ...
  public static class myMethod_args
      implements TBase, java.io.Serializable, Cloneable, Comparable<myMethod_args> {
  ...
  public static class myMethod_result
      implements TBase, java.io.Serializable, Cloneable, Comparable<myMethod_result> {
