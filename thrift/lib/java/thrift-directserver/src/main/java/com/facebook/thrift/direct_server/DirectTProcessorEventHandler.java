 ...
 *
 * <p>Implement automatic fb303 counters for java thrift service.
 *
...
public class DirectTProcessorEventHandler extends TProcessorEventHandler {

  protected FacebookBase handler_;

  private static class TStat {
    ...
    TStat(FacebookBase h, String fn_name) {
      ...
      bytesWritten_ = new MovingAvgStat(h, fn_name + ".bytes_written", numCalls_);

      timeProcess_ = new MovingAvgStat(h, fn_name + ".time_process_us", numCalls_);
    }
  };
  ...
  public void preRead(Object handler_context, String fn_name) throws TException {
    ...
    if (stats.cxt_ != null) {
      TDirectBufferProtocol p = (TDirectBufferProtocol) stats.cxt_.getInputProtocol();
  ...
  @Override
  public void handlerError(Object handler_context, String fn_name, Throwable ex) throws TException {
