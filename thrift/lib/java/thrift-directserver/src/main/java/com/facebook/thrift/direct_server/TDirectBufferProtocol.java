 ...
 *
 * <p>Class TDirectBufferProtocol extends TBinaryBufferProtocol class so that we can take the full
 * benefits of direct buffer.
 *
...
public class TDirectBufferProtocol extends TBinaryProtocol {
  private static Logger LOG = LoggerFactory.getLogger(TDirectBufferProtocol.class);
