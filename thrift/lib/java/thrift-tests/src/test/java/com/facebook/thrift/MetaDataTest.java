...
public class MetaDataTest {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (!mdMap.containsKey(CrazyNesting.SET_FIELD)
        || !mdMap.containsKey(CrazyNesting.LIST_FIELD)
        || !mdMap.containsKey(CrazyNesting.STRING_FIELD))
    ...
    if (((MapMetaData)
                ((ListMetaData)
                        ((SetMetaData)
                                ((MapMetaData)
                                        ((MapMetaData)
                                                ((ListMetaData)
                                                        mdMap.get(CrazyNesting.LIST_FIELD)
                                                            .valueMetaData)
                                                    .elemMetaData)
                                            .valueMetaData)
                                    .valueMetaData)
      ...
      throw new RuntimeException(
          "metadata map contains wrong type for a value in a deeply nested structure");
    if (((StructMetaData)
                ((MapMetaData)
                        ((ListMetaData)
                                ((SetMetaData)
        ...
        != Insanity.class)
      throw new RuntimeException(
          "metadata map contains wrong class for a struct in a deeply nested structure");
