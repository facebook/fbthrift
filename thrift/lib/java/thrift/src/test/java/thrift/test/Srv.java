...
public class Srv {
  ...
  public static class Client extends EventHandlerBase implements Iface, TClientIf {
    ...
    public int recv_primitiveMethod() throws TException {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
          "primitiveMethod failed: unknown result");
    }
    ...
    public CompactProtoTestStruct recv_structMethod() throws TException {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
          "structMethod failed: unknown result");
    }
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void Janky(int arg, AsyncMethodCallback resultHandler566) throws TException {
      checkReady();
      Janky_call method_call = new Janky_call(arg, resultHandler566, this, ___protocolFactory,
          ___transport);
    ...
    public static class Janky_call extends TAsyncMethodCall {
      ...
      public Janky_call(int arg,
          AsyncMethodCallback resultHandler567,
          TAsyncClient client563,
          TProtocolFactory protocolFactory564,
          TNonblockingTransport transport565) throws TException {
    ...
    public void voidMethod(AsyncMethodCallback resultHandler571) throws TException {
      checkReady();
      voidMethod_call method_call = new voidMethod_call(resultHandler571, this, ___protocolFactory,
          ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class voidMethod_call extends TAsyncMethodCall {
      public voidMethod_call(AsyncMethodCallback resultHandler572,
          TAsyncClient client568,
          TProtocolFactory protocolFactory569,
          TNonblockingTransport transport570) throws TException {
    ...
    public void primitiveMethod(AsyncMethodCallback resultHandler576) throws TException {
      checkReady();
      primitiveMethod_call method_call = new primitiveMethod_call(resultHandler576, this,
    ...
    public static class primitiveMethod_call extends TAsyncMethodCall {
      public primitiveMethod_call(AsyncMethodCallback resultHandler577,
          TAsyncClient client573,
          TProtocolFactory protocolFactory574,
          TNonblockingTransport transport575) throws TException {
    ...
    public void structMethod(AsyncMethodCallback resultHandler581) throws TException {
      checkReady();
      structMethod_call method_call = new structMethod_call(resultHandler581, this,
          ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class structMethod_call extends TAsyncMethodCall {
      public structMethod_call(AsyncMethodCallback resultHandler582,
          TAsyncClient client578,
          TProtocolFactory protocolFactory579,
          TNonblockingTransport transport580) throws TException {
  ...
  public static class Janky_args
      implements TBase, java.io.Serializable, Cloneable, Comparable<Janky_args> {
  ...
  public static class Janky_result
      implements TBase, java.io.Serializable, Cloneable, Comparable<Janky_result> {
  ...
  public static class voidMethod_args
      implements TBase, java.io.Serializable, Cloneable, Comparable<voidMethod_args> {
  ...
  public static class voidMethod_result
      implements TBase, java.io.Serializable, Cloneable, Comparable<voidMethod_result> {
  ...
  public static class primitiveMethod_args
      implements TBase, java.io.Serializable, Cloneable, Comparable<primitiveMethod_args> {
  ...
  public static class primitiveMethod_result
      implements TBase, java.io.Serializable, Cloneable, Comparable<primitiveMethod_result> {
  ...
  public static class structMethod_args
      implements TBase, java.io.Serializable, Cloneable, Comparable<structMethod_args> {
  ...
  public static class structMethod_result
      implements TBase, java.io.Serializable, Cloneable, Comparable<structMethod_result> {
