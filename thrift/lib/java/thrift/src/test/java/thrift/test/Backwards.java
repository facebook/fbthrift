...
public class Backwards implements TBase, java.io.Serializable, Cloneable, Comparable<Backwards> {
  ...
  private static final TField FIRST_TAG2_FIELD_DESC = new TField("first_tag2", TType.I32,
      (short) 2);
  private static final TField SECOND_TAG1_FIELD_DESC = new TField("second_tag1", TType.I32,
      (short) 1);
