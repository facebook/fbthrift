...
public class Inherited {
  ...
  public static class Client extends Srv.Client implements Iface, TClientIf {
    ...
    public int recv_identity() throws TException {
      ...
      throw new TApplicationException(TApplicationException.MISSING_RESULT,
          "identity failed: unknown result");
    }
  ...
  public static class AsyncClient extends Srv.AsyncClient implements AsyncIface {
    ...
    public void identity(int arg, AsyncMethodCallback resultHandler587) throws TException {
      checkReady();
      identity_call method_call = new identity_call(arg, resultHandler587, this, ___protocolFactory,
          ___transport);
    ...
    public static class identity_call extends TAsyncMethodCall {
      ...
      public identity_call(int arg,
          AsyncMethodCallback resultHandler588,
          TAsyncClient client584,
          TProtocolFactory protocolFactory585,
          TNonblockingTransport transport586) throws TException {
  ...
  public static class identity_args
      implements TBase, java.io.Serializable, Cloneable, Comparable<identity_args> {
  ...
  public static class identity_result
      implements TBase, java.io.Serializable, Cloneable, Comparable<identity_result> {
