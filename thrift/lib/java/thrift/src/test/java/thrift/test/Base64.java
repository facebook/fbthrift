  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    if (this.getB1() == null) {
      ...
      for (int i = 0; i < __b1_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getB1()[i]).length() > 1 ? Integer.toHexString(this.getB1()[i])
                .substring(Integer.toHexString(this.getB1()[i]).length() - 2)
                .toUpperCase() : "0" + Integer.toHexString(this.getB1()[i]).toUpperCase());
      }
      if (this.getB1().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getB2() == null) {
      ...
      for (int i = 0; i < __b2_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getB2()[i]).length() > 1 ? Integer.toHexString(this.getB2()[i])
                .substring(Integer.toHexString(this.getB2()[i]).length() - 2)
                .toUpperCase() : "0" + Integer.toHexString(this.getB2()[i]).toUpperCase());
      }
      if (this.getB2().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getB3() == null) {
      ...
      for (int i = 0; i < __b3_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getB3()[i]).length() > 1 ? Integer.toHexString(this.getB3()[i])
                .substring(Integer.toHexString(this.getB3()[i]).length() - 2)
                .toUpperCase() : "0" + Integer.toHexString(this.getB3()[i]).toUpperCase());
      }
      if (this.getB3().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getB4() == null) {
      ...
      for (int i = 0; i < __b4_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getB4()[i]).length() > 1 ? Integer.toHexString(this.getB4()[i])
                .substring(Integer.toHexString(this.getB4()[i]).length() - 2)
                .toUpperCase() : "0" + Integer.toHexString(this.getB4()[i]).toUpperCase());
      }
      if (this.getB4().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getB5() == null) {
      ...
      for (int i = 0; i < __b5_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getB5()[i]).length() > 1 ? Integer.toHexString(this.getB5()[i])
                .substring(Integer.toHexString(this.getB5()[i]).length() - 2)
                .toUpperCase() : "0" + Integer.toHexString(this.getB5()[i]).toUpperCase());
      }
      if (this.getB5().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getB6() == null) {
      ...
      for (int i = 0; i < __b6_size; i++) {
        ...
        sb.append(
            Integer.toHexString(this.getB6()[i]).length() > 1 ? Integer.toHexString(this.getB6()[i])
                .substring(Integer.toHexString(this.getB6()[i]).length() - 2)
                .toUpperCase() : "0" + Integer.toHexString(this.getB6()[i]).toUpperCase());
      }
      if (this.getB6().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
