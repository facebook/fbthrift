...
public class OneOfEach implements TBase, java.io.Serializable, Cloneable, Comparable<OneOfEach> {
  ...
  private static final TField DOUBLE_PRECISION_FIELD_DESC = new TField("double_precision",
      TType.DOUBLE, (short) 7);
  private static final TField SOME_CHARACTERS_FIELD_DESC = new TField("some_characters",
      TType.STRING, (short) 8);
  private static final TField ZOMG_UNICODE_FIELD_DESC = new TField("zomg_unicode", TType.STRING,
      (short) 9);
  ...
  private static final TField STRING_STRING_MAP_FIELD_DESC = new TField("string_string_map",
      TType.MAP, (short) 15);
  private static final TField STRING_STRING_HASH_MAP_FIELD_DESC = new TField(
      "string_string_hash_map", TType.MAP, (short) 16);
  private static final TField FLOAT_PRECISION_FIELD_DESC = new TField("float_precision",
      TType.FLOAT, (short) 17);
  private static final TField RANK_MAP_FIELD_DESC = new TField("rank_map", TType.MAP, (short) 18);
  private static final TField TWO_INTS_UNINIT_FIELD_DESC = new TField("two_ints_uninit",
      TType.STRUCT, (short) 19);
  private static final TField TWO_INTS_INIT_FIELD_DESC = new TField("two_ints_init", TType.STRUCT,
      (short) 20);
  private static final TField LIST_TWO_INTS_UNINIT_FIELD_DESC = new TField("list_two_ints_uninit",
      TType.LIST, (short) 21);
  private static final TField LIST_TWO_INTS_INIT_DEFAULT_FIELD_DESC = new TField(
      "list_two_ints_init_default", TType.LIST, (short) 22);
  private static final TField LIST_TWO_INTS_INIT_EXPLICIT_FIELD_DESC = new TField(
      "list_two_ints_init_explicit", TType.LIST, (short) 23);
  ...
  static {
    ...
    tmpMetaDataMap.put(DOUBLE_PRECISION,
        new FieldMetaData("double_precision", TFieldRequirementType.DEFAULT,
            new FieldValueMetaData(TType.DOUBLE)));
    tmpMetaDataMap.put(SOME_CHARACTERS,
        new FieldMetaData("some_characters", TFieldRequirementType.DEFAULT,
            new FieldValueMetaData(TType.STRING)));
    tmpMetaDataMap.put(ZOMG_UNICODE,
        new FieldMetaData("zomg_unicode", TFieldRequirementType.DEFAULT,
            new FieldValueMetaData(TType.STRING)));
    ...
    tmpMetaDataMap.put(I64_LIST, new FieldMetaData("i64_list", TFieldRequirementType.DEFAULT,
        new ListMetaData(TType.LIST,
            new FieldValueMetaData(TType.I64))));
    tmpMetaDataMap.put(STRING_STRING_MAP,
        new FieldMetaData("string_string_map", TFieldRequirementType.DEFAULT,
            new MapMetaData(TType.MAP,
                new FieldValueMetaData(TType.STRING),
                new FieldValueMetaData(TType.STRING))));
    tmpMetaDataMap.put(STRING_STRING_HASH_MAP,
        new FieldMetaData("string_string_hash_map", TFieldRequirementType.DEFAULT,
            new MapMetaData(TType.MAP,
                new FieldValueMetaData(TType.STRING),
                new FieldValueMetaData(TType.STRING))));
    tmpMetaDataMap.put(FLOAT_PRECISION,
        new FieldMetaData("float_precision", TFieldRequirementType.DEFAULT,
            new FieldValueMetaData(TType.FLOAT)));
    tmpMetaDataMap.put(RANK_MAP, new FieldMetaData("rank_map", TFieldRequirementType.DEFAULT,
        new MapMetaData(TType.MAP,
            new FieldValueMetaData(TType.I64),
            new FieldValueMetaData(TType.FLOAT))));
    tmpMetaDataMap.put(TWO_INTS_UNINIT,
        new FieldMetaData("two_ints_uninit", TFieldRequirementType.DEFAULT,
            new StructMetaData(TType.STRUCT, TwoInts.class)));
    tmpMetaDataMap.put(TWO_INTS_INIT,
        new FieldMetaData("two_ints_init", TFieldRequirementType.DEFAULT,
            new StructMetaData(TType.STRUCT, TwoInts.class)));
    tmpMetaDataMap.put(LIST_TWO_INTS_UNINIT,
        new FieldMetaData("list_two_ints_uninit", TFieldRequirementType.DEFAULT,
            new ListMetaData(TType.LIST,
                new StructMetaData(TType.STRUCT, TwoInts.class))));
    tmpMetaDataMap.put(LIST_TWO_INTS_INIT_DEFAULT,
        new FieldMetaData("list_two_ints_init_default", TFieldRequirementType.DEFAULT,
            new ListMetaData(TType.LIST,
                new StructMetaData(TType.STRUCT, TwoInts.class))));
    tmpMetaDataMap.put(LIST_TWO_INTS_INIT_EXPLICIT,
        new FieldMetaData("list_two_ints_init_explicit", TFieldRequirementType.DEFAULT,
            new ListMetaData(TType.LIST,
                new StructMetaData(TType.STRUCT, TwoInts.class))));
  ...
  public boolean equals(OneOfEach that) {
    ...
    boolean this_present_list_two_ints_init_default = true &&
        this.isSetList_two_ints_init_default();
    boolean that_present_list_two_ints_init_default = true &&
        that.isSetList_two_ints_init_default();
    if (this_present_list_two_ints_init_default || that_present_list_two_ints_init_default) {
      if (!(this_present_list_two_ints_init_default && that_present_list_two_ints_init_default)) {
        return false;
      }
      if (!TBaseHelper.equalsNobinary(this.list_two_ints_init_default,
          that.list_two_ints_init_default)) {
        return false;
      }
    }

    boolean this_present_list_two_ints_init_explicit = true &&
        this.isSetList_two_ints_init_explicit();
    boolean that_present_list_two_ints_init_explicit = true &&
        that.isSetList_two_ints_init_explicit();
    if (this_present_list_two_ints_init_explicit || that_present_list_two_ints_init_explicit) {
      if (!(this_present_list_two_ints_init_explicit && that_present_list_two_ints_init_explicit)) {
        return false;
      }
      if (!TBaseHelper.equalsNobinary(this.list_two_ints_init_explicit,
          that.list_two_ints_init_explicit)) {
        return false;
      }
    }
  ...
  public int compareTo(OneOfEach other) {
    ...
    lastComparison = Boolean.valueOf(isSetDouble_precision())
        .compareTo(other.isSetDouble_precision());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSome_characters())
        .compareTo(other.isSetSome_characters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetString_string_map())
        .compareTo(other.isSetString_string_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetString_string_hash_map())
        .compareTo(other.isSetString_string_hash_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetFloat_precision())
        .compareTo(other.isSetFloat_precision());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetTwo_ints_uninit())
        .compareTo(other.isSetTwo_ints_uninit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetList_two_ints_uninit())
        .compareTo(other.isSetList_two_ints_uninit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetList_two_ints_init_default())
        .compareTo(other.isSetList_two_ints_init_default());
    if (lastComparison != 0) {
      return lastComparison;
    }
    lastComparison = TBaseHelper.compareTo(list_two_ints_init_default,
        other.list_two_ints_init_default);
    if (lastComparison != 0) {
      return lastComparison;
    }
    lastComparison = Boolean.valueOf(isSetList_two_ints_init_explicit())
        .compareTo(other.isSetList_two_ints_init_explicit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    lastComparison = TBaseHelper.compareTo(list_two_ints_init_explicit,
        other.list_two_ints_init_explicit);
    if (lastComparison != 0) {
      return lastComparison;
    }
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.string_string_hash_map = new HashMap<String, String>(
                  Math.max(0, 2 * _map90.size));
              for (int _i91 = 0;
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.string_string_hash_map != null) {
      ...
      {
        oprot.writeMapBegin(
            new TMap(TType.STRING, TType.STRING, this.string_string_hash_map.size()));
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    if (this.getBase64() == null) {
      ...
      for (int i = 0; i < __base64_size; i++) {
        ...
        sb.append(Integer.toHexString(this.getBase64()[i]).length() > 1 ? Integer.toHexString(
            this.getBase64()[i])
            .substring(Integer.toHexString(this.getBase64()[i]).length() - 2)
            .toUpperCase() : "0" + Integer.toHexString(this.getBase64()[i]).toUpperCase());
      }
      if (this.getBase64().length > 128) {
        sb.append(" ...");
      }
    }
    first = false;
    ...
    if (this.getList_two_ints_init_default() == null) {
      ...
      sb.append(
          TBaseHelper.toString(this.getList_two_ints_init_default(), indent + 1, prettyPrint));
    }
    first = false;
    if (!first) {
      sb.append("," + newLine);
    ...
    if (this.getList_two_ints_init_explicit() == null) {
      ...
      sb.append(
          TBaseHelper.toString(this.getList_two_ints_init_explicit(), indent + 1, prettyPrint));
    }
    first = false;
    if (!first) {
      sb.append("," + newLine);
