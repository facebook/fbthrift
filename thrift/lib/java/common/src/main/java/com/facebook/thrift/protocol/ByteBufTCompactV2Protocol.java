...
/** Implementation of Compact serialization V2 */
@NotThreadSafe
final class ByteBufTCompactV2Protocol extends ByteBufTProtocol {
   ...
   * delta stuff.
   */
  private final ArrayDeque<Short> lastField = new ArrayDeque<>();
   ...
   * incorporated.
   */
  private TField booleanField = null;

  private TField terseField = null;
  /**
   ...
   */
  public void writeFieldBegin(TField field, boolean terse) throws TException {
    if (terse) {
      terseField = field;
  ...
  private void writeFieldBeginInternal(TField field, byte typeOverride) throws TException {
    ...
    if (field.id > lastFieldId && field.id - lastFieldId <= 15) {
      // write them together
      byteBuf.writeByte((field.id - lastFieldId) << 4 | typeToWrite);
    } else {
      // write them separate
  ...
  public void writeMapBegin(TMap map) throws TException {
    if (map.size == 0) {
      ...
      if (terseField != null) {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
      }
  ...
  public void writeBool(boolean b) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(b)) {
        return;
      } else {
        booleanField = terseField;
        terseField = null;
      }
    }
    ...
    if (booleanField != null) {
      ...
      writeFieldBeginInternal(booleanField, b ? BOOLEAN_TRUE : BOOLEAN_FALSE);
      booleanField = null;
    } else {
  ...
  public void writeI16(short i16) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(i16)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
  ...
  public void writeI32(int i32) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(i32)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
  ...
  public void writeI64(long i64) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(i64)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
  ...
  public void writeString(String str) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(str)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
  ...
  public void writeFloat(float flt) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(flt)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
  ...
  public void writeDouble(double dub) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(dub)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
  ...
  public void writeBinary(ByteBuffer bin) throws TException {
    if (isTerse()) {
      if (IntrinsicDefaults.isDefault(bin)) {
        return;
      } else {
        writeFieldBeginInternal(terseField, (byte) -1);
        terseField = null;
