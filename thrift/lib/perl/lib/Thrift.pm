...
sub to_string {
  my $self = shift;
  # not all thrift exceptions do something useful with the code,
  # some leave it undef, which is perfectly kosher to perl, until
  # you try to stringify it.
  if(defined $self->{code}) {
    return ref($self) . ": $self->{message} ($self->{code})";
  } else {
