      ...
      case apache::thrift::protocol::T_MAP:
        {
          ...
          uint32_t i, size;
          bool sizeUnknown;
          piprot_->readMapBegin(keyType, valType, size, sizeUnknown);
          if (print_) {
            printf("{");
          }
          if (!sizeUnknown) {
      ...
      case apache::thrift::protocol::T_SET:
        {
          ...
          uint32_t i, size;
          bool sizeUnknown;
          piprot_->readSetBegin(elemType, size, sizeUnknown);
          if (print_) {
            printf("{");
          }
          if (!sizeUnknown) {
      ...
      case apache::thrift::protocol::T_LIST:
        {
          ...
          uint32_t i, size;
          bool sizeUnknown;
          piprot_->readListBegin(elemType, size, sizeUnknown);
          if (print_) {
            printf("[");
          }
          if (!sizeUnknown) {
