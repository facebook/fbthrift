...
class TEventServer : public apache::thrift::server::TServer {
 ...
 private:
  ...
  /**
   * Create and return a default thread factory
   */
  static std::shared_ptr<concurrency::ThreadFactory>
  ...
  */
  ...
  TEventServer(std::shared_ptr<AsyncProcessor> processor,
               int port,
    ...
    apache::thrift::server::TServer(std::shared_ptr<TProcessor>()),
  ...
  */
  ...
  TEventServer(std::shared_ptr<AsyncProcessor> processor,
    ...
    setDuplexProtocolFactory(
      std::shared_ptr<TDualProtocolFactory>(
  ...
  */
  ...
  TEventServer(
      ...
      std::shared_ptr<apache::thrift::protocol::TDuplexProtocolFactory>
  ...
  */
  ...
  TEventServer(
      ...
      std::shared_ptr<apache::thrift::protocol::TProtocolFactory>
       protocolFactory,
      int port,
      std::shared_ptr<concurrency::ThreadManager> const& threadManager =
  ...
  */
   ...
   */
  std::shared_ptr<TAsyncProcessorFactory> getAsyncProcessorFactory() const {
   ...
   */
  void setAsyncProcessorFactory(std::shared_ptr<TAsyncProcessorFactory> pf) {
  ...
  */
   ...
   */
  void setThreadManager(std::shared_ptr<concurrency::ThreadManager>
                        threadManager) {
  ...
  /**
   * Call this to initialize workers
   */
  void setupWorkers();

  /**
   * Call this to initialize server socket
   */
   ...
   *         getConnectionContext() may return nullptr when invoked after
