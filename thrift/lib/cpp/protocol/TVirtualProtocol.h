...
class TProtocolDefaults : public TProtocol {
 ...
 protected:
  TProtocolDefaults(const std::shared_ptr<transport::TTransport>& ptrans)
    : TProtocol(ptrans)
  {}
...
class TVirtualProtocol : public Super_ {
 public:
  ...
  ::apache::thrift::reflection::Schema * getSchema_virt() {
  ...
  virtual void setNextStructType_virt(uint64_t reflection_id) {
 ...
 protected:
  TVirtualProtocol(const std::shared_ptr<transport::TTransport>& ptrans)
    : Super_(ptrans)
  {}
