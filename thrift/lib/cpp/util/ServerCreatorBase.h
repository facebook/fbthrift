...
class ServerCreatorBase : public ServerCreator {
 public:
  ...
  void setServerEventHandler(
      const std::shared_ptr<server::TServerEventHandler>& eventHandler) {
   ...
   */
  void setProtocolFactory(const std::shared_ptr<protocol::TProtocolFactory>&);
  ...
  void setDuplexProtocolFactory(
    const std::shared_ptr<protocol::TDuplexProtocolFactory>&);
 ...
 protected:
   ...
   */
  virtual void configureServer(const std::shared_ptr<server::TServer>& srv);
   ...
   * Subclasses should call this method in createServer().
   */
  virtual std::shared_ptr<protocol::TProtocolFactory> getProtocolFactory();

  virtual std::shared_ptr<protocol::TDuplexProtocolFactory>
  ...
  std::shared_ptr<server::TServerEventHandler> serverEventHandler_;
  std::shared_ptr<protocol::TProtocolFactory> protocolFactory_;
  std::shared_ptr<protocol::TDuplexProtocolFactory> duplexProtocolFactory_;
};
