...
class SyncServerCreator : public ServerCreatorBase {
 public:
   ...
   */
  SyncServerCreator(const std::shared_ptr<TProcessor>& processor,
  ...
  void setTransportFactory(
      const std::shared_ptr<transport::TTransportFactory>& tf) {
  ...
  void setDuplexTransportFactory(
      const std::shared_ptr<transport::TDuplexTransportFactory>& tf) {
   ...
   */
  std::shared_ptr<transport::TDuplexTransportFactory> getDuplexTransportFactory();
  /**
   * Create a new server.
   */
 ...
 protected:
  ...
  std::shared_ptr<transport::TServerSocket> createServerSocket();
  ...
  std::shared_ptr<transport::TTransportFactory> transportFactory_;
  std::shared_ptr<transport::TDuplexTransportFactory> duplexTransportFactory_;
};
