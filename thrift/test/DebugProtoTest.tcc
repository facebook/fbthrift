...
// This file gets included (repeatedly) from DebugProtoTest.cpp

{
  ...
  cout << "--- const1" << endl;
  cout << X_PRINT(X_NS DebugProtoTest_constants::const1()) << endl << endl;
  cout << "--- const2" << endl;
  cout << X_PRINT(X_NS DebugProtoTest_constants::const2()) << endl << endl;
  ...
  cout << X_PRINT(hm) << endl << endl;

  X_NS TestUnion u;
  u.set_struct_field(std::move(ooe));
  cout << X_PRINT(u) << endl << endl;
}
