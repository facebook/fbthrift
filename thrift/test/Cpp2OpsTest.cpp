...
TYPED_TEST_P(Cpp2OpsTest, Simple) {
  ...
  uint32_t size;
  {
    ...
    TypeParam obj;
    obj.num = cpp2::g_Cpp2OpsCompat_constants.num_test_value;
    obj.str = cpp2::g_Cpp2OpsCompat_constants.str_test_value;
...

  {
    ...
    EXPECT_EQ(cpp2::g_Cpp2OpsCompat_constants.num_test_value, obj.num);
    EXPECT_EQ(cpp2::g_Cpp2OpsCompat_constants.str_test_value, obj.str);
  }
}
