 ...
 */
string t_java_generator::base_type_name(
...
void t_java_generator::generate_java_doc(ofstream& out, t_field* field) {
 ...
 */
void t_java_generator::generate_java_doc(ofstream& out, t_function* tfunction) {
