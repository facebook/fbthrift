...
func (p *RaiserDoRaiseResultBuilder) B(b *Banal) *RaiserDoRaiseResultBuilder {
  p.obj.B = b
  return p
}

func (p *RaiserDoRaiseResultBuilder) F(f *Fiery) *RaiserDoRaiseResultBuilder {
  p.obj.F = f
  return p
}

func (p *RaiserDoRaiseResultBuilder) S(s *Serious) *RaiserDoRaiseResultBuilder {
  p.obj.S = s
  return p
}

func (p *RaiserDoRaiseResult) SetB(b *Banal) *RaiserDoRaiseResult {
  p.B = b
  return p
}

func (p *RaiserDoRaiseResult) SetF(f *Fiery) *RaiserDoRaiseResult {
  p.F = f
  return p
}

func (p *RaiserDoRaiseResult) SetS(s *Serious) *RaiserDoRaiseResult {
  p.S = s
  return p
}
...
func (p *RaiserGet200ResultBuilder) Success(success *string) *RaiserGet200ResultBuilder {
  p.obj.Success = success
  return p
}

func (p *RaiserGet200Result) SetSuccess(success *string) *RaiserGet200Result {
  p.Success = success
  return p
}
...
func (p *RaiserGet500ResultBuilder) Success(success *string) *RaiserGet500ResultBuilder {
  p.obj.Success = success
  return p
}

func (p *RaiserGet500ResultBuilder) F(f *Fiery) *RaiserGet500ResultBuilder {
  p.obj.F = f
  return p
}

func (p *RaiserGet500ResultBuilder) B(b *Banal) *RaiserGet500ResultBuilder {
  p.obj.B = b
  return p
}

func (p *RaiserGet500ResultBuilder) S(s *Serious) *RaiserGet500ResultBuilder {
  p.obj.S = s
  return p
}

func (p *RaiserGet500Result) SetSuccess(success *string) *RaiserGet500Result {
  p.Success = success
  return p
}

func (p *RaiserGet500Result) SetF(f *Fiery) *RaiserGet500Result {
  p.F = f
  return p
}

func (p *RaiserGet500Result) SetB(b *Banal) *RaiserGet500Result {
  p.B = b
  return p
}

func (p *RaiserGet500Result) SetS(s *Serious) *RaiserGet500Result {
  p.S = s
  return p
}
