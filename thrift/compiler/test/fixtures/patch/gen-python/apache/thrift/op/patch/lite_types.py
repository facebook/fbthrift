...
def _fbthrift_metadata__struct_GeneratePatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_GeneratePatch()
def _fbthrift_metadata__struct_GenerateOptionalPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_GenerateOptionalPatch()
def _fbthrift_metadata__struct_BoolPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_BoolPatch()
def _fbthrift_metadata__struct_BytePatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_BytePatch()
def _fbthrift_metadata__struct_I16Patch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_I16Patch()
def _fbthrift_metadata__struct_I32Patch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_I32Patch()
def _fbthrift_metadata__struct_I64Patch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_I64Patch()
def _fbthrift_metadata__struct_FloatPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_FloatPatch()
def _fbthrift_metadata__struct_DoublePatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_DoublePatch()
def _fbthrift_metadata__struct_StringPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_StringPatch()
def _fbthrift_metadata__struct_BinaryPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_BinaryPatch()
def _fbthrift_metadata__struct_OptionalBoolPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalBoolPatch()
def _fbthrift_metadata__struct_OptionalBytePatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalBytePatch()
def _fbthrift_metadata__struct_OptionalI16Patch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalI16Patch()
def _fbthrift_metadata__struct_OptionalI32Patch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalI32Patch()
def _fbthrift_metadata__struct_OptionalI64Patch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalI64Patch()
def _fbthrift_metadata__struct_OptionalFloatPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalFloatPatch()
def _fbthrift_metadata__struct_OptionalDoublePatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalDoublePatch()
def _fbthrift_metadata__struct_OptionalStringPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalStringPatch()
def _fbthrift_metadata__struct_OptionalBinaryPatch():
    return apache.thrift.op.patch.lite_metadata.gen_metadata_struct_OptionalBinaryPatch()
