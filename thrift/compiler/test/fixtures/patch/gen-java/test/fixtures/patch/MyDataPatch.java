...
public final class MyDataPatch implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public MyDataPatch(
        ...
        @com.facebook.swift.codec.ThriftField(value=6, name="patchAfter", requiredness=Requiredness.NONE) final test.fixtures.patch.MyDataFieldPatch patchAfter
    ) {
        this.assign = assign;
        this.clear = clear;
        this.patch = patch;
    ...
    public static class Builder {
        ...
        private test.fixtures.patch.MyDataFieldPatch patchAfter = null;
        ...
        public Builder setPatchAfter(test.fixtures.patch.MyDataFieldPatch patchAfter) {
            this.patchAfter = patchAfter;
            return this;
        }
    
        public test.fixtures.patch.MyDataFieldPatch getPatchAfter() { return patchAfter; }
    ...
    private static final TField ENSURE_FIELD_DESC = new TField("ensure", TType.STRUCT, (short)5);
        private final test.fixtures.patch.MyDataFieldPatch patchAfter;
    ...
    public static MyDataPatch read0(TProtocol oprot) throws TException {
      ...
      while (true) {
        ...
        case _PATCHAFTER:
          if (__field.type == TType.STRUCT) {
            test.fixtures.patch.MyDataFieldPatch patchAfter = test.fixtures.patch.MyDataFieldPatch.read0(oprot);
