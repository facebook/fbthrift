...
public final class MyDataPatch implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    @ThriftConstructor
    public MyDataPatch(
        @com.facebook.swift.codec.ThriftField(value=1, name="data1", requiredness=) final com.facebook.thrift.op_swift.StringPatch data1,
        @com.facebook.swift.codec.ThriftField(value=2, name="data2", requiredness=) final com.facebook.thrift.op_swift.I32Patch data2
    ) {
        this.data1 = data1;
        this.data2 = data2;
    }
