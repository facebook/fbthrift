...
public final class MyStruct implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    @ThriftConstructor
    public MyStruct(
        @com.facebook.swift.codec.ThriftField(value=1, name="boolVal", requiredness=) final boolean boolVal,
        @com.facebook.swift.codec.ThriftField(value=2, name="byteVal", requiredness=) final byte byteVal,
        @com.facebook.swift.codec.ThriftField(value=3, name="i16Val", requiredness=) final short i16Val,
        @com.facebook.swift.codec.ThriftField(value=4, name="i32Val", requiredness=) final int i32Val,
        @com.facebook.swift.codec.ThriftField(value=5, name="i64Val", requiredness=) final long i64Val,
        @com.facebook.swift.codec.ThriftField(value=6, name="floatVal", requiredness=) final float floatVal,
        @com.facebook.swift.codec.ThriftField(value=7, name="doubleVal", requiredness=) final double doubleVal,
        @com.facebook.swift.codec.ThriftField(value=8, name="stringVal", requiredness=) final String stringVal,
        @com.facebook.swift.codec.ThriftField(value=9, name="binaryVal", requiredness=) final byte[] binaryVal,
        @com.facebook.swift.codec.ThriftField(value=10, name="structVal", requiredness=) final test.fixtures.patch.MyData structVal,
        ...
        @com.facebook.swift.codec.ThriftField(value=30, name="unionVal", requiredness=) final test.fixtures.patch.MyUnion unionVal
    ) {
