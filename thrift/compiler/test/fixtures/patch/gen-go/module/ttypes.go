...
func (p *MyStruct)  ReadField21(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptListVal = append(p.OptListVal, _elem1)
  }
...
func (p *MyStruct)  ReadField22(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptSetVal = append(p.OptSetVal, _elem2)
  }
...
func (p *MyStruct) String() string {
  ...
  return fmt.Sprintf("MyStruct({BoolVal:%s ByteVal:%s I16Val:%s I32Val:%s I64Val:%s FloatVal:%s DoubleVal:%s StringVal:%s BinaryVal:%s StructVal:%s OptBoolVal:%s OptByteVal:%s OptI16Val:%s OptI32Val:%s OptI64Val:%s OptFloatVal:%s OptDoubleVal:%s OptStringVal:%s OptBinaryVal:%s OptStructVal:%s OptListVal:%s OptSetVal:%s OptMapVal:%s})", boolValVal, byteValVal, i16ValVal, i32ValVal, i64ValVal, floatValVal, doubleValVal, stringValVal, binaryValVal, structValVal, optBoolValVal, optByteValVal, optI16ValVal, optI32ValVal, optI64ValVal, optFloatValVal, optDoubleValVal, optStringValVal, optBinaryValVal, optStructValVal, optListValVal, optSetValVal, optMapValVal)
}
...
var MyDataPatch_Data1_DEFAULT *patch0.StringPatch
func (p *MyDataPatch) GetData1() *patch0.StringPatch {
  if !p.IsSetData1() {
    return MyDataPatch_Data1_DEFAULT
  }
return p.Data1
}
var MyDataPatch_Data2_DEFAULT *patch0.I32Patch
func (p *MyDataPatch) GetData2() *patch0.I32Patch {
  if !p.IsSetData2() {
...
func (m *MyDataPatchBuilder) Data1(data1 *patch0.StringPatch) *MyDataPatchBuilder {
  m.obj.Data1 = data1
  return m
}

func (m *MyDataPatchBuilder) Data2(data2 *patch0.I32Patch) *MyDataPatchBuilder {
  m.obj.Data2 = data2
  return m
}

func (m *MyDataPatch) SetData1(data1 *patch0.StringPatch) *MyDataPatch {
  m.Data1 = data1
  return m
}

func (m *MyDataPatch) SetData2(data2 *patch0.I32Patch) *MyDataPatch {
  m.Data2 = data2
  return m
}
...
type OptionalMyDataValuePatch struct {
  ...
  PatchAfter *MyDataValuePatch `thrift:"patchAfter,4" db:"patchAfter" json:"patchAfter"`
}
...
func (p *OptionalMyDataValuePatch)  ReadField1(iprot thrift.Protocol) error {
  p.Ensure = NewMyData()
...
func (p *OptionalMyDataValuePatch) writeField1(oprot thrift.Protocol) (err error) {
  if p.IsSetEnsure() {
    if err := oprot.WriteFieldBegin("ensure", thrift.STRUCT, 1); err != nil {
...
func (p *OptionalMyDataValuePatch) String() string {
  ...
  return fmt.Sprintf("OptionalMyDataValuePatch({Ensure:%s Clear:%s Patch:%s PatchAfter:%s})", ensureVal, clearVal, patchVal, patchAfterVal)
}
...
//  - Assign: Assigns to a given struct. If set, all other operations are ignored.
//  - Clear: Clears a given value. Applies first.
//  - Append: Appends to a given list. Currently Ignored.
//  - Prepend: Prepends to a given list. Currently Ignored.
type MyStructField21Patch struct {
  Assign []int16 `thrift:"assign,1,optional" db:"assign" json:"assign,omitempty"`
  Clear bool `thrift:"clear,2" db:"clear" json:"clear"`
  // unused field # 3
  Append []int16 `thrift:"append,4" db:"append" json:"append"`
  Prepend []int16 `thrift:"prepend,5" db:"prepend" json:"prepend"`
}
...
func (p *MyStructField21Patch)  ReadField1(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Assign = append(p.Assign, _elem5)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField21Patch)  ReadField4(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Append = append(p.Append, _elem6)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *MyStructField21Patch) writeField4(oprot thrift.Protocol) (err error) {
  if err := oprot.WriteFieldBegin("append", thrift.LIST, 4); err != nil {
...
func (p *MyStructField21Patch) writeField5(oprot thrift.Protocol) (err error) {
  if err := oprot.WriteFieldBegin("prepend", thrift.LIST, 5); err != nil {
...
func (p *MyStructField21Patch) String() string {
  ...
  return fmt.Sprintf("MyStructField21Patch({Assign:%s Clear:%s Append:%s Prepend:%s})", assignVal, clearVal, appendVal, prependVal)
}
...
type OptionalMyStructField21Patch struct {
  ...
  PatchAfter *MyStructField21Patch `thrift:"patchAfter,4" db:"patchAfter" json:"patchAfter"`
}
...
func (p *OptionalMyStructField21Patch)  ReadField1(iprot thrift.Protocol) error {
  _, size, err := iprot.ReadListBegin()
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Ensure = append(p.Ensure, _elem8)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *OptionalMyStructField21Patch) writeField1(oprot thrift.Protocol) (err error) {
  if p.IsSetEnsure() {
    if err := oprot.WriteFieldBegin("ensure", thrift.LIST, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:ensure: ", p), err) }
...
func (p *OptionalMyStructField21Patch) String() string {
  ...
  return fmt.Sprintf("OptionalMyStructField21Patch({Ensure:%s Clear:%s Patch:%s PatchAfter:%s})", ensureVal, clearVal, patchVal, patchAfterVal)
}

// Attributes:
//  - Assign: Assigns to a given struct. If set, all other operations are ignored.
//  - Clear: Clears a given value. Applies first.
//  - Add: Adds entries, if not already present. Currently Ignored.
//  - Remove: Removes entries, if present. Currently Ignored.
type MyStructField22Patch struct {
  Assign []string `thrift:"assign,1,optional" db:"assign" json:"assign,omitempty"`
  Clear bool `thrift:"clear,2" db:"clear" json:"clear"`
  // unused field # 3
  Add []string `thrift:"add,4" db:"add" json:"add"`
  Remove []string `thrift:"remove,5" db:"remove" json:"remove"`
}
...
func (p *MyStructField22Patch) writeField4(oprot thrift.Protocol) (err error) {
  if err := oprot.WriteFieldBegin("add", thrift.SET, 4); err != nil {
...
func (p *MyStructField22Patch) writeField5(oprot thrift.Protocol) (err error) {
  if err := oprot.WriteFieldBegin("remove", thrift.SET, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:remove: ", p), err) }
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:remove: ", p), err) }
  return err
}
...
func (p *MyStructField22Patch) String() string {
  ...
  return fmt.Sprintf("MyStructField22Patch({Assign:%s Clear:%s Add:%s Remove:%s})", assignVal, clearVal, addVal, removeVal)
}
...
type OptionalMyStructField22Patch struct {
  ...
  PatchAfter *MyStructField22Patch `thrift:"patchAfter,4" db:"patchAfter" json:"patchAfter"`
}
...
func (p *OptionalMyStructField22Patch)  ReadField1(iprot thrift.Protocol) error {
  _, size, err := iprot.ReadSetBegin()
  if err != nil {
    return thrift.PrependError("error reading set begin: ", err)
  }
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Ensure = append(p.Ensure, _elem12)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
func (p *OptionalMyStructField22Patch) writeField1(oprot thrift.Protocol) (err error) {
  if p.IsSetEnsure() {
    if err := oprot.WriteFieldBegin("ensure", thrift.SET, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:ensure: ", p), err) }
...
func (p *OptionalMyStructField22Patch) String() string {
  ...
  return fmt.Sprintf("OptionalMyStructField22Patch({Ensure:%s Clear:%s Patch:%s PatchAfter:%s})", ensureVal, clearVal, patchVal, patchAfterVal)
}
...
//  - Clear: Clears a given value. Applies first.
//  - Add: Adds entries, if not already present. Currently Ignored.
//  - RemoveIf: Removes the given key/value pairs, if present. Currently Ignored.
type MyStructField23Patch struct {
  Assign map[string]string `thrift:"assign,1,optional" db:"assign" json:"assign,omitempty"`
  Clear bool `thrift:"clear,2" db:"clear" json:"clear"`
  // unused field # 3
  Add map[string]string `thrift:"add,4" db:"add" json:"add"`
  // unused field # 5
  RemoveIf map[string]string `thrift:"removeIf,6" db:"removeIf" json:"removeIf"`
}
...
func (p *MyStructField23Patch) GetRemoveIf() map[string]string {
  return p.RemoveIf
}
...
func (m *MyStructField23PatchBuilder) RemoveIf(removeIf map[string]string) *MyStructField23PatchBuilder {
  m.obj.RemoveIf = removeIf
  return m
}
...
func (m *MyStructField23Patch) SetRemoveIf(removeIf map[string]string) *MyStructField23Patch {
  m.RemoveIf = removeIf
  return m
}
...
func (p *MyStructField23Patch)  ReadField4(iprot thrift.Protocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *MyStructField23Patch)  ReadField6(iprot thrift.Protocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *MyStructField23Patch) writeField4(oprot thrift.Protocol) (err error) {
  if err := oprot.WriteFieldBegin("add", thrift.MAP, 4); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:add: ", p), err) }
...
func (p *MyStructField23Patch) writeField6(oprot thrift.Protocol) (err error) {
  if err := oprot.WriteFieldBegin("removeIf", thrift.MAP, 6); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:removeIf: ", p), err) }
  if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRING, len(p.RemoveIf)); err != nil {
    return thrift.PrependError("error writing map begin: ", err)
  }
  for k, v := range p.RemoveIf {
    if err := oprot.WriteString(string(k)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T. (0) field write error: ", p), err) }
    if err := oprot.WriteString(string(v)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T. (0) field write error: ", p), err) }
  ...
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 6:removeIf: ", p), err) }
  return err
}
...
func (p *MyStructField23Patch) String() string {
  ...
  clearVal := fmt.Sprintf("%v", p.Clear)
  addVal := fmt.Sprintf("%v", p.Add)
  removeIfVal := fmt.Sprintf("%v", p.RemoveIf)
  return fmt.Sprintf("MyStructField23Patch({Assign:%s Clear:%s Add:%s RemoveIf:%s})", assignVal, clearVal, addVal, removeIfVal)
}
...
type OptionalMyStructField23Patch struct {
  Ensure map[string]string `thrift:"ensure,1,optional" db:"ensure" json:"ensure,omitempty"`
  Clear bool `thrift:"clear,2" db:"clear" json:"clear"`
  Patch *MyStructField23Patch `thrift:"patch,3" db:"patch" json:"patch"`
  PatchAfter *MyStructField23Patch `thrift:"patchAfter,4" db:"patchAfter" json:"patchAfter"`
}
...
func (p *OptionalMyStructField23Patch)  ReadField1(iprot thrift.Protocol) error {
  _, _, size, err := iprot.ReadMapBegin()
  if err != nil {
    return thrift.PrependError("error reading map begin: ", err)
  }
...
func (p *OptionalMyStructField23Patch) writeField1(oprot thrift.Protocol) (err error) {
  if p.IsSetEnsure() {
    if err := oprot.WriteFieldBegin("ensure", thrift.MAP, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:ensure: ", p), err) }
...
func (p *OptionalMyStructField23Patch) String() string {
  ...
  return fmt.Sprintf("OptionalMyStructField23Patch({Ensure:%s Clear:%s Patch:%s PatchAfter:%s})", ensureVal, clearVal, patchVal, patchAfterVal)
}
...
type OptionalMyStructValuePatch struct {
  ...
  PatchAfter *MyStructValuePatch `thrift:"patchAfter,4" db:"patchAfter" json:"patchAfter"`
}
...
func (p *OptionalMyStructValuePatch)  ReadField1(iprot thrift.Protocol) error {
...
func (p *OptionalMyStructValuePatch) writeField1(oprot thrift.Protocol) (err error) {
  if p.IsSetEnsure() {
    if err := oprot.WriteFieldBegin("ensure", thrift.STRUCT, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:ensure: ", p), err) }
    if err := p.Ensure.Write(oprot); err != nil {
...
func (p *OptionalMyStructValuePatch) String() string {
  ...
  return fmt.Sprintf("OptionalMyStructValuePatch({Ensure:%s Clear:%s Patch:%s PatchAfter:%s})", ensureVal, clearVal, patchVal, patchAfterVal)
}
