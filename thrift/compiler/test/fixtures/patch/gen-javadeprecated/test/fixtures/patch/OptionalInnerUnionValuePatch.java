...
public class OptionalInnerUnionValuePatch implements TBase, java.io.Serializable, Cloneable, Comparable<OptionalInnerUnionValuePatch> {
   ...
   */
  public InnerUnionValuePatch patch;
  /**
   ...
   */
  public InnerUnionValuePatch patchAfter;
  ...
  static {
    FieldMetaData.addStructMetaDataMap(OptionalInnerUnionValuePatch.class, metaDataMap);
  }
  ...
  public OptionalInnerUnionValuePatch(
      boolean clear,
      InnerUnionValuePatch patch,
      InnerUnionValuePatch patchAfter) {
    this();
    this.clear = clear;
    setClearIsSet(true);
    this.patch = patch;
  ...
  public static class Builder {
    ...
    private InnerUnionValuePatch patch;
    private InnerUnion ensure;
    private InnerUnionValuePatch patchAfter;
    ...
    public Builder setPatch(final InnerUnionValuePatch patch) {
      this.patch = patch;
      return this;
    }
    ...
    public Builder setPatchAfter(final InnerUnionValuePatch patchAfter) {
      this.patchAfter = patchAfter;
      return this;
    }
   ...
   */
  public OptionalInnerUnionValuePatch(OptionalInnerUnionValuePatch other) {
  ...
  public OptionalInnerUnionValuePatch deepCopy() {
    return new OptionalInnerUnionValuePatch(this);
  }
   ...
   * Clears any set value. Applies first.
   */
  public OptionalInnerUnionValuePatch setClear(boolean clear) {
    this.clear = clear;
    setClearIsSet(true);
    return this;
  }
   ...
   * Patches any set value. Applies second.
   */
  public InnerUnionValuePatch getPatch() {
    return this.patch;
  }
   ...
   * Patches any set value. Applies second.
   */
  public OptionalInnerUnionValuePatch setPatch(InnerUnionValuePatch patch) {
    this.patch = patch;
    return this;
  }
   ...
   * Assigns the value, if not already set. Applies third.
   */
  public OptionalInnerUnionValuePatch setEnsure(InnerUnion ensure) {
    this.ensure = ensure;
    return this;
  }
   ...
   * Patches any set value, including newly set values. Applies fourth.
   */
  public InnerUnionValuePatch getPatchAfter() {
   ...
   * Patches any set value, including newly set values. Applies fourth.
   */
  public OptionalInnerUnionValuePatch setPatchAfter(InnerUnionValuePatch patchAfter) {
    this.patchAfter = patchAfter;
    return this;
  }
  ...
  public void setFieldValue(int fieldID, Object __value) {
    ...
    case PATCH:
      if (__value == null) {
        ...
        setPatch((InnerUnionValuePatch)__value);
      }
      break;
    ...
    case PATCHAFTER:
      if (__value == null) {
        ...
        setPatchAfter((InnerUnionValuePatch)__value);
      }
      break;
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof OptionalInnerUnionValuePatch))
      return false;
    OptionalInnerUnionValuePatch that = (OptionalInnerUnionValuePatch)_that;
  ...
  @Override
  public int compareTo(OptionalInnerUnionValuePatch other) {
    if (other == null) {
      ...
      switch (__field.id)
      {
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            this.patch = new InnerUnionValuePatch();
        ...
        case PATCHAFTER:
          if (__field.type == TType.STRUCT) {
            this.patchAfter = new InnerUnionValuePatch();
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("OptionalInnerUnionValuePatch");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
