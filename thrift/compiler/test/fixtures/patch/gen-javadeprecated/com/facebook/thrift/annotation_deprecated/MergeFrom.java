...
public class MergeFrom implements TBase, java.io.Serializable, Cloneable, Comparable<MergeFrom> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(MergeFrom.class, metaDataMap);
  }
  ...
  public static class Builder {
    ...
    public MergeFrom build() {
      MergeFrom result = new MergeFrom();
  ...
  public MergeFrom setType(String type) {
    this.type = type;
    return this;
  }
  ...
  @Override
  public int compareTo(MergeFrom other) {
    if (other == null) {
