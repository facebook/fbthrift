...
public class OptionalMyStructField23Patch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public final MyStructField23Patch patchAfter;
  ...
  public static OptionalMyStructField23Patch deserialize(TProtocol iprot) throws TException {
    ...
    MyStructField23Patch tmp_patchAfter = null;
    TField __field;
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
          ...
          if (__field.type == TType.MAP) {
            {
              ...
              tmp_ensure = new HashMap<String,String>(Math.max(0, 2*_map34.size));
              for (int _i35 = 0; 
        ...
        case PATCHAFTER:
          if (__field.type == TType.STRUCT) {
            tmp_patchAfter = MyStructField23Patch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
