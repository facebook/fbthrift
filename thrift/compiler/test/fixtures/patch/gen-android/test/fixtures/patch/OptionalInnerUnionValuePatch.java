...
public class OptionalInnerUnionValuePatch implements TBase, java.io.Serializable, Cloneable {
   ...
   */
  public final InnerUnionValuePatch patch;
  /**
   ...
   */
  public final InnerUnionValuePatch patchAfter;
  ...
  public static OptionalInnerUnionValuePatch deserialize(TProtocol iprot) throws TException {
    Boolean tmp_clear = null;
    InnerUnionValuePatch tmp_patch = null;
    InnerUnion tmp_ensure = null;
    InnerUnionValuePatch tmp_patchAfter = null;
    TField __field;
      ...
      switch (__field.id)
      {
        ...
        case PATCH:
          if (__field.type == TType.STRUCT) {
            tmp_patch = InnerUnionValuePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        ...
        case PATCHAFTER:
          if (__field.type == TType.STRUCT) {
            tmp_patchAfter = InnerUnionValuePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
    ...
    OptionalInnerUnionValuePatch _that;
    _that = new OptionalInnerUnionValuePatch(
      tmp_clear
      ,tmp_patch
      ,tmp_ensure
      ,tmp_patchAfter
