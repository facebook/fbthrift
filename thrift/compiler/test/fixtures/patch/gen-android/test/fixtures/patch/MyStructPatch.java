...
public class MyStructPatch implements TBase, java.io.Serializable, Cloneable {
  ...
  public final MyDataValuePatch structVal;
  ...
  public final MyUnionValuePatch unionVal;
  ...
  public static MyStructPatch deserialize(TProtocol iprot) throws TException {
    ...
    MyDataValuePatch tmp_structVal = null;
    ...
    MyUnionValuePatch tmp_unionVal = null;
    TField __field;
    ...
    while (true)
    {
      ...
      switch (__field.id)
      {
        ...
        case STRUCTVAL:
          if (__field.type == TType.STRUCT) {
            tmp_structVal = MyDataValuePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        ...
        case OPTSTRUCTVAL:
          if (__field.type == TType.STRUCT) {
            tmp_optStructVal = OptionalMyDataValuePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
        ...
        case UNIONVAL:
          if (__field.type == TType.STRUCT) {
            tmp_unionVal = MyUnionValuePatch.deserialize(iprot);
          } else {
            TProtocolUtil.skip(iprot, __field.type);
          }
          break;
