...
public class MyDataValuePatch implements TBase, java.io.Serializable, Cloneable {
  ...
  public static MyDataValuePatch deserialize(TProtocol iprot) throws TException {
    ...
    MyDataValuePatch _that;
    _that = new MyDataValuePatch(
      tmp_assign
      ,tmp_clear
      ,tmp_patch
    );
