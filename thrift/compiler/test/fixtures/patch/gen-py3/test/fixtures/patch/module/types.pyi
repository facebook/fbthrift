...
class InnerUnion(thrift.py3.types.Union, _typing.Hashable):
    ...
    @staticmethod
    def fromValue(value: _typing.Union[None, bytes]) -> InnerUnion: ...
    @__property__
    def value(self) -> _typing.Union[None, bytes]: ...
    @__property__
...
class MyUnion(thrift.py3.types.Union, _typing.Hashable):
    ...
    @staticmethod
    def fromValue(value: _typing.Union[None, str, int, InnerUnion]) -> MyUnion: ...
    @__property__
    def value(self) -> _typing.Union[None, str, int, InnerUnion]: ...
    @__property__
...
class InnerUnionPatch(thrift.py3.types.Struct, _typing.Hashable):
    class __fbthrift_IsSet:
        innerOption: bool
        pass

    innerOption: Final[_apache_thrift_op_patch_types.BinaryPatch] = ...

    def __init__(
        self, *,
        innerOption: _typing.Optional[_apache_thrift_op_patch_types.BinaryPatch]=None
    ) -> None: ...

    def __call__(
        self, *,
        innerOption: _typing.Union[_apache_thrift_op_patch_types.BinaryPatch, '__NotSet', None]=NOTSET
    ) -> InnerUnionPatch: ...

    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['InnerUnionPatch'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'InnerUnionPatch') -> bool: ...
    def __gt__(self, other: 'InnerUnionPatch') -> bool: ...
    def __le__(self, other: 'InnerUnionPatch') -> bool: ...
    def __ge__(self, other: 'InnerUnionPatch') -> bool: ...


class InnerUnionValuePatch(thrift.py3.types.Struct, _typing.Hashable):
    class __fbthrift_IsSet:
        clear: bool
        patch: bool
        ensure: bool
    ...
    patch: Final[InnerUnionPatch] = ...

    ensure: Final[InnerUnion] = ...

    patchAfter: Final[InnerUnionPatch] = ...

    def __init__(
        self, *,
        clear: _typing.Optional[bool]=None,
        patch: _typing.Optional[InnerUnionPatch]=None,
        ensure: _typing.Optional[InnerUnion]=None,
        patchAfter: _typing.Optional[InnerUnionPatch]=None
    ) -> None: ...

    def __call__(
        self, *,
        clear: _typing.Union[bool, '__NotSet', None]=NOTSET,
        patch: _typing.Union[InnerUnionPatch, '__NotSet', None]=NOTSET,
        ensure: _typing.Union[InnerUnion, '__NotSet', None]=NOTSET,
        patchAfter: _typing.Union[InnerUnionPatch, '__NotSet', None]=NOTSET
    ) -> InnerUnionValuePatch: ...

    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['InnerUnionValuePatch'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'InnerUnionValuePatch') -> bool: ...
    def __gt__(self, other: 'InnerUnionValuePatch') -> bool: ...
    def __le__(self, other: 'InnerUnionValuePatch') -> bool: ...
    def __ge__(self, other: 'InnerUnionValuePatch') -> bool: ...


class OptionalInnerUnionValuePatch(thrift.py3.types.Struct, _typing.Hashable):
    class __fbthrift_IsSet:
        clear: bool
        patch: bool
        ensure: bool
    ...
    patch: Final[InnerUnionValuePatch] = ...

    ensure: Final[_typing.Optional[InnerUnion]] = ...

    patchAfter: Final[InnerUnionValuePatch] = ...

    def __init__(
        self, *,
        clear: _typing.Optional[bool]=None,
        patch: _typing.Optional[InnerUnionValuePatch]=None,
        ensure: _typing.Optional[InnerUnion]=None,
        patchAfter: _typing.Optional[InnerUnionValuePatch]=None
    ) -> None: ...

    def __call__(
        self, *,
        clear: _typing.Union[bool, '__NotSet', None]=NOTSET,
        patch: _typing.Union[InnerUnionValuePatch, '__NotSet', None]=NOTSET,
        ensure: _typing.Union[InnerUnion, '__NotSet', None]=NOTSET,
        patchAfter: _typing.Union[InnerUnionValuePatch, '__NotSet', None]=NOTSET
    ) -> OptionalInnerUnionValuePatch: ...

    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['OptionalInnerUnionValuePatch'], bytes]]: ...
    def __hash__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __lt__(self, other: 'OptionalInnerUnionValuePatch') -> bool: ...
    def __gt__(self, other: 'OptionalInnerUnionValuePatch') -> bool: ...
    def __le__(self, other: 'OptionalInnerUnionValuePatch') -> bool: ...
    def __ge__(self, other: 'OptionalInnerUnionValuePatch') -> bool: ...
...
class MyUnionPatch(thrift.py3.types.Struct, _typing.Hashable):
    ...
    option3: Final[InnerUnionValuePatch] = ...
    ...
    def __init__(
        ...
        option3: _typing.Optional[InnerUnionValuePatch]=None
    ) -> None: ...
    ...
    def __call__(
        ...
        option3: _typing.Union[InnerUnionValuePatch, '__NotSet', None]=NOTSET
    ) -> MyUnionPatch: ...
