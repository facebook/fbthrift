...
cdef class __BoolPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cBoolPatch* _struct_cpp_obj
...
cdef class __BytePatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cBytePatch* _struct_cpp_obj
...
cdef class __I16Patch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cI16Patch* _struct_cpp_obj
...
cdef class __I32Patch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cI32Patch* _struct_cpp_obj
...
cdef class __I64Patch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cI64Patch* _struct_cpp_obj
...
cdef class __FloatPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cFloatPatch* _struct_cpp_obj
...
cdef class __DoublePatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cDoublePatch* _struct_cpp_obj
...
cdef class __StringPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cStringPatch* _struct_cpp_obj
...
cdef class __BinaryPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cBinaryPatch* _struct_cpp_obj
...
cdef class __OptionalBoolPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalBoolPatch* _struct_cpp_obj
...
cdef class __OptionalBytePatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalBytePatch* _struct_cpp_obj
...
cdef class __OptionalI16Patch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalI16Patch* _struct_cpp_obj
...
cdef class __OptionalI32Patch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalI32Patch* _struct_cpp_obj
...
cdef class __OptionalI64Patch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalI64Patch* _struct_cpp_obj
...
cdef class __OptionalFloatPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalFloatPatch* _struct_cpp_obj
...
cdef class __OptionalDoublePatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalDoublePatch* _struct_cpp_obj
...
cdef class __OptionalStringPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalStringPatch* _struct_cpp_obj
...
cdef class __OptionalBinaryPatch_FieldsSetter(__StructFieldsSetter):
    cdef _apache_thrift_op_patch_types.cOptionalBinaryPatch* _struct_cpp_obj
