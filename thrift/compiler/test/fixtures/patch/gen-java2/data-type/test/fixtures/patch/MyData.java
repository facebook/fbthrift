...
public final class MyData implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    @ThriftConstructor
    public MyData(
        @com.facebook.swift.codec.ThriftField(value=1, name="data1", requiredness=) final String data1,
        @com.facebook.swift.codec.ThriftField(value=2, name="data2", requiredness=) final int data2
    ) {
        this.data1 = data1;
        this.data2 = data2;
    }
