...
import test.fixtures.basic.module.lite_types
...
class MyServiceInterface(
    ...
    def __get_metadata__() -> _fbthrift_metadata.ThriftMetadata:
        return test.fixtures.basic.module.lite_metadata.gen_metadata_service_MyService()
    ...
    async def _fbthrift__handler_ping(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_ping_args, args, protocol)
        value = await self.ping()
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_ping_result()
    ...
    async def _fbthrift__handler_getRandomData(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_getRandomData_args, args, protocol)
        value = await self.getRandomData()
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_getRandomData_result(success=value)
    ...
    async def _fbthrift__handler_sink(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_sink_args, args, protocol)
        value = await self.sink(args_struct.sink,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_sink_result()
    ...
    async def _fbthrift__handler_putDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_putDataById_args, args, protocol)
        value = await self.putDataById(args_struct.id,args_struct.data,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_putDataById_result()
    ...
    async def _fbthrift__handler_hasDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_hasDataById_args, args, protocol)
        value = await self.hasDataById(args_struct.id,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_hasDataById_result(success=value)
    ...
    async def _fbthrift__handler_getDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_getDataById_args, args, protocol)
        value = await self.getDataById(args_struct.id,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_getDataById_result(success=value)
    ...
    async def _fbthrift__handler_deleteDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_deleteDataById_args, args, protocol)
        value = await self.deleteDataById(args_struct.id,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_deleteDataById_result()
    ...
    async def _fbthrift__handler_lobDataById(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> None:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_lobDataById_args, args, protocol)
...
class DbMixedStackArgumentsInterface(
    ...
    @staticmethod
    def __get_metadata__() -> _fbthrift_metadata.ThriftMetadata:
        return test.fixtures.basic.module.lite_metadata.gen_metadata_service_DbMixedStackArguments()
    ...
    async def _fbthrift__handler_getDataByKey0(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_DbMixedStackArguments_getDataByKey0_args, args, protocol)
        value = await self.getDataByKey0(args_struct.key,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_DbMixedStackArguments_getDataByKey0_result(success=value)
    ...
    async def _fbthrift__handler_getDataByKey1(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_DbMixedStackArguments_getDataByKey1_args, args, protocol)
        value = await self.getDataByKey1(args_struct.key,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_DbMixedStackArguments_getDataByKey1_result(success=value)
