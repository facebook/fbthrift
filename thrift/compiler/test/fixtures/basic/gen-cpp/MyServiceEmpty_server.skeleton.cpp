...
class MyServiceEmptyHandler : virtual public MyServiceEmptyIf {
 public:
  MyServiceEmptyHandler() {
...
int main(int argc, char **argv) {
  int port = 9090;
  shared_ptr<MyServiceEmptyHandler> handler(new MyServiceEmptyHandler());
  shared_ptr<TProcessor> processor(new MyServiceEmptyProcessor(handler));
