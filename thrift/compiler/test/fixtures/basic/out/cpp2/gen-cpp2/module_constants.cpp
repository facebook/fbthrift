...
::std::string_view _fbthrift_schema_db8b8e607dc6bead() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_db8b8e607dc6bead_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_db8b8e607dc6bead_uris() {
  return {};
}
