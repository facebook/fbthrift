...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  void pang()")
  fmt.Fprintln(os.Stderr, "  void ping()")
  fmt.Fprintln(os.Stderr, "  void pong()")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := module.NewMyServicePrioChildClientFactory(trans, protocolFactory)
  ...
  case "pang":
    if flag.NArg() - 1 != 0 {
      fmt.Fprintln(os.Stderr, "Pang requires 0 args")
      flag.Usage()
    }
    fmt.Print(client.Pang())
    fmt.Print("\n")
    break
  case "ping":
    if flag.NArg() - 1 != 0 {
  ...
  case "pong":
    if flag.NArg() - 1 != 0 {
      fmt.Fprintln(os.Stderr, "Pong requires 0 args")
      flag.Usage()
    }
    fmt.Print(client.Pong())
    fmt.Print("\n")
    break
  case "":
    Usage()
