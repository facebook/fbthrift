...
class MyServiceSvAsyncIf {
 public:
  ...
  virtual void async_tm_sink(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, int64_t p_sink) = 0;
  virtual folly::Future<folly::Unit> future_sink(int64_t p_sink) = 0;
  virtual folly::SemiFuture<folly::Unit> semifuture_sink(int64_t p_sink) = 0;
  ...
  virtual void async_tm_getDataById(std::unique_ptr<apache::thrift::HandlerCallback<std::unique_ptr<::std::string>>> callback, int64_t p_id) = 0;
  virtual folly::Future<std::unique_ptr<::std::string>> future_getDataById(int64_t p_id) = 0;
  virtual folly::SemiFuture<std::unique_ptr<::std::string>> semifuture_getDataById(int64_t p_id) = 0;
  virtual void async_tm_deleteDataById(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, int64_t p_id) = 0;
  virtual folly::Future<folly::Unit> future_deleteDataById(int64_t p_id) = 0;
  virtual folly::SemiFuture<folly::Unit> semifuture_deleteDataById(int64_t p_id) = 0;
  virtual void async_tm_lobDataById(std::unique_ptr<apache::thrift::HandlerCallbackBase> callback, int64_t p_id, std::unique_ptr<::std::string> p_data) = 0;
  virtual folly::Future<folly::Unit> future_lobDataById(int64_t p_id, std::unique_ptr<::std::string> p_data) = 0;
  virtual folly::SemiFuture<folly::Unit> semifuture_lobDataById(int64_t p_id, std::unique_ptr<::std::string> p_data) = 0;
};
...
class MyServiceSvIf : public MyServiceSvAsyncIf, public apache::thrift::ServerInterface {
 public:
  ...
  folly::Future<folly::Unit> future_sink(int64_t p_sink) override;
  folly::SemiFuture<folly::Unit> semifuture_sink(int64_t p_sink) override;
  void async_tm_sink(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, int64_t p_sink) override;
  ...
  folly::Future<std::unique_ptr<::std::string>> future_getDataById(int64_t p_id) override;
  folly::SemiFuture<std::unique_ptr<::std::string>> semifuture_getDataById(int64_t p_id) override;
  void async_tm_getDataById(std::unique_ptr<apache::thrift::HandlerCallback<std::unique_ptr<::std::string>>> callback, int64_t p_id) override;
  virtual void deleteDataById(int64_t /*id*/);
  folly::Future<folly::Unit> future_deleteDataById(int64_t p_id) override;
  folly::SemiFuture<folly::Unit> semifuture_deleteDataById(int64_t p_id) override;
  void async_tm_deleteDataById(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, int64_t p_id) override;
  virtual void lobDataById(int64_t /*id*/, std::unique_ptr<::std::string> /*data*/);
  folly::Future<folly::Unit> future_lobDataById(int64_t p_id, std::unique_ptr<::std::string> p_data) override;
  folly::SemiFuture<folly::Unit> semifuture_lobDataById(int64_t p_id, std::unique_ptr<::std::string> p_data) override;
  void async_tm_lobDataById(std::unique_ptr<apache::thrift::HandlerCallbackBase> callback, int64_t p_id, std::unique_ptr<::std::string> p_data) override;
};
...
class MyServiceAsyncProcessor : public ::apache::thrift::GeneratedAsyncProcessor {
 ...
 private:
  ...
  void setUpAndProcess_ping(apache::thrift::ResponseChannelRequest::UniquePtr req, apache::thrift::SerializedRequest&& serializedRequest, apache::thrift::Cpp2RequestContext* ctx, folly::EventBase* eb, apache::thrift::concurrency::ThreadManager* tm);
  template <typename ProtocolIn_, typename ProtocolOut_>
  ...
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_getRandomData(apache::thrift::ResponseChannelRequest::UniquePtr req, apache::thrift::SerializedRequest&& serializedRequest, apache::thrift::Cpp2RequestContext* ctx, folly::EventBase* eb, apache::thrift::concurrency::ThreadManager* tm);
  template <typename ProtocolIn_, typename ProtocolOut_>
  ...
  template <typename ProtocolIn_, typename ProtocolOut_>
  void setUpAndProcess_getDataById(apache::thrift::ResponseChannelRequest::UniquePtr req, apache::thrift::SerializedRequest&& serializedRequest, apache::thrift::Cpp2RequestContext* ctx, folly::EventBase* eb, apache::thrift::concurrency::ThreadManager* tm);
  template <typename ProtocolIn_, typename ProtocolOut_>
