...
class MyServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
 ...
 private:
  virtual void cppDoNothingImpl(bool useSync, apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback);
 public:
 ...
 private:
  template <typename Protocol_>
  void cppDoNothingT(Protocol_* prot, bool useSync, apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback);
 public:
};
