...
class MyServicePrioChildAsyncProcessor : public  ::cpp2::MyServicePrioParentAsyncProcessor {
 ...
 private:
  ...
  template <class ProtocolIn_, class ProtocolOut_>
  static void throw_pang(std::unique_ptr<apache::thrift::ResponseChannel::Request> req,int32_t protoSeqId,apache::thrift::ContextStack* ctx,std::exception_ptr ep,apache::thrift::Cpp2RequestContext* reqCtx);
  template <class ProtocolIn_, class ProtocolOut_>
...
class MyServicePrioChildAsyncClient : public  ::cpp2::MyServicePrioParentAsyncClient {
 public:
  ...
  virtual void pang(std::function<void (::apache::thrift::ClientReceiveState&&)> callback);
