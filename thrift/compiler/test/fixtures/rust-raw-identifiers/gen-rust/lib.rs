    ...
    {        fn r#return(
            ...
            self.transport()
                ...
                .and_then(|reply| ::futures::future::ready({
                    ...
                    move |mut p: P::Deserializer| -> ::std::result::Result<(), crate::errors::foo::ReturnError> {
                        use ::fbthrift::{ProtocolReader as _};
                        let p = &mut p;
                        let (_, message_type, _) = p.read_message_begin(|_| ())?;
                        let result = match message_type {
                            ::fbthrift::MessageType::Reply => {
                                let exn: crate::services::foo::ReturnExn = ::fbthrift::Deserialize::read(p)?;
                                match exn {
        ...
        fn super_(
            ...
            self.transport()
                ...
                .and_then(|reply| ::futures::future::ready({
                    let de = P::deserializer(reply);
                    move |mut p: P::Deserializer| -> ::std::result::Result<(), crate::errors::foo::SuperError> {
                        use ::fbthrift::{ProtocolReader as _};
                        let p = &mut p;
                        let (_, message_type, _) = p.read_message_begin(|_| ())?;
                        let result = match message_type {
                            ::fbthrift::MessageType::Reply => {
                                let exn: crate::services::foo::SuperExn = ::fbthrift::Deserialize::read(p)?;
                                match exn {
