                    ...
                    (move |mut p: P::Deserializer| {
                        ...
                        match message_type {
                            ::fbthrift::MessageType::Reply => {
                                let exn: ::tokio_shim::task::JoinHandle<(Result<crate::services::foo::ReturnExn, _>, _)> = ::tokio_shim::task::spawn_blocking(move || {
            ...
            self.transport()
                ...
                .and_then(|reply| {
                    ...
                    (move |mut p: P::Deserializer| {
                        ...
                        match message_type {
                            ::fbthrift::MessageType::Reply => {
                                let exn: ::tokio_shim::task::JoinHandle<(Result<crate::services::foo::SuperExn, _>, _)> = ::tokio_shim::task::spawn_blocking(move || {
                                  (::fbthrift::Deserialize::read(&mut p), p)
                                });
                                ::futures::future::Either::Right(exn.then(
                                    |exn| {
