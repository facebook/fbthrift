...
struct module_constants {
  ...
  static constexpr ::std::int8_t const A_BYTE_ = static_cast<int8_t>(8);

  static constexpr ::std::int8_t A_BYTE() {
    return A_BYTE_;
  }

  static constexpr ::std::int16_t const THE_ANSWER_ = static_cast<int16_t>(42);

  static constexpr ::std::int16_t THE_ANSWER() {
    return THE_ANSWER_;
  }

  static constexpr ::std::int32_t const A_NUMBER_ = 84;

  static constexpr ::std::int32_t A_NUMBER() {
    return A_NUMBER_;
  }

  static constexpr ::std::int64_t const A_BIG_NUMBER_ = 102LL;

  static constexpr ::std::int64_t A_BIG_NUMBER() {
    return A_BIG_NUMBER_;
  }

  static constexpr double const A_REAL_NUMBER_ = 3.14;

  static constexpr double A_REAL_NUMBER() {
    return A_REAL_NUMBER_;
  }

  static constexpr double const A_FAKE_NUMBER_ = 3;
