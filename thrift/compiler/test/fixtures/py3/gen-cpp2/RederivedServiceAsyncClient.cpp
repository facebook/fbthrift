...
void RederivedServiceAsyncClient::get_sevenT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback) {

  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
  RederivedService_get_seven_pargs args;
  auto sizer = [&](Protocol_* p) { return args.serializedSizeZC(p); };
  auto writer = [&](Protocol_* p) { args.write(p); };
  static constexpr std::string_view methodName = "get_seven";
...
void RederivedServiceAsyncClient::get_seven(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
  auto ctx = get_sevenCtx(&rpcOptions);
...
void RederivedServiceAsyncClient::get_sevenImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
      get_sevenT(&writer, rpcOptions, std::move(ctx), contextStack, std::move(callback));
      break;
    }
...
std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> RederivedServiceAsyncClient::get_sevenCtx(apache::thrift::RpcOptions* rpcOptions) {
...
folly::exception_wrapper RederivedServiceAsyncClient::recv_wrapped_get_seven(::std::int32_t& _return, ::apache::thrift::ClientReceiveState& state) {
  ...
  constexpr auto const fname = "get_seven";
