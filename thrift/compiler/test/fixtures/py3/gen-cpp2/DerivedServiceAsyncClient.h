...
class DerivedServiceAsyncClient : public ::py3::simple::SimpleServiceAsyncClient {
 ...
 protected:
  void get_sixImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback);
 public:
 ...
 private:
  ...
  folly::coro::Task<::std::int32_t> co_get_six(apache::thrift::RpcOptions* rpcOptions) {
    ...
    if constexpr (hasRpcOptions) {
      ...
      get_sixImpl(defaultRpcOptions, ctx, ctx->ctx.get(), std::move(wrappedCallback));
    }
    if (cancellable) {
 ...
 private:
  ...
  void get_sixT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback);
  std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> get_sixCtx(apache::thrift::RpcOptions* rpcOptions);
 public:
};
