...
folly::IOBufQueue RederivedServiceAsyncProcessor::return_get_seven(int32_t protoSeqId, apache::thrift::ContextStack* ctx, ::std::int32_t const& _return) {
  ProtocolOut_ prot;
  RederivedService_get_seven_presult result;
  result.get<0>().value = const_cast<::std::int32_t*>(&_return);
  result.setIsSet(0, true);
  return serializeResponse("get_seven", &prot, protoSeqId, ctx, result);
}
