...
folly::IOBufQueue DerivedServiceAsyncProcessor::return_get_six(int32_t protoSeqId, apache::thrift::ContextStack* ctx, ::std::int32_t const& _return) {
  ProtocolOut_ prot;
  DerivedService_get_six_presult result;
  result.get<0>().value = const_cast<::std::int32_t*>(&_return);
  result.setIsSet(0, true);
  return serializeResponse("get_six", &prot, protoSeqId, ctx, result);
}
