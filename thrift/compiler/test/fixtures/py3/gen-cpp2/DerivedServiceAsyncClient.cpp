...
void DerivedServiceAsyncClient::get_sixT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback) {
...
void DerivedServiceAsyncClient::get_six(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
  ...
  get_sixImpl(rpcOptions, std::move(ctx), std::move(wrappedCallback));
}

void DerivedServiceAsyncClient::get_sixImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
      get_sixT(&writer, rpcOptions, std::move(ctx), std::move(callback));
      break;
    }
...
::std::int32_t DerivedServiceAsyncClient::sync_get_six(apache::thrift::RpcOptions& rpcOptions) {
  ...
  get_sixImpl(rpcOptions, ctx, std::move(wrappedCallback));
