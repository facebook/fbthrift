...
void DerivedServiceAsyncClient::get_sixT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback) {
...
void DerivedServiceAsyncClient::get_six(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
  auto ctx = get_sixCtx(&rpcOptions);
  ...
  get_sixImpl(rpcOptions, std::move(ctx), contextStack, std::move(wrappedCallback));
}

void DerivedServiceAsyncClient::get_sixImpl(const apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
      get_sixT(&writer, rpcOptions, std::move(ctx), contextStack, std::move(callback));
      break;
    }
...
std::shared_ptr<::apache::thrift::detail::ac::ClientRequestContext> DerivedServiceAsyncClient::get_sixCtx(apache::thrift::RpcOptions* rpcOptions) {
...
::std::int32_t DerivedServiceAsyncClient::sync_get_six(apache::thrift::RpcOptions& rpcOptions) {
  ...
  get_sixImpl(rpcOptions, ctx, ctx->ctx.get(), std::move(wrappedCallback));
