...
class RederivedServiceAsyncClient : public ::py3::simple::DerivedServiceAsyncClient {
 ...
 private:
  ...
  void get_sevenT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback);
