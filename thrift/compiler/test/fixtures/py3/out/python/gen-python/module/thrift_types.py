...
CustomString = str
CustomBinary = bytes
class CustomList(_fbthrift_python_types._ListTypedefBase):
    __slots__ = ()
    _fbthrift_list_type_info = _fbthrift_python_types.typeinfo_i32
class CustomSet(_fbthrift_python_types._SetTypedefBase):
    __slots__ = ()
    _fbthrift_set_type_info = _fbthrift_python_types.typeinfo_i32
class CustomMap(_fbthrift_python_types._MapTypedefBase):
    __slots__ = ()
...
AdaptedString = str
AdaptedBinary = bytes
class AdaptedList(_fbthrift_python_types._ListTypedefBase):
    __slots__ = ()
    _fbthrift_list_type_info = _fbthrift_python_types.typeinfo_i32
class AdaptedSet(_fbthrift_python_types._SetTypedefBase):
    __slots__ = ()
    _fbthrift_set_type_info = _fbthrift_python_types.typeinfo_i32
class AdaptedMap(_fbthrift_python_types._MapTypedefBase):
    __slots__ = ()
    _fbthrift_map_key_type_info = _fbthrift_python_types.typeinfo_i32
    _fbthrift_map_val_type_info = _fbthrift_python_types.typeinfo_i32
