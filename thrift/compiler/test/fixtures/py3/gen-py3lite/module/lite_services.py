...
class SimpleServiceInterface(
    ...
    async def _fbthrift__handler_get_five(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_five_args, args, protocol)
        value = await self.get_five()
        return_struct = _module_lite_types._fbthrift_SimpleService_get_five_result(success=value)
    ...
    async def _fbthrift__handler_add_five(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_add_five_args, args, protocol)
        value = await self.add_five(args_struct.num,)
        return_struct = _module_lite_types._fbthrift_SimpleService_add_five_result(success=value)
    ...
    async def _fbthrift__handler_do_nothing(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_do_nothing_args, args, protocol)
        value = await self.do_nothing()
        return_struct = _module_lite_types._fbthrift_SimpleService_do_nothing_result()
    ...
    async def _fbthrift__handler_concat(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_concat_args, args, protocol)
        value = await self.concat(args_struct.first,args_struct.second,)
        return_struct = _module_lite_types._fbthrift_SimpleService_concat_result(success=value)
    ...
    async def _fbthrift__handler_get_value(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_value_args, args, protocol)
        value = await self.get_value(args_struct.simple_struct,)
        return_struct = _module_lite_types._fbthrift_SimpleService_get_value_result(success=value)
    ...
    async def _fbthrift__handler_negate(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_negate_args, args, protocol)
        value = await self.negate(args_struct.input,)
        return_struct = _module_lite_types._fbthrift_SimpleService_negate_result(success=value)
    ...
    async def _fbthrift__handler_tiny(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_tiny_args, args, protocol)
        value = await self.tiny(args_struct.input,)
        return_struct = _module_lite_types._fbthrift_SimpleService_tiny_result(success=value)
    ...
    async def _fbthrift__handler_small(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_small_args, args, protocol)
        value = await self.small(args_struct.input,)
        return_struct = _module_lite_types._fbthrift_SimpleService_small_result(success=value)
    ...
    async def _fbthrift__handler_big(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_big_args, args, protocol)
        value = await self.big(args_struct.input,)
        return_struct = _module_lite_types._fbthrift_SimpleService_big_result(success=value)
    ...
    async def _fbthrift__handler_two(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_two_args, args, protocol)
        value = await self.two(args_struct.input,)
        return_struct = _module_lite_types._fbthrift_SimpleService_two_result(success=value)
    ...
    async def _fbthrift__handler_expected_exception(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_expected_exception_args, args, protocol)
        try:
    ...
    async def _fbthrift__handler_unexpected_exception(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_unexpected_exception_args, args, protocol)
        value = await self.unexpected_exception()
        return_struct = _module_lite_types._fbthrift_SimpleService_unexpected_exception_result(success=value)
    ...
    async def _fbthrift__handler_sum_i16_list(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_sum_i16_list_args, args, protocol)
        value = await self.sum_i16_list(args_struct.numbers,)
        return_struct = _module_lite_types._fbthrift_SimpleService_sum_i16_list_result(success=value)
    ...
    async def _fbthrift__handler_sum_i32_list(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_sum_i32_list_args, args, protocol)
        value = await self.sum_i32_list(args_struct.numbers,)
        return_struct = _module_lite_types._fbthrift_SimpleService_sum_i32_list_result(success=value)
    ...
    async def _fbthrift__handler_sum_i64_list(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_sum_i64_list_args, args, protocol)
        value = await self.sum_i64_list(args_struct.numbers,)
        return_struct = _module_lite_types._fbthrift_SimpleService_sum_i64_list_result(success=value)
    ...
    async def _fbthrift__handler_concat_many(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_concat_many_args, args, protocol)
        value = await self.concat_many(args_struct.words,)
        return_struct = _module_lite_types._fbthrift_SimpleService_concat_many_result(success=value)
    ...
    async def _fbthrift__handler_count_structs(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_count_structs_args, args, protocol)
        value = await self.count_structs(args_struct.items,)
        return_struct = _module_lite_types._fbthrift_SimpleService_count_structs_result(success=value)
    ...
    async def _fbthrift__handler_sum_set(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_sum_set_args, args, protocol)
        value = await self.sum_set(args_struct.numbers,)
        return_struct = _module_lite_types._fbthrift_SimpleService_sum_set_result(success=value)
    ...
    async def _fbthrift__handler_contains_word(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_contains_word_args, args, protocol)
        value = await self.contains_word(args_struct.words,args_struct.word,)
        return_struct = _module_lite_types._fbthrift_SimpleService_contains_word_result(success=value)
    ...
    async def _fbthrift__handler_get_map_value(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_map_value_args, args, protocol)
        value = await self.get_map_value(args_struct.words,args_struct.key,)
        return_struct = _module_lite_types._fbthrift_SimpleService_get_map_value_result(success=value)
    ...
    async def _fbthrift__handler_map_length(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_map_length_args, args, protocol)
        value = await self.map_length(args_struct.items,)
        return_struct = _module_lite_types._fbthrift_SimpleService_map_length_result(success=value)
    ...
    async def _fbthrift__handler_sum_map_values(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_sum_map_values_args, args, protocol)
        value = await self.sum_map_values(args_struct.items,)
        return_struct = _module_lite_types._fbthrift_SimpleService_sum_map_values_result(success=value)
    ...
    async def _fbthrift__handler_complex_sum_i32(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_complex_sum_i32_args, args, protocol)
        value = await self.complex_sum_i32(args_struct.counter,)
        return_struct = _module_lite_types._fbthrift_SimpleService_complex_sum_i32_result(success=value)
    ...
    async def _fbthrift__handler_repeat_name(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_repeat_name_args, args, protocol)
        value = await self.repeat_name(args_struct.counter,)
        return_struct = _module_lite_types._fbthrift_SimpleService_repeat_name_result(success=value)
    ...
    async def _fbthrift__handler_get_struct(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_struct_args, args, protocol)
        value = await self.get_struct()
        return_struct = _module_lite_types._fbthrift_SimpleService_get_struct_result(success=value)
    ...
    async def _fbthrift__handler_fib(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_fib_args, args, protocol)
        value = await self.fib(args_struct.n,)
        return_struct = _module_lite_types._fbthrift_SimpleService_fib_result(success=value)
    ...
    async def _fbthrift__handler_unique_words(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_unique_words_args, args, protocol)
        value = await self.unique_words(args_struct.words,)
        return_struct = _module_lite_types._fbthrift_SimpleService_unique_words_result(success=value)
    ...
    async def _fbthrift__handler_words_count(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_words_count_args, args, protocol)
        value = await self.words_count(args_struct.words,)
        return_struct = _module_lite_types._fbthrift_SimpleService_words_count_result(success=value)
    ...
    async def _fbthrift__handler_set_enum(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_set_enum_args, args, protocol)
        value = await self.set_enum(args_struct.in_enum,)
        return_struct = _module_lite_types._fbthrift_SimpleService_set_enum_result(success=value)
    ...
    async def _fbthrift__handler_list_of_lists(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_list_of_lists_args, args, protocol)
        value = await self.list_of_lists(args_struct.num_lists,args_struct.num_items,)
        return_struct = _module_lite_types._fbthrift_SimpleService_list_of_lists_result(success=value)
    ...
    async def _fbthrift__handler_word_character_frequency(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_word_character_frequency_args, args, protocol)
        value = await self.word_character_frequency(args_struct.sentence,)
        return_struct = _module_lite_types._fbthrift_SimpleService_word_character_frequency_result(success=value)
    ...
    async def _fbthrift__handler_list_of_sets(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_list_of_sets_args, args, protocol)
        value = await self.list_of_sets(args_struct.some_words,)
        return_struct = _module_lite_types._fbthrift_SimpleService_list_of_sets_result(success=value)
    ...
    async def _fbthrift__handler_nested_map_argument(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_nested_map_argument_args, args, protocol)
        value = await self.nested_map_argument(args_struct.struct_map,)
        return_struct = _module_lite_types._fbthrift_SimpleService_nested_map_argument_result(success=value)
    ...
    async def _fbthrift__handler_make_sentence(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_make_sentence_args, args, protocol)
        value = await self.make_sentence(args_struct.word_chars,)
        return_struct = _module_lite_types._fbthrift_SimpleService_make_sentence_result(success=value)
    ...
    async def _fbthrift__handler_get_union(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_union_args, args, protocol)
        value = await self.get_union(args_struct.sets,)
        return_struct = _module_lite_types._fbthrift_SimpleService_get_union_result(success=value)
    ...
    async def _fbthrift__handler_get_keys(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_keys_args, args, protocol)
        value = await self.get_keys(args_struct.string_map,)
        return_struct = _module_lite_types._fbthrift_SimpleService_get_keys_result(success=value)
    ...
    async def _fbthrift__handler_lookup_double(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_lookup_double_args, args, protocol)
        value = await self.lookup_double(args_struct.key,)
        return_struct = _module_lite_types._fbthrift_SimpleService_lookup_double_result(success=value)
    ...
    async def _fbthrift__handler_retrieve_binary(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_retrieve_binary_args, args, protocol)
        value = await self.retrieve_binary(args_struct.something,)
        return_struct = _module_lite_types._fbthrift_SimpleService_retrieve_binary_result(success=value)
    ...
    async def _fbthrift__handler_contain_binary(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_contain_binary_args, args, protocol)
        value = await self.contain_binary(args_struct.binaries,)
        return_struct = _module_lite_types._fbthrift_SimpleService_contain_binary_result(success=value)
    ...
    async def _fbthrift__handler_contain_enum(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_contain_enum_args, args, protocol)
        value = await self.contain_enum(args_struct.the_enum,)
        return_struct = _module_lite_types._fbthrift_SimpleService_contain_enum_result(success=value)
    ...
    async def _fbthrift__handler_get_binary_union_struct(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_SimpleService_get_binary_union_struct_args, args, protocol)
        value = await self.get_binary_union_struct(args_struct.u,)
        return_struct = _module_lite_types._fbthrift_SimpleService_get_binary_union_struct_result(success=value)
...
SimpleServiceInterface,
    ...
    async def _fbthrift__handler_get_six(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_DerivedService_get_six_args, args, protocol)
        value = await self.get_six()
        return_struct = _module_lite_types._fbthrift_DerivedService_get_six_result(success=value)
...
DerivedServiceInterface,
    ...
    async def _fbthrift__handler_get_seven(self, args, protocol):
        args_struct = deserialize(_module_lite_types._fbthrift_RederivedService_get_seven_args, args, protocol)
        value = await self.get_seven()
        return_struct = _module_lite_types._fbthrift_RederivedService_get_seven_result(success=value)
