...
class OptionalRefStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __call__(
        self, *,
        optional_blob: _typing.Union[__iobuf.IOBuf, NOTSETTYPE, None]=NOTSET
    ) -> OptionalRefStruct: ...
    ...
    @__property__
    def optional_blob(self) -> _typing.Optional[__iobuf.IOBuf]: ...
...
class BinaryUnion(thrift.py3.types.Union, _typing.Hashable):
    ...
    @__property__
    def iobuf_val(self) -> __iobuf.IOBuf: ...
...
class BinaryUnionStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __call__(
        self, *,
        u: _typing.Union['BinaryUnion', NOTSETTYPE, None]=NOTSET
    ) -> BinaryUnionStruct: ...
