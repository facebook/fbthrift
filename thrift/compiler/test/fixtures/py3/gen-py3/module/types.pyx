...
cdef class List__i16(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            return List__i16.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
...
cdef class List__SimpleStruct(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__SimpleStruct.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
...
cdef class Map__string_SimpleStruct(thrift.py3.types.Map):
    ...
    def __getitem__(self, key):
        ...
        if iter == deref(self._cpp_obj).end():
            raise err
        cdef shared_ptr[cSimpleStruct] citem = __reference_shared_ptr(deref(iter).second, self._cpp_obj)
        return SimpleStruct.create(citem)
...
cdef class Map__string_List__SimpleStruct(thrift.py3.types.Map):
    ...
    def __getitem__(self, key):
        ...
        if iter == deref(self._cpp_obj).end():
            raise err
        cdef shared_ptr[vector[cSimpleStruct]] citem = __reference_shared_ptr(deref(iter).second, self._cpp_obj)
...
cdef class List__List__string(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__List__string.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
...
cdef class List__Map__string_string(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__Map__string_string.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
    ...
    def __and__(self, other):
        ...
        while loc != deref(cself).end():
            if deref(cother).count(deref(loc)) > 0:
                deref(shretval).insert(deref(loc))
            inc(loc)
        return Set__binary.create(cmove(shretval))
...
cdef class List__AnEnum(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__AnEnum.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
...
cdef class List__Map__i32_double(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__Map__i32_double.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
