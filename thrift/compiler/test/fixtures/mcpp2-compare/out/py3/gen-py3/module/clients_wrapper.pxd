...
cdef extern from "thrift/compiler/test/fixtures/mcpp2-compare/gen-py3/module/clients_wrapper.h" namespace "::some::valid::ns":
  ...
  cdef cppclass cParamServiceClientWrapper "::some::valid::ns::ParamServiceClientWrapper":
    ...
    cFollyFuture[cFollyUnit] annotatedParams(cRpcOptions, 
      ...
      _module_cbindings._apache_thrift_SizedContainer__folly_small_vector_8_type[cint64_t] arg_list_type,
      _module_cbindings.folly_sorted_vector_set[string] arg_set_type,
      _module_cbindings._FakeMap[cint64_t,double] arg_map_type,
      _module_cbindings.std_unordered_map[string,_module_cbindings.cContainerStruct] arg_map_struct_type,
