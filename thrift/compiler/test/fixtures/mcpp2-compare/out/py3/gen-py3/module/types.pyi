...
_folly_small_vector__List__i64T = _typing.TypeVar('_folly_small_vector__List__i64T', bound=_typing.Sequence[int])


class folly_small_vector__List__i64(_typing.Sequence[int], _typing.Hashable):
    def __init__(self, items: _typing.Optional[_typing.Sequence[int]]=None) -> None: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __copy__(self) -> _typing.Sequence[int]: ...
    ...
    @_typing.overload
    def __getitem__(self, s: slice) -> _typing.Sequence[int]: ...
    def __add__(self, other: _typing.Sequence[int]) -> 'folly_small_vector__List__i64': ...
    def __radd__(self, other: _typing.Sequence[int]) -> 'folly_small_vector__List__i64': ...
    def __reversed__(self) -> _typing.Iterator[int]: ...
    #pyre-ignore[14]: no idea what pyre is on about
    def __iter__(self) -> _typing.Iterator[int]: ...
