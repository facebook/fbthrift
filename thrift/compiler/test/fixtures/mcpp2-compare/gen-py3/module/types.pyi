...
class ComplexUnion(thrift.py3.types.Union, _typing.Hashable):
    ...
    @staticmethod
    def fromValue(value: _typing.Union[int, int, str, str, int, int, float, bool, _typing.Sequence[int], _typing.AbstractSet[int], _typing.Mapping[str, int], _typing.Mapping[str, int], MyEnumA, _typing.Sequence[MyEnumA], 'MyStruct', _typing.AbstractSet['MyStruct'], 'SimpleUnion', 'SimpleUnion', _typing.Sequence['SimpleUnion'], _typing.AbstractSet['SimpleUnion'], _typing.Sequence[_typing.AbstractSet['SimpleUnion']], bytes, bytes, _typing.Sequence[bytes], 'MyStruct', 'MyStruct', 'AnException']) -> ComplexUnion: ...
    @__property__
    def value(self) -> _typing.Union[int, int, str, str, int, int, float, bool, _typing.Sequence[int], _typing.AbstractSet[int], _typing.Mapping[str, int], _typing.Mapping[str, int], MyEnumA, _typing.Sequence[MyEnumA], 'MyStruct', _typing.AbstractSet['MyStruct'], 'SimpleUnion', 'SimpleUnion', _typing.Sequence['SimpleUnion'], _typing.AbstractSet['SimpleUnion'], _typing.Sequence[_typing.AbstractSet['SimpleUnion']], bytes, bytes, _typing.Sequence[bytes], 'MyStruct', 'MyStruct', 'AnException']: ...
    @__property__
