...
class Empty(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['Empty'], _builtins.bytes]]: ...
...
class ASimpleStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['ASimpleStruct'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
...
class ASimpleStructNoexcept(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['ASimpleStructNoexcept'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
...
class MyStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        MyStringField2: _typing.Optional[_builtins.str]=None,
        MyBinaryField: _typing.Optional[_builtins.bytes]=None,
        MyBinaryField2: _typing.Optional[_builtins.bytes]=None,
        MyBinaryField3: _builtins.bytes,
        MyBinaryListField4: _typing.Optional[_typing.Sequence[_builtins.bytes]]=None,
        MyMapEnumAndInt: _typing.Optional[_typing.Mapping[MyEnumA, _builtins.str]]=None
    ) -> None: ...
    ...
    def __call__(
        ...
        MyStringField2: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        MyBinaryField: _typing.Union[_builtins.bytes, NOTSETTYPE, None]=NOTSET,
        MyBinaryField2: _typing.Union[_builtins.bytes, NOTSETTYPE, None]=NOTSET,
        MyBinaryField3: _typing.Union[_builtins.bytes, NOTSETTYPE]=NOTSET,
        MyBinaryListField4: _typing.Union[_typing.Sequence[_builtins.bytes], NOTSETTYPE, None]=NOTSET,
        MyMapEnumAndInt: _typing.Union[_typing.Mapping[MyEnumA, _builtins.str], NOTSETTYPE, None]=NOTSET
    ) -> MyStruct: ...
    ...
    @property
    def MyStringField2(self) -> _builtins.str: ...
    @property
    def MyBinaryField(self) -> _builtins.bytes: ...
    @property
    def MyBinaryField2(self) -> _typing.Optional[_builtins.bytes]: ...
    @property
    def MyBinaryField3(self) -> _builtins.bytes: ...
    @property
    def MyBinaryListField4(self) -> _typing.Sequence[_builtins.bytes]: ...
    @property
    def MyMapEnumAndInt(self) -> _typing.Mapping[MyEnumA, _builtins.str]: ...
...
class SimpleUnion(thrift.py3.types.Union, _typing.Hashable):
    ...
    @staticmethod
    def fromValue(value: _typing.Union[int, _builtins.str]) -> SimpleUnion: ...
    @property
    def value(self) -> _typing.Union[int, _builtins.str]: ...
    @property
...
class ComplexUnion(thrift.py3.types.Union, _typing.Hashable):
    def __init__(
        ...
        stringValue: _typing.Optional[_builtins.str]=None,
        req_stringValue: _builtins.str,
        opt_stringValue: _typing.Optional[_builtins.str]=None,
        ...
        union_map: _typing.Optional[_typing.Mapping[_builtins.str, int]]=None,
        req_union_map: _typing.Mapping[_builtins.str, int],
        opt_union_map: _typing.Optional[_typing.Mapping[_builtins.str, int]]=None,
    ...
    def stringValue(self) -> _builtins.str: ...
    @property
    def req_stringValue(self) -> _builtins.str: ...
    @property
    def opt_stringValue(self) -> _typing.Optional[_builtins.str]: ...
    @property
    ...
    @property
    def union_map(self) -> _typing.Mapping[_builtins.str, int]: ...
    @property
    def req_union_map(self) -> _typing.Mapping[_builtins.str, int]: ...
    @property
    def opt_union_map(self) -> _typing.Optional[_typing.Mapping[_builtins.str, int]]: ...
    @property
    ...
    @staticmethod
    def fromValue(value: _typing.Union[int, int, int, _builtins.str, _builtins.str, _builtins.str, int, int, float, bool, _typing.Sequence[int], _typing.AbstractSet[int], _typing.Mapping[_builtins.str, int], _typing.Mapping[_builtins.str, int], _typing.Mapping[_builtins.str, int], MyEnumA, _typing.Sequence[MyEnumA], 'MyStruct', _typing.AbstractSet['MyStruct'], 'SimpleUnion', 'SimpleUnion', 'SimpleUnion', _typing.Sequence['SimpleUnion'], _typing.AbstractSet['SimpleUnion'], _typing.Sequence[_typing.AbstractSet['SimpleUnion']], _builtins.bytes, _builtins.bytes, _builtins.bytes, _typing.Sequence[_builtins.bytes], 'MyStruct', 'MyStruct', 'AnException']) -> ComplexUnion: ...
    @property
    def value(self) -> _typing.Union[int, int, int, _builtins.str, _builtins.str, _builtins.str, int, int, float, bool, _typing.Sequence[int], _typing.AbstractSet[int], _typing.Mapping[_builtins.str, int], _typing.Mapping[_builtins.str, int], _typing.Mapping[_builtins.str, int], MyEnumA, _typing.Sequence[MyEnumA], 'MyStruct', _typing.AbstractSet['MyStruct'], 'SimpleUnion', 'SimpleUnion', 'SimpleUnion', _typing.Sequence['SimpleUnion'], _typing.AbstractSet['SimpleUnion'], _typing.Sequence[_typing.AbstractSet['SimpleUnion']], _builtins.bytes, _builtins.bytes, _builtins.bytes, _typing.Sequence[_builtins.bytes], 'MyStruct', 'MyStruct', 'AnException']: ...
    @property
...
class AnException(thrift.py3.exceptions.Error, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        req_code: int,
        message2: _typing.Optional[_builtins.str]=None,
        req_message: _builtins.str,
        exception_list: _typing.Optional[_typing.Sequence[int]]=None,
        exception_set: _typing.Optional[_typing.AbstractSet[int]]=None,
        exception_map: _typing.Optional[_typing.Mapping[_builtins.str, int]]=None,
        req_exception_map: _typing.Mapping[_builtins.str, int],
        enum_field: _typing.Optional[MyEnumA]=None,
        enum_container: _typing.Optional[_typing.Sequence[MyEnumA]]=None,
        a_struct: _typing.Optional['MyStruct']=None,
        a_set_struct: _typing.Optional[_typing.AbstractSet['MyStruct']]=None,
    ...
    @property
    def message2(self) -> _builtins.str: ...
    @property
    def req_message(self) -> _builtins.str: ...
    @property
    def exception_list(self) -> _typing.Sequence[int]: ...
    @property
    def exception_set(self) -> _typing.AbstractSet[int]: ...
    @property
    def exception_map(self) -> _typing.Mapping[_builtins.str, int]: ...
    @property
    def req_exception_map(self) -> _typing.Mapping[_builtins.str, int]: ...
    @property
    def enum_field(self) -> MyEnumA: ...
    @property
    def enum_container(self) -> _typing.Sequence[MyEnumA]: ...
...
class AnotherException(thrift.py3.exceptions.Error, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        code: _typing.Optional[int]=None,
        req_code: int,
        message: _typing.Optional[_builtins.str]=None
    ) -> None: ...
...
class containerStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        fieldB: _typing.Optional[_typing.Mapping[_builtins.str, bool]]=None,
        req_fieldB: _typing.Mapping[_builtins.str, bool],
        opt_fieldB: _typing.Optional[_typing.Mapping[_builtins.str, bool]]=None,
        ...
        fieldD: _typing.Optional[_builtins.str]=None,
        fieldE: _typing.Optional[_builtins.str]=None,
        req_fieldE: _typing.Optional[_builtins.str]=None,
        opt_fieldE: _typing.Optional[_builtins.str]=None,
        fieldF: _typing.Optional[_typing.Sequence[_typing.Sequence[int]]]=None,
        fieldG: _typing.Optional[_typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, int]]]]=None,
        fieldH: _typing.Optional[_typing.Sequence[_typing.AbstractSet[int]]]=None,
        fieldI: _typing.Optional[bool]=None,
        fieldJ: _typing.Optional[_typing.Mapping[_builtins.str, _typing.Sequence[int]]]=None,
        ...
        fieldM: _typing.Optional[_typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]]]=None,
        ...
        fieldAE: _typing.Optional[_typing.Mapping[_builtins.str, int]]=None,
        fieldSD: _typing.Optional[_builtins.str]=None
    ) -> None: ...
    ...
    def __call__(
        ...
        fieldB: _typing.Union[_typing.Mapping[_builtins.str, bool], NOTSETTYPE, None]=NOTSET,
        req_fieldB: _typing.Union[_typing.Mapping[_builtins.str, bool], NOTSETTYPE]=NOTSET,
        opt_fieldB: _typing.Union[_typing.Mapping[_builtins.str, bool], NOTSETTYPE, None]=NOTSET,
        ...
        fieldD: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        fieldE: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        req_fieldE: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        opt_fieldE: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        fieldF: _typing.Union[_typing.Sequence[_typing.Sequence[int]], NOTSETTYPE, None]=NOTSET,
        fieldG: _typing.Union[_typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, int]]], NOTSETTYPE, None]=NOTSET,
        ...
        fieldJ: _typing.Union[_typing.Mapping[_builtins.str, _typing.Sequence[int]], NOTSETTYPE, None]=NOTSET,
        ...
        fieldM: _typing.Union[_typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]], NOTSETTYPE, None]=NOTSET,
        ...
        fieldAE: _typing.Union[_typing.Mapping[_builtins.str, int], NOTSETTYPE, None]=NOTSET,
        fieldSD: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET
    ) -> containerStruct: ...
    ...
    @property
    def fieldB(self) -> _typing.Mapping[_builtins.str, bool]: ...
    @property
    def req_fieldB(self) -> _typing.Mapping[_builtins.str, bool]: ...
    @property
    def opt_fieldB(self) -> _typing.Optional[_typing.Mapping[_builtins.str, bool]]: ...
    @property
    ...
    @property
    def fieldD(self) -> _builtins.str: ...
    @property
    def fieldE(self) -> _builtins.str: ...
    @property
    def req_fieldE(self) -> _builtins.str: ...
    @property
    def opt_fieldE(self) -> _builtins.str: ...
    @property
    def fieldF(self) -> _typing.Sequence[_typing.Sequence[int]]: ...
    @property
    def fieldG(self) -> _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, int]]]: ...
    @property
    def fieldH(self) -> _typing.Sequence[_typing.AbstractSet[int]]: ...
    @property
    def fieldI(self) -> bool: ...
    @property
    def fieldJ(self) -> _typing.Mapping[_builtins.str, _typing.Sequence[int]]: ...
    @property
    ...
    @property
    def fieldM(self) -> _typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]]: ...
    @property
    def fieldN(self) -> int: ...
    @property
    ...
    @property
    def fieldAE(self) -> _typing.Mapping[_builtins.str, int]: ...
    @property
    def fieldSD(self) -> _builtins.str: ...
...
class MyIncludedStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['MyIncludedStruct'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
...
class AnnotatedStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        container_with_ref: _typing.Optional[_typing.Mapping[int, _typing.Sequence[_builtins.str]]]=None,
        req_cpp_unique_ref: 'containerStruct',
        req_cpp2_unique_ref: 'containerStruct',
        req_container_with_ref: _typing.Sequence[_builtins.str],
        ...
        ref_type_const: _typing.Optional[_typing.Mapping[int, _typing.Sequence[_builtins.str]]]=None,
        req_ref_type_shared: 'containerStruct',
        req_ref_type_const: 'containerStruct',
        req_ref_type_unique: _typing.Sequence[_builtins.str],
        ...
        set_type: _typing.Optional[_typing.AbstractSet[_builtins.str]]=None,
        map_type: _typing.Optional[_typing.Mapping[int, float]]=None,
        map_struct_type: _typing.Optional[_typing.Mapping[_builtins.str, 'containerStruct']]=None,
        ...
        list_string_template: _typing.Optional[_typing.Sequence[_builtins.str]]=None,
        set_template: _typing.Optional[_typing.AbstractSet[_builtins.str]]=None,
        map_template: _typing.Optional[_typing.Mapping[int, _builtins.str]]=None,
        typedef_list_template: _typing.Optional[_typing.Sequence[int]]=None,
        typedef_deque_template: _typing.Optional[_typing.Sequence[_builtins.str]]=None,
        typedef_set_template: _typing.Optional[_typing.AbstractSet[_builtins.str]]=None,
        typedef_map_template: _typing.Optional[_typing.Mapping[int, _builtins.str]]=None,
    ...
    def __call__(
        ...
        container_with_ref: _typing.Union[_typing.Mapping[int, _typing.Sequence[_builtins.str]], NOTSETTYPE, None]=NOTSET,
        ...
        req_container_with_ref: _typing.Union[_typing.Sequence[_builtins.str], NOTSETTYPE]=NOTSET,
        ...
        ref_type_const: _typing.Union[_typing.Mapping[int, _typing.Sequence[_builtins.str]], NOTSETTYPE, None]=NOTSET,
        ...
        req_ref_type_unique: _typing.Union[_typing.Sequence[_builtins.str], NOTSETTYPE]=NOTSET,
        ...
        set_type: _typing.Union[_typing.AbstractSet[_builtins.str], NOTSETTYPE, None]=NOTSET,
        map_type: _typing.Union[_typing.Mapping[int, float], NOTSETTYPE, None]=NOTSET,
        map_struct_type: _typing.Union[_typing.Mapping[_builtins.str, 'containerStruct'], NOTSETTYPE, None]=NOTSET,
        ...
        list_string_template: _typing.Union[_typing.Sequence[_builtins.str], NOTSETTYPE, None]=NOTSET,
        set_template: _typing.Union[_typing.AbstractSet[_builtins.str], NOTSETTYPE, None]=NOTSET,
        map_template: _typing.Union[_typing.Mapping[int, _builtins.str], NOTSETTYPE, None]=NOTSET,
        typedef_list_template: _typing.Union[_typing.Sequence[int], NOTSETTYPE, None]=NOTSET,
        typedef_deque_template: _typing.Union[_typing.Sequence[_builtins.str], NOTSETTYPE, None]=NOTSET,
        typedef_set_template: _typing.Union[_typing.AbstractSet[_builtins.str], NOTSETTYPE, None]=NOTSET,
        typedef_map_template: _typing.Union[_typing.Mapping[int, _builtins.str], NOTSETTYPE, None]=NOTSET,
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['AnnotatedStruct'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    ...
    @property
    def container_with_ref(self) -> _typing.Optional[_typing.Mapping[int, _typing.Sequence[_builtins.str]]]: ...
    @property
    def req_cpp_unique_ref(self) -> 'containerStruct': ...
    @property
    def req_cpp2_unique_ref(self) -> 'containerStruct': ...
    @property
    def req_container_with_ref(self) -> _typing.Sequence[_builtins.str]: ...
    @property
    ...
    @property
    def ref_type_const(self) -> _typing.Optional[_typing.Mapping[int, _typing.Sequence[_builtins.str]]]: ...
    @property
    def req_ref_type_shared(self) -> 'containerStruct': ...
    @property
    def req_ref_type_const(self) -> 'containerStruct': ...
    @property
    def req_ref_type_unique(self) -> _typing.Sequence[_builtins.str]: ...
    @property
    ...
    @property
    def set_type(self) -> _typing.AbstractSet[_builtins.str]: ...
    @property
    def map_type(self) -> _typing.Mapping[int, float]: ...
    @property
    def map_struct_type(self) -> _typing.Mapping[_builtins.str, 'containerStruct']: ...
    @property
    ...
    @property
    def list_string_template(self) -> _typing.Sequence[_builtins.str]: ...
    @property
    def set_template(self) -> _typing.AbstractSet[_builtins.str]: ...
    @property
    def map_template(self) -> _typing.Mapping[int, _builtins.str]: ...
    @property
    def typedef_list_template(self) -> _typing.Sequence[int]: ...
    @property
    def typedef_deque_template(self) -> _typing.Sequence[_builtins.str]: ...
    @property
    def typedef_set_template(self) -> _typing.AbstractSet[_builtins.str]: ...
    @property
    def typedef_map_template(self) -> _typing.Mapping[int, _builtins.str]: ...
    @property
...
class FloatStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['FloatStruct'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
...
class AllRequiredNoExceptMoveCtrStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['AllRequiredNoExceptMoveCtrStruct'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
...
class Map__string_i64(_typing.Mapping[_builtins.str, int], _typing.Hashable):
...
class Set__List__string(_typing.AbstractSet[_typing.Sequence[_builtins.str]], _typing.Hashable):
    def __init__(self, items: _typing.AbstractSet[_typing.Sequence[_builtins.str]]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def isdisjoint(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> bool: ...
    def union(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> 'Set__List__string': ...
    def intersection(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> 'Set__List__string': ...
    def difference(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> 'Set__List__string': ...
    def symmetric_difference(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> 'Set__List__string': ...
    def issubset(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> bool: ...
    def issuperset(self, other: _typing.AbstractSet[_typing.Sequence[_builtins.str]]) -> bool: ...
...
class Map__i32_List__string(_typing.Mapping[int, _typing.Sequence[_builtins.str]], _typing.Hashable):
...
class Map__List__Set__string_string(_typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: _typing.Sequence[_typing.AbstractSet[_builtins.str]]) -> _builtins.str: ...
    def __iter__(self) -> _typing.Iterator[_typing.Sequence[_typing.AbstractSet[_builtins.str]]]: ...


class Map__Set__List__i32_Map__List__Set__string_string(_typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: _typing.AbstractSet[_typing.Sequence[int]]) -> _typing.Mapping[_typing.Sequence[_typing.AbstractSet[_builtins.str]], _builtins.str]: ...
...
class Map__MyEnumA_string(_typing.Mapping[MyEnumA, _builtins.str], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[MyEnumA, _builtins.str]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: MyEnumA) -> _builtins.str: ...
    def __iter__(self) -> _typing.Iterator[MyEnumA]: ...
...
class Map__string_bool(_typing.Mapping[_builtins.str, bool], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[_builtins.str, bool]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: _builtins.str) -> bool: ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...
...
class Map__string_Map__string_Map__string_i32(_typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, int]]], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, int]]]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: _builtins.str) -> _typing.Mapping[_builtins.str, _typing.Mapping[_builtins.str, int]]: ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...
...
class Map__string_List__i32(_typing.Mapping[_builtins.str, _typing.Sequence[int]], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[_builtins.str, _typing.Sequence[int]]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: _builtins.str) -> _typing.Sequence[int]: ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...
...
class folly_sorted_vector_set_std_string__Set__string(_typing.AbstractSet[_builtins.str], _typing.Hashable):
    def __init__(self, items: _typing.AbstractSet[_builtins.str]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def isdisjoint(self, other: _typing.AbstractSet[_builtins.str]) -> bool: ...
    def union(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set_std_string__Set__string': ...
    def intersection(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set_std_string__Set__string': ...
    def difference(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set_std_string__Set__string': ...
    def symmetric_difference(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set_std_string__Set__string': ...
    def issubset(self, other: _typing.AbstractSet[_builtins.str]) -> bool: ...
    def issuperset(self, other: _typing.AbstractSet[_builtins.str]) -> bool: ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...
...
class std_unordered_map_std_string_containerStruct__Map__string_containerStruct(_typing.Mapping[_builtins.str, 'containerStruct'], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[_builtins.str, 'containerStruct']=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: _builtins.str) -> 'containerStruct': ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...
...
_std_deque__List__stringT = _typing.TypeVar('_std_deque__List__stringT', bound=_typing.Sequence[_builtins.str])


class std_deque__List__string(_typing.Sequence[_builtins.str], _typing.Hashable):
    def __init__(self, items: _typing.Sequence[_builtins.str]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    ...
    def count(self, item: _typing.Any) -> int: ...
    def index(self, item: _typing.Any, start: int = ..., stop: int = ...) -> int: ...
    def __add__(self, other: _typing.Sequence[_builtins.str]) -> 'std_deque__List__string': ...
    def __radd__(self, other: _std_deque__List__stringT) -> _std_deque__List__stringT: ...
    def __reversed__(self) -> _typing.Iterator[_builtins.str]: ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...


class folly_sorted_vector_set__Set__string(_typing.AbstractSet[_builtins.str], _typing.Hashable):
    def __init__(self, items: _typing.AbstractSet[_builtins.str]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def isdisjoint(self, other: _typing.AbstractSet[_builtins.str]) -> bool: ...
    def union(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set__Set__string': ...
    def intersection(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set__Set__string': ...
    def difference(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set__Set__string': ...
    def symmetric_difference(self, other: _typing.AbstractSet[_builtins.str]) -> 'folly_sorted_vector_set__Set__string': ...
    def issubset(self, other: _typing.AbstractSet[_builtins.str]) -> bool: ...
    def issuperset(self, other: _typing.AbstractSet[_builtins.str]) -> bool: ...
    def __iter__(self) -> _typing.Iterator[_builtins.str]: ...


class folly_sorted_vector_map__Map__i64_string(_typing.Mapping[int, _builtins.str], _typing.Hashable):
...
_List__Map__i16_stringT = _typing.TypeVar('_List__Map__i16_stringT', bound=_typing.Sequence[_typing.Mapping[int, _builtins.str]])


class List__Map__i16_string(_typing.Sequence[_typing.Mapping[int, _builtins.str]], _typing.Hashable):
    def __init__(self, items: _typing.Sequence[_typing.Mapping[int, _builtins.str]]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    @_typing.overload
    def __getitem__(self, i: int) -> _typing.Mapping[int, _builtins.str]: ...
    @_typing.overload
    def __getitem__(self, s: slice) -> _typing.Sequence[_typing.Mapping[int, _builtins.str]]: ...
    def count(self, item: _typing.Any) -> int: ...
    def index(self, item: _typing.Any, start: int = ..., stop: int = ...) -> int: ...
    def __add__(self, other: _typing.Sequence[_typing.Mapping[int, _builtins.str]]) -> 'List__Map__i16_string': ...
    def __radd__(self, other: _List__Map__i16_stringT) -> _List__Map__i16_stringT: ...
    def __reversed__(self) -> _typing.Iterator[_typing.Mapping[int, _builtins.str]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Mapping[int, _builtins.str]]: ...
...
IOBuf = _builtins.bytes
IOBufPtr = _builtins.bytes
