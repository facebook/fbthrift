...
class ComplexUnion(thrift.py3.types.Union):
    ...
    @property
    def opt_union_map(self) -> _typing.Mapping[str, int]: ...
    @property
...
class containerStruct(thrift.py3.types.Struct):
    ...
    def __call__(
        ...
        req_fieldC: _typing.Union[_typing.AbstractSet[int], NOTSETTYPE]=NOTSET,
        ...
        req_fieldE: _typing.Union[str, NOTSETTYPE]=NOTSET,
        ...
        req_fieldR: _typing.Union[MyEnumA, NOTSETTYPE]=NOTSET,
    ...
    @property
    def opt_fieldB(self) -> _typing.Mapping[str, bool]: ...
    @property
...
class AnnotatedStruct(thrift.py3.types.Struct):
    ...
    @property
    def container_with_ref(self) -> _typing.Mapping[int, _typing.Sequence[str]]: ...
    @property
    ...
    @property
    def opt_container_with_ref(self) -> _typing.AbstractSet[int]: ...
    @property
    def ref_type_unique(self) -> 'containerStruct': ...
    @property
    def ref_type_shared(self) -> 'containerStruct': ...
    @property
    def ref_type_const(self) -> _typing.Mapping[int, _typing.Sequence[str]]: ...
    @property
    ...
    @property
    def opt_ref_type_shared(self) -> _typing.AbstractSet[int]: ...
    @property
