...
AnnotatedStruct::AnnotatedStruct() :
      ...
      struct_struct(static_cast<::some::valid::ns::containerStruct>(::apache::thrift::detail::make_constant< ::some::valid::ns::containerStruct>(::apache::thrift::detail::wrap_struct_argument<::apache::thrift::tag::fieldD>(apache::thrift::StringTraits<std::string>::fromStringLiteral("some string")), ::apache::thrift::detail::wrap_struct_argument<::apache::thrift::tag::fieldI>(static_cast<bool>(false))))) {
}
