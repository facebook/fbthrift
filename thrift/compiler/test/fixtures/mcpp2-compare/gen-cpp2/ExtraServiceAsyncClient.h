...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_throws_function();
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<bool> co_throws_function2(bool param1);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<std::map<int32_t, std::string>> co_throws_function3(bool param1, const std::string& param2);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_oneway_void_ret_i32_i32_i32_i32_i32_param(int32_t param1, int32_t param2, int32_t param3, int32_t param4, int32_t param5);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_oneway_void_ret_map_setlist_param(const std::map<std::string, int64_t>& param1, const std::set<std::vector<std::string>>& param2);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_oneway_void_ret_struct_param(const  ::some::valid::ns::MyStruct& param1);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_oneway_void_ret_listunion_param(const std::vector< ::some::valid::ns::ComplexUnion>& param1);
#endif
