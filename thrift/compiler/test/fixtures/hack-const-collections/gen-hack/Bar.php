...
interface BarClientIf extends \IThriftSyncIf {
   ...
   *       5: i64 e);
   */
  public function gen_baz(ConstSet<int> $a, \HH\KeyedContainer<int, \HH\KeyedContainer<int, ConstSet<string>>> $b, int $c, ?Foo $d, int $e): Awaitable<string>;
}
...
class BarClient extends \ThriftClientBase implements BarClientIf {
   ...
   *       5: i64 e);
   */
  public async function gen_baz(ConstSet<int> $a, \HH\KeyedContainer<int, \HH\KeyedContainer<int, ConstSet<string>>> $b, int $c, ?Foo $d, int $e): Awaitable<string> {
    $currentseqid = $this->sendImpl_baz($a, $b, $c, $d, $e);
    await $this->asyncHandler_->genWait($currentseqid);
    return $this->recvImpl_baz($currentseqid);
  }
