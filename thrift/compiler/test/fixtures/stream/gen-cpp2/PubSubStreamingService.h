...
class PubSubStreamingServiceSvAsyncIf {
 public:
  ...
  virtual void async_tm_client(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foo) = 0;
  virtual folly::Future<folly::Unit> future_client(apache::thrift::SemiStream<int32_t> foo) = 0;
  virtual void async_tm_server(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foo) = 0;
  virtual folly::Future<folly::Unit> future_server(apache::thrift::SemiStream<int32_t> foo) = 0;
  virtual void async_tm_both(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foo) = 0;
  virtual folly::Future<folly::Unit> future_both(apache::thrift::SemiStream<int32_t> foo) = 0;
  ...
  virtual void async_tm_clientthrows(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foostream) = 0;
  virtual folly::Future<folly::Unit> future_clientthrows(apache::thrift::SemiStream<int32_t> foostream) = 0;
...
class PubSubStreamingServiceSvIf : public PubSubStreamingServiceSvAsyncIf, public apache::thrift::ServerInterface {
 public:
  ...
  virtual void client(apache::thrift::SemiStream<int32_t> /*foo*/);
  folly::Future<folly::Unit> future_client(apache::thrift::SemiStream<int32_t> foo) override;
  void async_tm_client(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foo) override;
  virtual void server(apache::thrift::SemiStream<int32_t> /*foo*/);
  folly::Future<folly::Unit> future_server(apache::thrift::SemiStream<int32_t> foo) override;
  void async_tm_server(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foo) override;
  virtual void both(apache::thrift::SemiStream<int32_t> /*foo*/);
  folly::Future<folly::Unit> future_both(apache::thrift::SemiStream<int32_t> foo) override;
  void async_tm_both(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foo) override;
  ...
  virtual void clientthrows(apache::thrift::SemiStream<int32_t> /*foostream*/);
  folly::Future<folly::Unit> future_clientthrows(apache::thrift::SemiStream<int32_t> foostream) override;
  void async_tm_clientthrows(std::unique_ptr<apache::thrift::HandlerCallback<void>> callback, apache::thrift::SemiStream<int32_t> foostream) override;
...
class PubSubStreamingServiceSvNull : public PubSubStreamingServiceSvIf {
 public:
  void client(apache::thrift::SemiStream<int32_t> /*foo*/) override;
  void server(apache::thrift::SemiStream<int32_t> /*foo*/) override;
  void both(apache::thrift::SemiStream<int32_t> /*foo*/) override;
  ...
  void clientthrows(apache::thrift::SemiStream<int32_t> /*foostream*/) override;
