...
void PubSubStreamingServiceAsyncClient::returnstreamT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t i32_from, int32_t i32_to) {
...
template <typename Protocol_>
void PubSubStreamingServiceAsyncClient::streamthrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
...
template <typename Protocol_>
void PubSubStreamingServiceAsyncClient::boththrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
...
template <typename Protocol_>
void PubSubStreamingServiceAsyncClient::responseandstreamthrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
...
template <typename Protocol_>
void PubSubStreamingServiceAsyncClient::streamleftthrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
  PubSubStreamingService_streamleftthrows_pargs args;
  args.get<0>().value = &foo;
  auto sizer = [&](Protocol_* p) { return args.serializedSizeZC(p); };
  auto writer = [&](Protocol_* p) { args.write(p); };
  apache::thrift::clientSendT<Protocol_>(prot, rpcOptions, std::move(callback), ctx->ctx, std::move(header), channel_.get(), "streamleftthrows", writer, sizer, apache::thrift::RpcKind::SINGLE_REQUEST_STREAMING_RESPONSE);
  ctx->reqContext.setRequestHeader(nullptr);
}

template <typename Protocol_>
void PubSubStreamingServiceAsyncClient::bothleftthrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
  PubSubStreamingService_bothleftthrows_pargs args;
  args.get<0>().value = &foo;
  auto sizer = [&](Protocol_* p) { return args.serializedSizeZC(p); };
  auto writer = [&](Protocol_* p) { args.write(p); };
  apache::thrift::clientSendT<Protocol_>(prot, rpcOptions, std::move(callback), ctx->ctx, std::move(header), channel_.get(), "bothleftthrows", writer, sizer, apache::thrift::RpcKind::SINGLE_REQUEST_STREAMING_RESPONSE);
  ctx->reqContext.setRequestHeader(nullptr);
}

template <typename Protocol_>
void PubSubStreamingServiceAsyncClient::responseandstreamleftthrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  std::shared_ptr<apache::thrift::transport::THeader> header(ctx, &ctx->header);
  PubSubStreamingService_responseandstreamleftthrows_pargs args;
  args.get<0>().value = &foo;
  auto sizer = [&](Protocol_* p) { return args.serializedSizeZC(p); };
  auto writer = [&](Protocol_* p) { args.write(p); };
  apache::thrift::clientSendT<Protocol_>(prot, rpcOptions, std::move(callback), ctx->ctx, std::move(header), channel_.get(), "responseandstreamleftthrows", writer, sizer, apache::thrift::RpcKind::SINGLE_REQUEST_STREAMING_RESPONSE);
  ctx->reqContext.setRequestHeader(nullptr);
}
...
void PubSubStreamingServiceAsyncClient::returnstream(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t i32_from, int32_t i32_to) {
  ...
  returnstreamImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), i32_from, i32_to);
}

void PubSubStreamingServiceAsyncClient::returnstreamImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t i32_from, int32_t i32_to) {
...
void PubSubStreamingServiceAsyncClient::streamthrows(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  ...
  callbackContext.protocolId =
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  callbackContext.ctx = std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx);
  streamthrowsImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), foo);
}

void PubSubStreamingServiceAsyncClient::streamthrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
...
void PubSubStreamingServiceAsyncClient::boththrows(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  ...
  callbackContext.protocolId =
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  callbackContext.ctx = std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx);
  boththrowsImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), foo);
}

void PubSubStreamingServiceAsyncClient::boththrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
...
void PubSubStreamingServiceAsyncClient::responseandstreamthrows(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  ...
  callbackContext.protocolId =
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  callbackContext.ctx = std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx);
  responseandstreamthrowsImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), foo);
}

void PubSubStreamingServiceAsyncClient::responseandstreamthrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
...
void PubSubStreamingServiceAsyncClient::streamleftthrows(std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  streamleftthrows(rpcOptions, std::move(callback), foo);
}

void PubSubStreamingServiceAsyncClient::streamleftthrows(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  auto ctx = std::make_shared<apache::thrift::detail::ac::ClientRequestContext>(
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(),
      rpcOptions.releaseWriteHeaders(),
      this->handlers_,
      this->getServiceName(),
      "PubSubStreamingService.streamleftthrows");
  apache::thrift::RequestCallback::Context callbackContext;
  callbackContext.protocolId =
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  callbackContext.ctx = std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx);
  streamleftthrowsImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), foo);
}

void PubSubStreamingServiceAsyncClient::streamleftthrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
      streamleftthrowsT(&writer, rpcOptions, std::move(ctx), std::move(callback), foo);
      break;
    }
    case apache::thrift::protocol::T_COMPACT_PROTOCOL:
    {
...
apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::sync_streamleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return sync_streamleftthrows(rpcOptions, foo);
}

apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::sync_streamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  apache::thrift::ClientReceiveState _returnState;
  apache::thrift::ClientSyncCallback<false> callback(&_returnState);
  auto protocolId = apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  auto evb = apache::thrift::GeneratedAsyncClient::getChannel()->getEventBase();
  auto ctx = std::make_shared<apache::thrift::detail::ac::ClientRequestContext>(
      ...
      this->getServiceName(),
      "PubSubStreamingService.streamleftthrows");
  streamleftthrowsImpl(rpcOptions, ctx, apache::thrift::RequestClientCallback::Ptr(&callback), foo);
  callback.waitUntilDone(evb);
  _returnState.resetProtocolId(protocolId);
  _returnState.resetCtx(std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx));
  SCOPE_EXIT {
  ...
  return recv_streamleftthrows(_returnState);
}



folly::Future<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::future_streamleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return future_streamleftthrows(rpcOptions, foo);
}

folly::SemiFuture<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::semifuture_streamleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return semifuture_streamleftthrows(rpcOptions, foo);
}

folly::Future<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::future_streamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  folly::Promise<apache::thrift::SemiStream<int32_t>> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<apache::thrift::FutureCallback<apache::thrift::SemiStream<int32_t>>>(std::move(_promise), recv_wrapped_streamleftthrows, channel_);
  streamleftthrows(rpcOptions, std::move(callback), foo);
  return _future;
}

folly::SemiFuture<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::semifuture_streamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  auto callbackAndFuture = makeSemiFutureCallback(recv_wrapped_streamleftthrows, channel_);
  auto callback = std::move(callbackAndFuture.first);
  streamleftthrows(rpcOptions, std::move(callback), foo);
  return std::move(callbackAndFuture.second);
}

folly::Future<std::pair<apache::thrift::SemiStream<int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> PubSubStreamingServiceAsyncClient::header_future_streamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  folly::Promise<std::pair<apache::thrift::SemiStream<int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<apache::thrift::HeaderFutureCallback<apache::thrift::SemiStream<int32_t>>>(std::move(_promise), recv_wrapped_streamleftthrows, channel_);
  streamleftthrows(rpcOptions, std::move(callback), foo);
  return _future;
}

folly::SemiFuture<std::pair<apache::thrift::SemiStream<int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> PubSubStreamingServiceAsyncClient::header_semifuture_streamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  auto callbackAndFuture = makeHeaderSemiFutureCallback(recv_wrapped_streamleftthrows, channel_);
  auto callback = std::move(callbackAndFuture.first);
  streamleftthrows(rpcOptions, std::move(callback), foo);
  return std::move(callbackAndFuture.second);
}
void PubSubStreamingServiceAsyncClient::streamleftthrows(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, int32_t foo) {
  streamleftthrows(std::make_unique<apache::thrift::FunctionReplyCallback>(std::move(callback)), foo);
}

folly::exception_wrapper PubSubStreamingServiceAsyncClient::recv_wrapped_streamleftthrows(apache::thrift::SemiStream<int32_t>& _return, ::apache::thrift::ClientReceiveState& state) {
  if (state.isException()) {
    return std::move(state.exception());
  }
  if (!state.buf()) {
  ...
  using result = PubSubStreamingService_streamleftthrows_presult;
  constexpr auto const fname = "streamleftthrows";
  switch (state.protocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolReader reader;
...
apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::recv_streamleftthrows(::apache::thrift::ClientReceiveState& state) {
  apache::thrift::SemiStream<int32_t> _return;
  auto ew = recv_wrapped_streamleftthrows(_return, state);
  if (ew) {
    ew.throw_exception();
  }
  return _return;
...
apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::recv_instance_streamleftthrows(::apache::thrift::ClientReceiveState& state) {
  return recv_streamleftthrows(state);
}

folly::exception_wrapper PubSubStreamingServiceAsyncClient::recv_instance_wrapped_streamleftthrows(apache::thrift::SemiStream<int32_t>& _return, ::apache::thrift::ClientReceiveState& state) {
  return recv_wrapped_streamleftthrows(_return, state);
}

void PubSubStreamingServiceAsyncClient::bothleftthrows(std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  bothleftthrows(rpcOptions, std::move(callback), foo);
}

void PubSubStreamingServiceAsyncClient::bothleftthrows(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  auto ctx = std::make_shared<apache::thrift::detail::ac::ClientRequestContext>(
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(),
      rpcOptions.releaseWriteHeaders(),
      this->handlers_,
      this->getServiceName(),
      "PubSubStreamingService.bothleftthrows");
  apache::thrift::RequestCallback::Context callbackContext;
  callbackContext.protocolId =
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  callbackContext.ctx = std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx);
  bothleftthrowsImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), foo);
}

void PubSubStreamingServiceAsyncClient::bothleftthrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
      bothleftthrowsT(&writer, rpcOptions, std::move(ctx), std::move(callback), foo);
      break;
    }
    case apache::thrift::protocol::T_COMPACT_PROTOCOL:
    {
...
apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::sync_bothleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return sync_bothleftthrows(rpcOptions, foo);
}

apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::sync_bothleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  apache::thrift::ClientReceiveState _returnState;
  apache::thrift::ClientSyncCallback<false> callback(&_returnState);
  auto protocolId = apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  auto evb = apache::thrift::GeneratedAsyncClient::getChannel()->getEventBase();
  auto ctx = std::make_shared<apache::thrift::detail::ac::ClientRequestContext>(
      ...
      this->getServiceName(),
      "PubSubStreamingService.bothleftthrows");
  bothleftthrowsImpl(rpcOptions, ctx, apache::thrift::RequestClientCallback::Ptr(&callback), foo);
  callback.waitUntilDone(evb);
  _returnState.resetProtocolId(protocolId);
  _returnState.resetCtx(std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx));
  SCOPE_EXIT {
  ...
  return recv_bothleftthrows(_returnState);
}



folly::Future<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::future_bothleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return future_bothleftthrows(rpcOptions, foo);
}

folly::SemiFuture<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::semifuture_bothleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return semifuture_bothleftthrows(rpcOptions, foo);
}

folly::Future<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::future_bothleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  folly::Promise<apache::thrift::SemiStream<int32_t>> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<apache::thrift::FutureCallback<apache::thrift::SemiStream<int32_t>>>(std::move(_promise), recv_wrapped_bothleftthrows, channel_);
  bothleftthrows(rpcOptions, std::move(callback), foo);
  return _future;
}

folly::SemiFuture<apache::thrift::SemiStream<int32_t>> PubSubStreamingServiceAsyncClient::semifuture_bothleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  auto callbackAndFuture = makeSemiFutureCallback(recv_wrapped_bothleftthrows, channel_);
  auto callback = std::move(callbackAndFuture.first);
  bothleftthrows(rpcOptions, std::move(callback), foo);
  return std::move(callbackAndFuture.second);
}

folly::Future<std::pair<apache::thrift::SemiStream<int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> PubSubStreamingServiceAsyncClient::header_future_bothleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  folly::Promise<std::pair<apache::thrift::SemiStream<int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<apache::thrift::HeaderFutureCallback<apache::thrift::SemiStream<int32_t>>>(std::move(_promise), recv_wrapped_bothleftthrows, channel_);
  bothleftthrows(rpcOptions, std::move(callback), foo);
  return _future;
}

folly::SemiFuture<std::pair<apache::thrift::SemiStream<int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> PubSubStreamingServiceAsyncClient::header_semifuture_bothleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  auto callbackAndFuture = makeHeaderSemiFutureCallback(recv_wrapped_bothleftthrows, channel_);
  auto callback = std::move(callbackAndFuture.first);
  bothleftthrows(rpcOptions, std::move(callback), foo);
  return std::move(callbackAndFuture.second);
}
void PubSubStreamingServiceAsyncClient::bothleftthrows(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, int32_t foo) {
  bothleftthrows(std::make_unique<apache::thrift::FunctionReplyCallback>(std::move(callback)), foo);
}

folly::exception_wrapper PubSubStreamingServiceAsyncClient::recv_wrapped_bothleftthrows(apache::thrift::SemiStream<int32_t>& _return, ::apache::thrift::ClientReceiveState& state) {
  if (state.isException()) {
    return std::move(state.exception());
  }
  if (!state.buf()) {
  ...
  using result = PubSubStreamingService_bothleftthrows_presult;
  constexpr auto const fname = "bothleftthrows";
  switch (state.protocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolReader reader;
...
apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::recv_bothleftthrows(::apache::thrift::ClientReceiveState& state) {
  apache::thrift::SemiStream<int32_t> _return;
  auto ew = recv_wrapped_bothleftthrows(_return, state);
  if (ew) {
    ew.throw_exception();
  }
  return _return;
...
apache::thrift::SemiStream<int32_t> PubSubStreamingServiceAsyncClient::recv_instance_bothleftthrows(::apache::thrift::ClientReceiveState& state) {
  return recv_bothleftthrows(state);
}

folly::exception_wrapper PubSubStreamingServiceAsyncClient::recv_instance_wrapped_bothleftthrows(apache::thrift::SemiStream<int32_t>& _return, ::apache::thrift::ClientReceiveState& state) {
  return recv_wrapped_bothleftthrows(_return, state);
}

void PubSubStreamingServiceAsyncClient::responseandstreamleftthrows(std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  responseandstreamleftthrows(rpcOptions, std::move(callback), foo);
}

void PubSubStreamingServiceAsyncClient::responseandstreamleftthrows(apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, int32_t foo) {
  auto ctx = std::make_shared<apache::thrift::detail::ac::ClientRequestContext>(
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId(),
      rpcOptions.releaseWriteHeaders(),
      this->handlers_,
      this->getServiceName(),
      "PubSubStreamingService.responseandstreamleftthrows");
  apache::thrift::RequestCallback::Context callbackContext;
  callbackContext.protocolId =
      apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  callbackContext.ctx = std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx);
  responseandstreamleftthrowsImpl(rpcOptions, std::move(ctx), apache::thrift::toRequestClientCallbackPtr(std::move(callback), std::move(callbackContext)), foo);
}

void PubSubStreamingServiceAsyncClient::responseandstreamleftthrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, int32_t foo) {
  switch (apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolWriter writer;
      responseandstreamleftthrowsT(&writer, rpcOptions, std::move(ctx), std::move(callback), foo);
      break;
    }
    case apache::thrift::protocol::T_COMPACT_PROTOCOL:
    {
...
apache::thrift::ResponseAndSemiStream<int32_t,int32_t> PubSubStreamingServiceAsyncClient::sync_responseandstreamleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return sync_responseandstreamleftthrows(rpcOptions, foo);
}

apache::thrift::ResponseAndSemiStream<int32_t,int32_t> PubSubStreamingServiceAsyncClient::sync_responseandstreamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  apache::thrift::ClientReceiveState _returnState;
  apache::thrift::ClientSyncCallback<false> callback(&_returnState);
  auto protocolId = apache::thrift::GeneratedAsyncClient::getChannel()->getProtocolId();
  auto evb = apache::thrift::GeneratedAsyncClient::getChannel()->getEventBase();
  auto ctx = std::make_shared<apache::thrift::detail::ac::ClientRequestContext>(
      ...
      this->getServiceName(),
      "PubSubStreamingService.responseandstreamleftthrows");
  responseandstreamleftthrowsImpl(rpcOptions, ctx, apache::thrift::RequestClientCallback::Ptr(&callback), foo);
  callback.waitUntilDone(evb);
  _returnState.resetProtocolId(protocolId);
  _returnState.resetCtx(std::shared_ptr<apache::thrift::ContextStack>(ctx, &ctx->ctx));
  SCOPE_EXIT {
  ...
  return recv_responseandstreamleftthrows(_returnState);
}



folly::Future<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>> PubSubStreamingServiceAsyncClient::future_responseandstreamleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return future_responseandstreamleftthrows(rpcOptions, foo);
}

folly::SemiFuture<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>> PubSubStreamingServiceAsyncClient::semifuture_responseandstreamleftthrows(int32_t foo) {
  ::apache::thrift::RpcOptions rpcOptions;
  return semifuture_responseandstreamleftthrows(rpcOptions, foo);
}

folly::Future<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>> PubSubStreamingServiceAsyncClient::future_responseandstreamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  folly::Promise<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<apache::thrift::FutureCallback<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>>>(std::move(_promise), recv_wrapped_responseandstreamleftthrows, channel_);
  responseandstreamleftthrows(rpcOptions, std::move(callback), foo);
  return _future;
}

folly::SemiFuture<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>> PubSubStreamingServiceAsyncClient::semifuture_responseandstreamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  auto callbackAndFuture = makeSemiFutureCallback(recv_wrapped_responseandstreamleftthrows, channel_);
  auto callback = std::move(callbackAndFuture.first);
  responseandstreamleftthrows(rpcOptions, std::move(callback), foo);
  return std::move(callbackAndFuture.second);
}

folly::Future<std::pair<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> PubSubStreamingServiceAsyncClient::header_future_responseandstreamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  folly::Promise<std::pair<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> _promise;
  auto _future = _promise.getFuture();
  auto callback = std::make_unique<apache::thrift::HeaderFutureCallback<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>>>(std::move(_promise), recv_wrapped_responseandstreamleftthrows, channel_);
  responseandstreamleftthrows(rpcOptions, std::move(callback), foo);
  return _future;
}

folly::SemiFuture<std::pair<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>, std::unique_ptr<apache::thrift::transport::THeader>>> PubSubStreamingServiceAsyncClient::header_semifuture_responseandstreamleftthrows(apache::thrift::RpcOptions& rpcOptions, int32_t foo) {
  auto callbackAndFuture = makeHeaderSemiFutureCallback(recv_wrapped_responseandstreamleftthrows, channel_);
  auto callback = std::move(callbackAndFuture.first);
  responseandstreamleftthrows(rpcOptions, std::move(callback), foo);
  return std::move(callbackAndFuture.second);
}
void PubSubStreamingServiceAsyncClient::responseandstreamleftthrows(folly::Function<void (::apache::thrift::ClientReceiveState&&)> callback, int32_t foo) {
  responseandstreamleftthrows(std::make_unique<apache::thrift::FunctionReplyCallback>(std::move(callback)), foo);
}

folly::exception_wrapper PubSubStreamingServiceAsyncClient::recv_wrapped_responseandstreamleftthrows(apache::thrift::ResponseAndSemiStream<int32_t,int32_t>& _return, ::apache::thrift::ClientReceiveState& state) {
  if (state.isException()) {
    return std::move(state.exception());
  }
  if (!state.buf()) {
  ...
  using result = PubSubStreamingService_responseandstreamleftthrows_presult;
  constexpr auto const fname = "responseandstreamleftthrows";
  switch (state.protocolId()) {
    case apache::thrift::protocol::T_BINARY_PROTOCOL:
    {
      apache::thrift::BinaryProtocolReader reader;
...
apache::thrift::ResponseAndSemiStream<int32_t,int32_t> PubSubStreamingServiceAsyncClient::recv_responseandstreamleftthrows(::apache::thrift::ClientReceiveState& state) {
  apache::thrift::ResponseAndSemiStream<int32_t,int32_t> _return;
  auto ew = recv_wrapped_responseandstreamleftthrows(_return, state);
  if (ew) {
    ew.throw_exception();
  }
  return _return;
...
apache::thrift::ResponseAndSemiStream<int32_t,int32_t> PubSubStreamingServiceAsyncClient::recv_instance_responseandstreamleftthrows(::apache::thrift::ClientReceiveState& state) {
  return recv_responseandstreamleftthrows(state);
}

folly::exception_wrapper PubSubStreamingServiceAsyncClient::recv_instance_wrapped_responseandstreamleftthrows(apache::thrift::ResponseAndSemiStream<int32_t,int32_t>& _return, ::apache::thrift::ClientReceiveState& state) {
  return recv_wrapped_responseandstreamleftthrows(_return, state);
}
