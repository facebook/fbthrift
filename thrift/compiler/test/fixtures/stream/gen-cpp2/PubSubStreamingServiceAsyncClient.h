...
class PubSubStreamingServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<apache::thrift::SemiStream<int32_t>> co_returnstream(int32_t i32_from, int32_t i32_to);
#endif
 ...
 private:
  void takesstreamImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::Stream<int32_t> instream, int32_t other_param);
 public:
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_takesstream(apache::thrift::Stream<int32_t> instream, int32_t other_param);
#endif
 ...
 private:
  template <typename Protocol_>
  void takesstreamT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::Stream<int32_t> instream, int32_t other_param);
 public:
 ...
 private:
  void differentImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::Stream<int32_t> foo, int64_t firstparam);
 public:
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<apache::thrift::SemiStream<std::string>> co_different(apache::thrift::Stream<int32_t> foo, int64_t firstparam);
#endif
 ...
 private:
  template <typename Protocol_>
  void differentT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::Stream<int32_t> foo, int64_t firstparam);
 public:
 ...
 private:
  void normalthrowsImpl(apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::Stream<int32_t> foo);
 public:
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_normalthrows(apache::thrift::Stream<int32_t> foo);
#endif
 ...
 private:
  template <typename Protocol_>
  void normalthrowsT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::shared_ptr<apache::thrift::detail::ac::ClientRequestContext> ctx, apache::thrift::RequestClientCallback::Ptr callback, apache::thrift::Stream<int32_t> foo);
 public:
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<apache::thrift::SemiStream<int32_t>> co_streamthrows(int32_t foo);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<apache::thrift::SemiStream<int32_t>> co_boththrows(int32_t foo);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>> co_responseandstreamthrows(int32_t foo);
#endif
