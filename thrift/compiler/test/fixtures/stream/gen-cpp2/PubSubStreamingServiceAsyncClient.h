...
class PubSubStreamingServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
 ...
 public:
  ...
  FOLLY_NODISCARD [[deprecated("To be replaced by new API soon")]] virtual folly::Try<apache::thrift::RpcResponseComplete<apache::thrift::SemiStream<int32_t>>> sync_complete_returnstream(
 ...
 public:
  ...
  FOLLY_NODISCARD [[deprecated("To be replaced by new API soon")]] virtual folly::Try<apache::thrift::RpcResponseComplete<apache::thrift::SemiStream<int32_t>>> sync_complete_streamthrows(
 ...
 public:
  ...
  FOLLY_NODISCARD [[deprecated("To be replaced by new API soon")]] virtual folly::Try<apache::thrift::RpcResponseComplete<apache::thrift::SemiStream<int32_t>>> sync_complete_boththrows(
      apache::thrift::RpcOptions& rpcOptions,  int32_t foo);
 ...
 public:
  ...
  FOLLY_NODISCARD [[deprecated("To be replaced by new API soon")]] virtual folly::Try<apache::thrift::RpcResponseComplete<apache::thrift::ResponseAndSemiStream<int32_t,int32_t>>> sync_complete_responseandstreamthrows(
      apache::thrift::RpcOptions& rpcOptions,  int32_t foo);
