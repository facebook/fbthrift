...
class Item:
    ...
    def to_python_struct(self) -> "simple.dependent.dependent.thrift_types.Item": ...   # type: ignore
    def to_py3_struct(self) -> "simple.dependent.dependent.types.Item": ...   # type: ignore
