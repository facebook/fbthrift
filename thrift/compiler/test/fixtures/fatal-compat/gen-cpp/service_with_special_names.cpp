...
void service_with_special_namesClient::send_keys()
{
  ...
  oprot_->writeMessageEnd();
  uint32_t _bytes680 = oprot_->getTransport()->writeEnd();
  oprot_->getTransport()->flush();
  if (ctx) ctx->postWrite(_bytes680);
  return;
}
...
void service_with_special_namesClient::send_annotation()
{
  ...
  oprot_->writeMessageEnd();
  uint32_t _bytes681 = oprot_->getTransport()->writeEnd();
  oprot_->getTransport()->flush();
  if (ctx) ctx->postWrite(_bytes681);
  return;
}
...
void service_with_special_namesClient::send_annotations()
{
  ...
  oprot_->writeMessageEnd();
  uint32_t _bytes682 = oprot_->getTransport()->writeEnd();
  oprot_->getTransport()->flush();
  if (ctx) ctx->postWrite(_bytes682);
  return;
}
...
void service_with_special_namesClient::send_member()
{
  ...
  oprot_->writeMessageEnd();
  uint32_t _bytes683 = oprot_->getTransport()->writeEnd();
  oprot_->getTransport()->flush();
  if (ctx) ctx->postWrite(_bytes683);
  return;
}
...
void service_with_special_namesClient::send_members()
{
  ...
  oprot_->writeMessageEnd();
  uint32_t _bytes684 = oprot_->getTransport()->writeEnd();
  oprot_->getTransport()->flush();
  if (ctx) ctx->postWrite(_bytes684);
  return;
}
...
bool service_with_special_namesProcessor::dispatchCall(::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& _fname, int32_t seqid, apache::thrift::server::TConnectionContext* connectionContext) {
