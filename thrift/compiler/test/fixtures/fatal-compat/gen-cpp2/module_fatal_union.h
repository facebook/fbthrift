...
class union_with_special_names_Type_enum_traits {
  ...
  public:
  using type = ::test_cpp1::cpp_reflection::union_with_special_names::Type;
  using name = thrift_fatal_impl_detail::test_cpp2_cpp_reflection_module__unique_strings_list::Type;
  using str = Type__struct_unique_strings_list;
  using names = ::fatal::list<
      str::get,
...
FATAL_REGISTER_ENUM_TRAITS(
  ::test_cpp1::cpp_reflection::thrift_fatal_impl_detail::union_with_special_names_Type_enum_traits,
  ::apache::thrift::detail::type_common_metadata_impl<
    module_tags::module,
    ::apache::thrift::reflected_annotations<::test_cpp1::cpp_reflection::thrift_fatal_impl_detail::union_with_special_names_Type_enum_traits::annotations>,
    static_cast<::apache::thrift::legacy_type_id_t>(0ull)
  >
);
...
class union_with_special_names_variant_traits {
  struct union_with_special_names__struct_unique_identifiers_list {
    using get = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::get>;
    using getter = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::getter>;
    using lists = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::lists>;
    using maps = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::maps>;
    using name = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::name>;
    using name_to_value = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::name_to_value>;
    using names = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::names>;
    using prefix_tree = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::prefix_tree>;
    using sets = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::sets>;
    using setter = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::setter>;
    using str = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::str>;
    using strings = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::strings>;
    using type = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::type>;
    using value = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::value>;
    using value_to_name = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::value_to_name>;
    using values = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::values>;
    using id = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::id>;
    using ids = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::ids>;
    using descriptor = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::descriptor>;
    using descriptors = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::descriptors>;
    using key = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::key>;
    using keys = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::keys>;
    using annotation = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::annotation>;
    using annotations = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::annotations>;
    using member = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::member>;
    using members = std::integral_constant<::test_cpp1::cpp_reflection::union_with_special_names::Type, ::test_cpp1::cpp_reflection::union_with_special_names::Type::members>;
  };
  ...
  public:
  using type = ::test_cpp1::cpp_reflection::union_with_special_names;
...
FATAL_REGISTER_VARIANT_TRAITS(
  ::test_cpp1::cpp_reflection::thrift_fatal_impl_detail::union_with_special_names_variant_traits,
  ::apache::thrift::detail::type_common_metadata_impl<
    module_tags::module,
    ::apache::thrift::reflected_annotations<::test_cpp1::cpp_reflection::thrift_fatal_impl_detail::union_with_special_names_variant_traits::annotations>,
