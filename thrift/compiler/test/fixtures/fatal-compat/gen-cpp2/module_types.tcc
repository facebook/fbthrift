        ...
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->j.emplace_back();
              std::vector<int32_t>::reference _elem_r = obj->j.back();
              xfer += iprot->readI32(_elem_r);
            }
          }
          else {
            obj->j.resize(_size_r);
            for (std::vector<int32_t>::reference _elem_r : obj->j) {
              xfer += iprot->readI32(_elem_r);
            }
          }
      ...
      case 11:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->j1.emplace_back();
              std::vector<int32_t>::reference _elem_r = obj->j1.back();
              xfer += iprot->readI32(_elem_r);
            }
          }
          else {
            obj->j1.resize(_size_r);
            for (std::vector<int32_t>::reference _elem_r : obj->j1) {
              xfer += iprot->readI32(_elem_r);
            }
          }
          xfer += iprot->readListEnd();
      ...
      case 12:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->j2.emplace_back();
              std::vector< ::test_cpp2::cpp_reflection::enum1>::reference _elem_r = obj->j2.back();
              int32_t ecast6;
            ...
            for (std::vector< ::test_cpp2::cpp_reflection::enum1>::reference _elem_r : obj->j2) {
              int32_t ecast7;
      ...
      case 13:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->j3.emplace_back();
              std::vector< ::test_cpp2::cpp_reflection::structA>::reference _elem_r = obj->j3.back();
              xfer += ::apache::thrift::Cpp2Ops<  ::test_cpp2::cpp_reflection::structA>::read(iprot, &_elem_r);
            }
          }
          else {
            obj->j3.resize(_size_r);
            for (std::vector< ::test_cpp2::cpp_reflection::structA>::reference _elem_r : obj->j3) {
              xfer += ::apache::thrift::Cpp2Ops<  ::test_cpp2::cpp_reflection::structA>::read(iprot, &_elem_r);
            }
          }
          xfer += iprot->readListEnd();
    ...
    switch (fid) {
      ...
      case 9:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->fieldI.emplace_back();
              std::vector<int32_t>::reference _elem_r = obj->fieldI.back();
              xfer += iprot->readI32(_elem_r);
            }
          }
          else {
            obj->fieldI.resize(_size_r);
            for (std::vector<int32_t>::reference _elem_r : obj->fieldI) {
              xfer += iprot->readI32(_elem_r);
            }
          }
          xfer += iprot->readListEnd();
      ...
      case 10:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->fieldJ.emplace_back();
              std::vector<std::string>::reference _elem_r = obj->fieldJ.back();
              xfer += iprot->readString(_elem_r);
            }
          }
          else {
            obj->fieldJ.resize(_size_r);
            for (std::vector<std::string>::reference _elem_r : obj->fieldJ) {
              xfer += iprot->readString(_elem_r);
            }
          }
          xfer += iprot->readListEnd();
      ...
      case 11:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->fieldK.emplace_back();
              std::vector<std::string>::reference _elem_r = obj->fieldK.back();
              xfer += iprot->readString(_elem_r);
            }
          }
          else {
            obj->fieldK.resize(_size_r);
            for (std::vector<std::string>::reference _elem_r : obj->fieldK) {
              xfer += iprot->readString(_elem_r);
            }
          }
          xfer += iprot->readListEnd();
      ...
      case 12:
      {
        if (ftype == apache::thrift::protocol::T_LIST) {
          ...
          if (_size_r == std::numeric_limits<uint32_t>::max()) {
            while (iprot->peekList()) {
              obj->fieldL.emplace_back();
              std::vector< ::test_cpp2::cpp_reflection::structA>::reference _elem_r = obj->fieldL.back();
              xfer += ::apache::thrift::Cpp2Ops<  ::test_cpp2::cpp_reflection::structA>::read(iprot, &_elem_r);
            }
          }
          else {
            obj->fieldL.resize(_size_r);
            for (std::vector< ::test_cpp2::cpp_reflection::structA>::reference _elem_r : obj->fieldL) {
              xfer += ::apache::thrift::Cpp2Ops<  ::test_cpp2::cpp_reflection::structA>::read(iprot, &_elem_r);
            }
          }
          xfer += iprot->readListEnd();
