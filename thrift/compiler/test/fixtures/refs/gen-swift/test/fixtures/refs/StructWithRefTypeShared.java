...
public final class StructWithRefTypeShared {
    ...
    public StructWithRefTypeShared(
        @ThriftField(value=1, name="def_field", requiredness=Requiredness.NONE, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref_type", value = "shared") }) final test.fixtures.refs.Empty defField,
        @ThriftField(value=2, name="opt_field", requiredness=Requiredness.OPTIONAL, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref_type", value = "shared") }) final test.fixtures.refs.Empty optField,
        @ThriftField(value=3, name="req_field", requiredness=Requiredness.REQUIRED, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref_type", value = "shared") }) final test.fixtures.refs.Empty reqField
    ) {
    ...
    @ThriftField(value=1, name="def_field", requiredness=Requiredness.NONE, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref_type", value = "shared") })
    public test.fixtures.refs.Empty getDefField() { return defField; }
        
    @ThriftField(value=2, name="opt_field", requiredness=Requiredness.OPTIONAL, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref_type", value = "shared") })
    public test.fixtures.refs.Empty getOptField() { return optField; }
        
    @ThriftField(value=3, name="req_field", requiredness=Requiredness.REQUIRED, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref_type", value = "shared") })
