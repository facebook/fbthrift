...
public final class StructWithRef {
    ...
    public StructWithRef(
        ...
        @ThriftField(value=2, name="opt_field", requiredness=Requiredness.OPTIONAL, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref", value = "1") }) final test.fixtures.refs.Empty optField,
        @ThriftField(value=3, name="req_field", requiredness=Requiredness.REQUIRED, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref", value = "1") }) final test.fixtures.refs.Empty reqField
    ) {
    ...
    @ThriftField(value=2, name="opt_field", requiredness=Requiredness.OPTIONAL, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref", value = "1") })
    public test.fixtures.refs.Empty getOptField() { return optField; }
        
    @ThriftField(value=3, name="req_field", requiredness=Requiredness.REQUIRED, idlAnnotations = { @ThriftIdlAnnotation(key = "cpp.ref", value = "1") })
