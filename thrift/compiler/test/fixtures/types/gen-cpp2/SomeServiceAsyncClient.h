...
class SomeServiceAsyncClient : public apache::thrift::GeneratedAsyncClient {
 ...
 private:
  virtual void binary_keyed_mapImpl(bool useSync, apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const std::vector<int64_t>& r);
 public:
 ...
 private:
  template <typename Protocol_>
  void binary_keyed_mapT(Protocol_* prot, bool useSync, apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback, const std::vector<int64_t>& r);
 public:
};
