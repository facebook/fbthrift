...
class ContainerStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.ContainerStruct):
    ...
    def __init__(
        self, *,
        fieldB: _fbthrift_python_mutable_containers.MutableList[builtins.int] | _fbthrift_python_mutable_types._ThriftListWrapper=...,
        fieldC: _fbthrift_python_mutable_containers.MutableList[builtins.int] | _fbthrift_python_mutable_types._ThriftListWrapper=...,
        fieldD: _fbthrift_python_mutable_containers.MutableList[builtins.int] | _fbthrift_python_mutable_types._ThriftListWrapper=...,
        fieldE: _fbthrift_python_mutable_containers.MutableList[builtins.int] | _fbthrift_python_mutable_types._ThriftListWrapper=...,
        fieldF: _fbthrift_python_mutable_containers.MutableSet[builtins.int] | _fbthrift_python_mutable_types._ThriftSetWrapper=...,
        fieldG: _fbthrift_python_mutable_containers.MutableMap[builtins.int, builtins.str] | _fbthrift_python_mutable_types._ThriftMapWrapper=...,
        fieldH: _fbthrift_python_mutable_containers.MutableMap[builtins.int, builtins.str] | _fbthrift_python_mutable_types._ThriftMapWrapper=...,
        fieldA: _fbthrift_python_mutable_containers.MutableList[builtins.int] | _fbthrift_python_mutable_types._ThriftListWrapper=...
    ) -> None: ...
...
class MyStructWithForwardRefEnum(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.MyStructWithForwardRefEnum):
    ...
    def __init__(
        self, *,
        a: _fbthrift_MyForwardRefEnum=...,
        b: _fbthrift_MyForwardRefEnum=...
    ) -> None: ...
...
class ComplexString(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.ComplexString):
    ...
    def __init__(
        self, *,
        a: builtins.str=...,
        b: _fbthrift_python_mutable_containers.MutableMap[builtins.str, builtins.int] | _fbthrift_python_mutable_types._ThriftMapWrapper=...
    ) -> None: ...
...
class MyStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.MyStruct):
    ...
    def __init__(
        ...
        majorVer: builtins.int=...,
        data: _fbthrift_MyDataItem=...
    ) -> None: ...
...
class AnnotatedTypes(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.AnnotatedTypes):
    ...
    def __init__(
        ...
        list_field: _fbthrift_python_mutable_containers.MutableList[_fbthrift_python_mutable_containers.MutableMap[builtins.int, builtins.str]] | _fbthrift_python_mutable_types._ThriftListWrapper=...
    ) -> None: ...
...
class AllocatorAware(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.AllocatorAware):
    ...
    def __init__(
        self, *,
        aa_list: _fbthrift_python_mutable_containers.MutableList[builtins.int] | _fbthrift_python_mutable_types._ThriftListWrapper=...,
        aa_set: _fbthrift_python_mutable_containers.MutableSet[builtins.int] | _fbthrift_python_mutable_types._ThriftSetWrapper=...,
        aa_map: _fbthrift_python_mutable_containers.MutableMap[builtins.int, builtins.int] | _fbthrift_python_mutable_types._ThriftMapWrapper=...,
        aa_string: builtins.str=...,
        not_a_container: builtins.int=...,
        aa_unique: builtins.int=...,
        aa_shared: builtins.int=...
    ) -> None: ...
...
class TypedefStruct(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.TypedefStruct):
    ...
    def __init__(
        self, *,
        i32_field: builtins.int=...,
        IntTypedef_field: builtins.int=...,
        UintTypedef_field: builtins.int=...
    ) -> None: ...
...
class StructWithDoubleUnderscores(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types.StructWithDoubleUnderscores):
    ...
    def __init__(
        self, *,
        _StructWithDoubleUnderscores__field: builtins.int=...
    ) -> None: ...
