...
class ContainerStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        fieldI: _typing.Optional[_typing.Mapping[str, str]]=None
    ) -> None: ...
    ...
    def __call__(
        ...
        fieldI: _typing.Union[_typing.Mapping[str, str], NOTSETTYPE, None]=NOTSET
    ) -> ContainerStruct: ...
    ...
    @property
    def fieldI(self) -> _typing.Mapping[str, str]: ...
...
class folly_sorted_vector_map__Map__string_string(_typing.Mapping[str, str], _typing.Hashable):
