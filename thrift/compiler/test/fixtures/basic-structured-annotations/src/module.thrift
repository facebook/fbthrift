...
@structured_annotation_inline {count = 1}@structured_annotation_with_default {
  name = 'abc',
}
...
@structured_annotation_inline {
  count = 2,
}@structured_annotation_with_default {}@structured_annotation_nested {
  name = 'nesty2',
  nest = structured_annotation_with_default {name = 'dcdbdcdadcdbdcd'},
}@included.structured_annotation_included {
  name = 'aba',
