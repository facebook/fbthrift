...
instance Hashable Init_args where
  hashWithSalt salt record = salt   `hashWithSalt` init_args_int1 record   `hashWithSalt` init_args_int2 record   `hashWithSalt` init_args_int3 record   `hashWithSalt` init_args_int4 record   `hashWithSalt` init_args_int5 record   `hashWithSalt` init_args_int6 record   `hashWithSalt` init_args_int7 record   `hashWithSalt` init_args_int8 record   `hashWithSalt` init_args_int9 record   `hashWithSalt` init_args_int10 record   `hashWithSalt` init_args_int11 record  
...
typemap_Init_args = Map.fromList [("int1",(1,T_I64)),("int2",(2,T_I64)),("int3",(3,T_I64)),("int4",(4,T_I64)),("int5",(5,T_I64)),("int6",(6,T_I64)),("int7",(7,T_I64)),("int8",(8,T_I64)),("int9",(9,T_I64)),("int10",(10,T_I64)),("int11",(11,T_I64))]
...
from_Init_result record = TStruct $ Map.fromList $ catMaybes
  [ (\_v18 -> Just (0, ("success",TI64 _v18))) $ init_result_success record
  ]
...
to_Init_result (TStruct fields) = Init_result{
  init_result_success = maybe (init_result_success default_Init_result) (\(_,_val20) -> (case _val20 of {TI64 _val21 -> _val21; _ -> error "wrong type"})) (Map.lookup (0) fields)
  }
...
process_init (seqid, iprot, oprot, handler) = do
  ...
  (Control.Exception.catch
    (do
      val <- Iface.init handler (init_args_int1 args) (init_args_int2 args) (init_args_int3 args) (init_args_int4 args) (init_args_int5 args) (init_args_int6 args) (init_args_int7 args) (init_args_int8 args) (init_args_int9 args) (init_args_int10 args) (init_args_int11 args)
