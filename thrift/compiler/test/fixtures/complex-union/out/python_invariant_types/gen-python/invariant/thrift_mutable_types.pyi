...
class InvariantTypes(_fbthrift_python_mutable_types.MutableUnion, _fbthrift_python_abstract_types.InvariantTypes):
    ...
    def __init__(
        self, *,
        struct_map: _fbthrift_python_mutable_containers.MutableMap[_fbthrift_StructForInvariantTypes, builtins.int] | _fbthrift_python_mutable_types._ThriftMapWrapper=...,
        union_map: _fbthrift_python_mutable_containers.MutableMap[_fbthrift_UnionForInvariantTypes, builtins.int] | _fbthrift_python_mutable_types._ThriftMapWrapper=...
    ) -> None: ...
