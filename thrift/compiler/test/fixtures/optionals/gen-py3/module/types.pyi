...
class Color(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['Color'], _builtins.bytes]]: ...
...
class Vehicle(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        licensePlate: _typing.Optional[_builtins.str]=None,
        description: _typing.Optional[_builtins.str]=None,
    ...
    def __call__(
        ...
        licensePlate: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        description: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        name: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        hasAC: _typing.Union[bool, NOTSETTYPE, None]=NOTSET
    ) -> Vehicle: ...

    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['Vehicle'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    ...
    @property
    def licensePlate(self) -> _typing.Optional[_builtins.str]: ...
    @property
    def description(self) -> _typing.Optional[_builtins.str]: ...
    @property
    def name(self) -> _typing.Optional[_builtins.str]: ...
    @property
    def hasAC(self) -> bool: ...
...
class Person(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        address: _typing.Optional[_builtins.str]=None,
        ...
        petNames: _typing.Optional[_typing.Mapping[Animal, _builtins.str]]=None,
    ...
    def __call__(
        ...
        address: _typing.Union[_builtins.str, NOTSETTYPE, None]=NOTSET,
        ...
        petNames: _typing.Union[_typing.Mapping[Animal, _builtins.str], NOTSETTYPE, None]=NOTSET,
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['Person'], _builtins.bytes]]: ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Any]]: ...
    def __bool__(self) -> bool: ...
    def __hash__(self) -> int: ...
    def __repr__(self) -> str: ...
    ...
    @property
    def address(self) -> _typing.Optional[_builtins.str]: ...
    @property
    ...
    @property
    def petNames(self) -> _typing.Optional[_typing.Mapping[Animal, _builtins.str]]: ...
    @property
...
class Map__Animal_string(_typing.Mapping[Animal, _builtins.str], _typing.Hashable):
    def __init__(self, items: _typing.Mapping[Animal, _builtins.str]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __contains__(self, x: object) -> bool: ...
    def __getitem__(self, key: Animal) -> _builtins.str: ...
