...
#include "thrift/compiler/test/fixtures/maps-with-incomplete-types/gen-cpp2/self-reference_types.tcc"

#include <thrift/lib/cpp2/gen/module_types_cpp.h>

#include "thrift/compiler/test/fixtures/maps-with-incomplete-types/gen-cpp2/self-reference_data.h"
...
bool A::operator<(const A& rhs) const {
  ...
  (void)lhs;
  if (!(lhs.some_map_ref() == rhs.some_map_ref())) {
    return lhs.some_map_ref() < rhs.some_map_ref();
  }
  return false;
}
