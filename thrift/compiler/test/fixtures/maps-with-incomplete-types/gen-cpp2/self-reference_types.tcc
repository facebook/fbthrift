...
_readField_some_map:
  {
    ...
    this->__fbthrift_field_some_map = ::std::map<::std::int32_t, ::apache::thrift::test::A>();
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::structure>, ::std::map<::std::int32_t, ::apache::thrift::test::A>>::readWithContext(*iprot, this->__fbthrift_field_some_map, _readState);
...
uint32_t A::serializedSize(Protocol_ const* prot_) const {
  ...
  if (this->__isset.get(0)) {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::structure>, ::std::map<::std::int32_t, ::apache::thrift::test::A>>::serializedSize<false>(*prot_, this->__fbthrift_field_some_map);
  }
...
uint32_t A::write(Protocol_* prot_) const {
  ...
  if (this->__isset.get(0)) {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::map<::apache::thrift::type_class::integral, ::apache::thrift::type_class::structure>, ::std::map<::std::int32_t, ::apache::thrift::test::A>>::write(*prot_, this->__fbthrift_field_some_map);
