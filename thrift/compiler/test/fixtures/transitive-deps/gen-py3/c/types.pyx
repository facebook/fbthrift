...
cdef class C(thrift.py3.types.Struct):
    def __init__(C self, **kwargs):
        ...
        self._fields_setter = __fbthrift_types_fields.__C_FieldsSetter.create(self._cpp_obj.get())
    ...
    def __call__(C self, **kwargs):
        ...
        __fbthrift_inst._fields_setter = __fbthrift_types_fields.__C_FieldsSetter.create(__fbthrift_inst._cpp_obj.get())
