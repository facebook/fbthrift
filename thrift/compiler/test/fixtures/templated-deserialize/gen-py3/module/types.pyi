...
class SmallStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __reduce__(self) -> _typing.Tuple[_typing.Callable, _typing.Tuple[_typing.Type['SmallStruct'], _builtins.bytes]]: ...
...
class containerStruct(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    def __init__(
        ...
        fieldR: _typing.Optional[_typing.Mapping[_builtins.str, bool]]=None,
    ...
    def __call__(
        ...
        fieldR: _typing.Union[_typing.Mapping[_builtins.str, bool], NOTSETTYPE, None]=NOTSET,
    ...
    @property
    def fieldR(self) -> _typing.Optional[_typing.Mapping[_builtins.str, bool]]: ...
    @property
