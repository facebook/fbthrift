...
class MyStructFloatFieldThrowExp(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[None, int, int, str, float]]]: ...
...
class MyStructMapFloatThrowExp(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[None, int, _typing.Mapping[int, _typing.Sequence[_typing.Sequence[float]]]]]]: ...
...
class MyStructTypeDef(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[None, int, int, str, str, _typing.Mapping[int, str], _typing.Mapping[int, str], _typing.Sequence[float], _typing.Sequence[float], _typing.Mapping[int, _typing.Sequence[_typing.Sequence[float]]]]]]: ...
...
class TypeRemapped(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[None, _typing.Mapping[int, str], _typing.Mapping[int, _typing.Mapping[int, int]], int, bytes]]]: ...
...
class complexException(_fbthrift_py3lite_exceptions.GeneratedError):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[None, str, _typing.Sequence[str], MyEnum, MyUnion, MyStruct, _typing.Mapping[int, str]]]]: ...
