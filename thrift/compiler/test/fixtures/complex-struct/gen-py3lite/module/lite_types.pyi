...
class MyStructFloatFieldThrowExp(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, int, str, float]]]: ...
...
class MyStructMapFloatThrowExp(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, _typing.Mapping[int, _typing.Sequence[_typing.Sequence[float]]]]]]: ...
...
class MyStruct(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, str, MyDataItem, MyEnum, bool, int, int, int, float, _typing.Sequence[float], _typing.Sequence[int], _typing.Sequence[int], _typing.Sequence[int], _typing.Sequence[str], _typing.Sequence[bool], _typing.Sequence[int], _typing.Mapping[int, str], _typing.Mapping[int, str], _typing.Mapping[str, MyStruct], _typing.Mapping[str, bool], _typing.Mapping[int, int], _typing.Mapping[int, bool], _typing.AbstractSet[int], _typing.AbstractSet[MyStruct], _typing.AbstractSet[int], _typing.AbstractSet[str], _typing.AbstractSet[int], _typing.Mapping[_typing.Sequence[int], _typing.Sequence[int]]]]]: ...
...
class SimpleStruct(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, str]]]: ...
...
class MyStructTypeDef(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, int, str, str, _typing.Mapping[int, str], _typing.Mapping[int, str], _typing.Sequence[float], _typing.Sequence[float], _typing.Mapping[int, _typing.Sequence[_typing.Sequence[float]]]]]]: ...
...
class ComplexNestedStruct(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, _typing.AbstractSet[_typing.AbstractSet[int]], _typing.Sequence[_typing.Sequence[_typing.Sequence[_typing.Sequence[MyEnum]]]], _typing.Sequence[_typing.Sequence[MyStruct]], _typing.AbstractSet[_typing.Sequence[_typing.Sequence[int]]], _typing.AbstractSet[_typing.AbstractSet[_typing.AbstractSet[int]]], _typing.Mapping[int, _typing.Sequence[_typing.Sequence[MyStruct]]], _typing.Mapping[MyStruct, int], _typing.Sequence[_typing.Mapping[int, int]], _typing.Sequence[_typing.Mapping[str, _typing.Sequence[MyStruct]]], _typing.Mapping[_typing.AbstractSet[int], int], _typing.Mapping[_typing.Sequence[str], int], _typing.Mapping[_typing.Mapping[int, str], _typing.Mapping[int, str]], _typing.Mapping[_typing.AbstractSet[_typing.Sequence[int]], _typing.Mapping[_typing.Sequence[_typing.AbstractSet[str]], str]], _typing.Mapping[_typing.Mapping[_typing.Mapping[int, str], str], _typing.Mapping[int, str]], _typing.Mapping[int, _typing.Sequence[MyStruct]], _typing.Mapping[int, _typing.AbstractSet[bool]], _typing.Mapping[_typing.AbstractSet[bool], MyEnum], _typing.Mapping[_typing.Sequence[int], _typing.AbstractSet[_typing.Mapping[float, str]]]]]]: ...
...
class TypeRemapped(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, _typing.Mapping[int, str], _typing.Mapping[int, _typing.Mapping[int, int]], int, bytes]]]: ...
...
class complexException(_fbthrift_py3lite_exceptions.GeneratedError):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, str, _typing.Sequence[str], MyEnum, MyUnion, MyStruct, _typing.Mapping[int, str]]]]: ...
