    ...
    switch (_readState.fieldId) {
      ...
      case 4:
      {
        if (_readState.isCompatibleWithType(iprot, apache::thrift::protocol::T_STRUCT)) {
          ...
          _readState.beforeSubobject(iprot);
          ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::structure, ::cpp2::ComplexNestedStruct>::readWithContext(*iprot, this->mutable_complexNestedStruct(), _readState);
          _readState.afterSubobject(iprot);
        } else {
          _readState.skip(iprot);
        }
      ...
      case 5:
      {
        if (_readState.isCompatibleWithType(iprot, apache::thrift::protocol::T_I64)) {
          this->set_longValue();
          ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, ::std::int64_t>::readWithContext(*iprot, this->mutable_longValue(), _readState);
        } else {
          _readState.skip(iprot);
        }
        break;
      ...
      case 6:
      {
        if (_readState.isCompatibleWithType(iprot, apache::thrift::protocol::T_I32)) {
          this->set_intValue();
          ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, ::std::int32_t>::readWithContext(*iprot, this->mutable_intValue(), _readState);
        } else {
          _readState.skip(iprot);
        }
        break;
...
uint32_t MyUnion::serializedSize(Protocol_ const* prot_) const {
  ...
  switch(this->getType()) {
    ...
    case MyUnion::Type::longValue:
    {
      ...
      xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, ::std::int64_t>::serializedSize<false>(*prot_, this->get_longValue());
      break;
    }
    case MyUnion::Type::intValue:
    {
      xfer += prot_->serializedFieldSize("intValue", apache::thrift::protocol::T_I32, 6);
      xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, ::std::int32_t>::serializedSize<false>(*prot_, this->get_intValue());
      break;
    }
...
uint32_t MyUnion::write(Protocol_* prot_) const {
  ...
  switch(this->getType()) {
    ...
    case MyUnion::Type::longValue:
    {
      ...
      xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, ::std::int64_t>::write(*prot_, this->get_longValue());
      xfer += prot_->writeFieldEnd();
      break;
    }
    case MyUnion::Type::intValue:
    {
      ...
      xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::integral, ::std::int32_t>::write(*prot_, this->get_intValue());
      xfer += prot_->writeFieldEnd();
      break;
    }
    case MyUnion::Type::__EMPTY__:;
    ...
    switch (_readState.fieldId) {
      ...
      case 2:
      {
        if (_readState.isCompatibleWithType(iprot, apache::thrift::protocol::T_LIST)) {
          ...
          ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::list<::apache::thrift::type_class::list<::apache::thrift::type_class::floating_point>>, ::std::vector<::std::vector<float>>>::readWithContext(*iprot, this->mutable_setFloat(), _readState);
          _readState.afterSubobject(iprot);
        } else {
          _readState.skip(iprot);
        }
