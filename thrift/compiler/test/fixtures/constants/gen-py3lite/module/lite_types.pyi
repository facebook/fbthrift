...
class Internship(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, str, Company, float, str]]]: ...
...
class Range(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, int]]]: ...
...
class struct2(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, str, struct1, _typing.Sequence[int]]]]: ...
...
class struct3(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, str, int, struct2]]]: ...
...
class struct4(_fbthrift_py3lite_types.Struct):
    ...
    def __iter__(self) -> typing.Iterator[typing.Tuple[str, _typing.Union[None, int, float, int]]]: ...
