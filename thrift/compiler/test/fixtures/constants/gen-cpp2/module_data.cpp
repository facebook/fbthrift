...
const std::array<folly::StringPiece, 3> TStructDataStorage<::cpp2::Internship>::fields_names = {{
  "weeks",
  "title",
  "employer",
}};
const std::array<int16_t, 3> TStructDataStorage<::cpp2::Internship>::fields_ids = {{
  1,
  2,
  3,
}};
const std::array<protocol::TType, 3> TStructDataStorage<::cpp2::Internship>::fields_types = {{
  TType::T_I32,
  TType::T_STRING,
  TType::T_I32,
}};
