...
_readField_field4:
  {
    ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::floating_point, double>::readWithContext(*iprot, this->field4, _readState);
...
uint32_t Foo::serializedSize(Protocol_ const* prot_) const {
  ...
  if (this->__isset.__fbthrift_get(folly::index_constant<3>())) {
    ...
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::floating_point, double>::serializedSize<false>(*prot_, this->field4);
  }
...
uint32_t Foo::write(Protocol_* prot_) const {
  ...
  if (this->__isset.__fbthrift_get(folly::index_constant<3>())) {
    ...
    previousFieldHasValue = true;
    xfer += ::apache::thrift::detail::pm::protocol_methods<::apache::thrift::type_class::floating_point, double>::write(*prot_, this->field4);
    xfer += prot_->writeFieldEnd();
  } else {
    previousFieldHasValue = false;
  }
