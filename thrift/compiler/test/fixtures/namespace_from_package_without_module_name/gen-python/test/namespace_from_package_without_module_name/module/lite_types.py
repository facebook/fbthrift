...
class Foo(metaclass=_fbthrift_py3lite_types.StructMeta):
    ...
    def to_py3_struct(self):
        ...
        return thrift.py3.converter.to_py3_struct(
            test.namespace_from_package_without_module_name.module.types.Foo, self
        )
...
def _fbthrift_metadata__struct_Foo():
    return test.namespace_from_package_without_module_name.module.lite_metadata.gen_metadata_struct_Foo()
