...
pub mod server {
    ...
    #[derive(Clone, Debug)]
    pub struct TestServiceProcessor<P, H, R> {
        service: H,
    ...
    impl<P, H, R> TestServiceProcessor<P, H, R>
    where
            ...
            + ::std::marker::Send + ::std::marker::Sync,
    {
        ...
        ) -> ::anyhow::Result<crate::services::test_service::InitExn> {
            use ::const_cstr::const_cstr;
            use ::tracing::Instrument as _;
            use ::futures::FutureExt as _;
    ...
    #[::async_trait::async_trait]
    impl<P, H, R> ::fbthrift::ServiceProcessor<P> for TestServiceProcessor<P, H, R>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        H: TestService,
        ...
        async fn handle_method(
            ...
            match idx {
                0usize => {
                    ...
                    let res = self.handle_init(_p, _r, &mut ctx_stack).await?;
    ...
    #[::async_trait::async_trait]
    impl<P, H, R> ::fbthrift::ThriftService<P::Frame> for TestServiceProcessor<P, H, R>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        P::Frame: ::std::marker::Send + 'static,
    ...
    pub fn make_TestService_server<F, H, R>(
        ...
        <R as ::fbthrift::RequestContext>::ContextStack: ::fbthrift::ContextStack<Name = R::Name, Buffer = F::DecBuf> + ::std::marker::Send + ::std::marker::Sync + 'static
    {
        match proto {
            ::fbthrift::ProtocolID::BinaryProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(TestServiceProcessor::<::fbthrift::BinaryProtocol<F>, H, R>::new(handler)))
            }
            ::fbthrift::ProtocolID::CompactProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(TestServiceProcessor::<::fbthrift::CompactProtocol<F>, H, R>::new(handler)))
            }
            bad => {
