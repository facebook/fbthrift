  ...
  protected function recvImpl_init(?int $expectedsequenceid = null, shape(?'read_options' => int) $options = shape()): int {
    try {
      ...
      if ($this->input_ is \TBinaryProtocolAccelerated) {
        $result = \thrift_protocol_read_binary($this->input_, '\namespace_from_package_without_module_name\TestService_init_result', $this->input_->isStrictRead(), Shapes::idx($options, 'read_options', 0));
      } else if ($this->input_ is \TCompactProtocolAccelerated)
      {
        $result = \thrift_protocol_read_compact($this->input_, '\namespace_from_package_without_module_name\TestService_init_result', Shapes::idx($options, 'read_options', 0));
      }
      else
      {
        $rseqid = 0;
