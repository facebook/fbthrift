...
uint32_t LazyCppRef::write(Protocol_* prot_) const {
  ...
  if (this->field1) {
    ...
    indexWriter.recordFieldStart();
    if constexpr (Protocol_::kHasIndexSupport()) {
      if (prot_->protocolType() == __fbthrift_protocol_ && !__fbthrift_isDeserialized_.field1) {
  ...
  if (this->field2) {
    ...
    indexWriter.recordFieldStart();
    if constexpr (Protocol_::kHasIndexSupport()) {
      if (prot_->protocolType() == __fbthrift_protocol_ && !__fbthrift_isDeserialized_.field2) {
