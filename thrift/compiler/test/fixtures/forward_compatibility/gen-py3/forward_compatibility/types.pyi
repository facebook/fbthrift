...
class NewStructure2(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __gt__(self, other: 'NewStructure2') -> bool: ...
    def __le__(self, other: 'NewStructure2') -> bool: ...
    def __ge__(self, other: 'NewStructure2') -> bool: ...
...
class NewStructureNested(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __gt__(self, other: 'NewStructureNested') -> bool: ...
    def __le__(self, other: 'NewStructureNested') -> bool: ...
    def __ge__(self, other: 'NewStructureNested') -> bool: ...
...
class NewStructureNestedField(thrift.py3.types.Struct, _typing.Hashable, _typing.Iterable[_typing.Tuple[str, _typing.Any]]):
    ...
    def __gt__(self, other: 'NewStructureNestedField') -> bool: ...
    def __le__(self, other: 'NewStructureNestedField') -> bool: ...
    def __ge__(self, other: 'NewStructureNestedField') -> bool: ...
