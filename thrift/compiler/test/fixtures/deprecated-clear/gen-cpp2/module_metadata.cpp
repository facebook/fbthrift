...
StructMetadata<::apache::thrift::test::StructWithDefaultStruct>::gen(ThriftMetadata& metadata) {
  auto res = metadata.structs_ref()->emplace("module.StructWithDefaultStruct", ::apache::thrift::metadata::ThriftStruct{});
  if (!res.second) {
    return res.first->second;
  }
  ::apache::thrift::metadata::ThriftStruct& module_StructWithDefaultStruct = res.first->second;
  module_StructWithDefaultStruct.name_ref() = "module.StructWithDefaultStruct";
  module_StructWithDefaultStruct.is_union_ref() = false;
  ...
  for (const auto& f : module_StructWithDefaultStruct_fields) {
    ...
    module_StructWithDefaultStruct.fields_ref()->push_back(std::move(field));
  }
  return res.first->second;
}
