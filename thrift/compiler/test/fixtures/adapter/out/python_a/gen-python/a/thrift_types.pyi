...
class MyStruct(_fbthrift_python_types.Struct, _fbthrift_python_abstract_types.MyStruct):
    ...
    def __init__(
        self, *,
        a: typeshed_one.AdapterOneType[_fbthrift__b__thrift_types._fbthrift_unadapted_B]=...,
        b: typeshed_three.AdapterThreeType[_fbthrift__c__thrift_types._fbthrift_unadapted_C1]=...,
        c: typeshed_two.AdapterTwoType[_fbthrift__c__thrift_types.C2]=...
    ) -> None: ...
