...
class _fbthrift_unadapted_AnnotationWithContainers(_fbthrift_python_mutable_types.MutableStruct, _fbthrift_python_abstract_types._fbthrift_unadapted_AnnotationWithContainers):
    ...
    def __init__(
        self, *,
        names: _fbthrift_python_mutable_containers.MutableList[builtins.str] | _fbthrift_python_mutable_types._ThriftListWrapper=...,
        counts: _fbthrift_python_mutable_containers.MutableMap[builtins.str, builtins.int] | _fbthrift_python_mutable_types._ThriftMapWrapper=...
    ) -> None: ...
