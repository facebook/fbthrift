...
class Bar(_fbthrift_python_types.Struct):
    ...
    adaptedStructField: _typing.Final[DirectlyAdapted] = ...
    def __init__(
        self, *,
        ...
        adaptedStructField: _typing.Optional[DirectlyAdapted]=...
    ) -> None: ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[Foo, Foo, _typing.Sequence[Foo], _typing.Sequence[Foo], Baz, Baz, DirectlyAdapted]]]: ...
...
class DirectlyAdapted(_fbthrift_python_types.Struct):
    field: _typing.Final[int] = ...
    def __init__(
        self, *,
    ...
    def _to_python(self) -> DirectlyAdapted: ...
    def _to_py3(self) -> "module.types.DirectlyAdapted": ...  # type: ignore
    def _to_py_deprecated(self) -> "module.ttypes.DirectlyAdapted": ...  # type: ignore
...
class TerseAdaptedFields(_fbthrift_python_types.Struct):
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[str, _typing.Union[int, str, _typing.AbstractSet[int]]]]: ...
    def _to_python(self) -> TerseAdaptedFields: ...
    def _to_py3(self) -> "module.types.TerseAdaptedFields": ...  # type: ignore
