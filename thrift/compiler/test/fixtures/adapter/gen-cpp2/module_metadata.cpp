...
StructMetadata<::cpp2::StructWithFieldAdapter>::gen(ThriftMetadata& metadata) {
  ...
  module_StructWithFieldAdapter_fields[] = {
    ...
    {4, "opt_boxed_field", true, std::make_unique<Primitive>(ThriftPrimitiveType::THRIFT_I32_TYPE), std::vector<ThriftConstStruct>{*cvStruct("cpp.Adapter", {{"name", cvString(R"(my::Adapter1)")}}).cv_struct_ref(), }},
  };
