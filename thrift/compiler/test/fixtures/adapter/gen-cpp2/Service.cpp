...
void ServiceSvIf::async_tm_func(std::unique_ptr<apache::thrift::HandlerCallback<::std::int32_t>> callback, std::unique_ptr<::std::string> p_arg1, std::unique_ptr<::cpp2::Foo> p_arg2) {
  ...
  switch (__fbthrift_invocation_func.load(std::memory_order_relaxed)) {
    case apache::thrift::detail::si::InvocationType::AsyncTm:
    {
      ...
      apache::thrift::detail::si::async_tm_future(std::move(callback), [&] {
        return future_func(std::move(p_arg1), std::move(p_arg2));
      });
      return;
    }
    case apache::thrift::detail::si::InvocationType::SemiFuture:
    {
      apache::thrift::detail::si::async_tm_semifuture(std::move(callback), [&] {
        return semifuture_func(std::move(p_arg1), std::move(p_arg2)); });
      return;
    }
...
std::shared_ptr<folly::RequestContext> ServiceAsyncProcessor::getBaseContextForRequest() {
