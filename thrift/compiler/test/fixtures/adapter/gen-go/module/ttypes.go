...
func (p *Foo)  ReadField5(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptionalSetField = append(p.OptionalSetField, _elem5)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
...
func (p *Foo)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptionalMapField[_key9] = _val10
  }
  if err := iprot.ReadMapEnd(); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
...
func (p *Bar)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem16 := NewFooWithAdapter()
    if err := _elem16.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem16), err)
    }
    p.StructListField = append(p.StructListField, _elem16)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *Bar)  ReadField4(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OptionalStructListField = append(p.OptionalStructListField, _elem17)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *TerseAdaptedFields)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.SetField = append(p.SetField, _elem18)
  }
  if err := iprot.ReadSetEnd(); err != nil {
    return thrift.PrependError("error reading set end: ", err)
  }
