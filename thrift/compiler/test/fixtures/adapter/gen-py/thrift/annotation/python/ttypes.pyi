...
class Adapter:
    ...
    def to_python_struct(self) -> "facebook.thrift.annotation.python.thrift_types.Adapter": ...   # type: ignore
    def to_py3_struct(self) -> "facebook.thrift.annotation.python.types.Adapter": ...   # type: ignore
