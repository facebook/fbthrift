...
class FieldWrapper:
    ...
    def to_python_struct(self) -> "facebook.thrift.annotation.hack.thrift_types.FieldWrapper": ...   # type: ignore
    def to_py3_struct(self) -> "facebook.thrift.annotation.hack.types.FieldWrapper": ...   # type: ignore
...
class Adapter:
    ...
    def __eq__(self, other: __T.Any) -> bool: ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def to_python_struct(self) -> "facebook.thrift.annotation.hack.thrift_types.Adapter": ...   # type: ignore
    def to_py3_struct(self) -> "facebook.thrift.annotation.hack.types.Adapter": ...   # type: ignore
...
class SkipCodegen:
    ...
    def __eq__(self, other: __T.Any) -> bool: ...
    def __ne__(self, other: __T.Any) -> bool: ...
    def to_python_struct(self) -> "facebook.thrift.annotation.hack.thrift_types.SkipCodegen": ...   # type: ignore
    def to_py3_struct(self) -> "facebook.thrift.annotation.hack.types.SkipCodegen": ...   # type: ignore
