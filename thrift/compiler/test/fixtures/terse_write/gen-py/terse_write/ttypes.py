...
__all__ = ['UTF8STRINGS', 'MyEnum', 'MyStruct', 'MyStructWithCustomDefault', 'StructLevelTerseStruct', 'FieldLevelTerseStruct', 'TerseStructWithCustomDefault', 'AdaptedFields', 'MyInteger']
