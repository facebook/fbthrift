...
public final class TerseStructWithCustomDefault implements com.facebook.thrift.payload.ThriftSerializable {
    ...
    public TerseStructWithCustomDefault(
        ...
        @com.facebook.swift.codec.ThriftField(value=10, name="enum_field", requiredness=Requiredness.NONE) final apache.thrift.test.MyEnum enumField,
        ...
        @com.facebook.swift.codec.ThriftField(value=14, name="struct_field", requiredness=Requiredness.NONE) final apache.thrift.test.MyStructWithCustomDefault structField
    ) {
    ...
    protected TerseStructWithCustomDefault() {
      ...
      this.enumField = apache.thrift.test.MyEnum.ME1;
    ...
    public static class Builder {
        ...
        private apache.thrift.test.MyEnum enumField = apache.thrift.test.MyEnum.ME1;
        ...
        .put((short)1, (short)1)
        .build();
        private apache.thrift.test.MyStructWithCustomDefault structField = null;
        ...
        public Builder setStructField(apache.thrift.test.MyStructWithCustomDefault structField) {
            this.structField = structField;
            return this;
        }
    
        public apache.thrift.test.MyStructWithCustomDefault getStructField() { return structField; }
    ...
    private static final TField MAP_FIELD_FIELD_DESC = new TField("map_field", TType.MAP, (short)13);
        private final apache.thrift.test.MyStructWithCustomDefault structField;
      ...
      while (true) {
        ...
        case _STRUCT_FIELD:
          if (__field.type == TType.STRUCT) {
            apache.thrift.test.MyStructWithCustomDefault structField = apache.thrift.test.MyStructWithCustomDefault.read0(oprot);
