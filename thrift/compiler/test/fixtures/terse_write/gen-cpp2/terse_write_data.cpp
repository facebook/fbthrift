...
const std::array<folly::StringPiece, 1> TStructDataStorage<::apache::thrift::test::MyStructWithCustomDefault>::fields_names = {{
  "field1",
}};
const std::array<int16_t, 1> TStructDataStorage<::apache::thrift::test::MyStructWithCustomDefault>::fields_ids = {{
  1,
}};
const std::array<protocol::TType, 1> TStructDataStorage<::apache::thrift::test::MyStructWithCustomDefault>::fields_types = {{
  TType::T_I64,
}};
...
const std::array<folly::StringPiece, 14> TStructDataStorage<::apache::thrift::test::TerseStructWithCustomDefault>::fields_names = {{
  "bool_field",
  "byte_field",
  "short_field",
  "int_field",
...
const std::array<int16_t, 14> TStructDataStorage<::apache::thrift::test::TerseStructWithCustomDefault>::fields_ids = {{
  1,
  2,
  3,
  4,
...
const std::array<protocol::TType, 14> TStructDataStorage<::apache::thrift::test::TerseStructWithCustomDefault>::fields_types = {{
  TType::T_BOOL,
  TType::T_BYTE,
  TType::T_I16,
  TType::T_I32,
