...
cdef class __MyStructWithCustomDefault_FieldsSetter(__StructFieldsSetter):
    ...
    cdef __MyStructWithCustomDefault_FieldsSetter _fbthrift_create(_terse_write_types.cMyStructWithCustomDefault* struct_cpp_obj):
        cdef __MyStructWithCustomDefault_FieldsSetter __fbthrift_inst = __MyStructWithCustomDefault_FieldsSetter.__new__(__MyStructWithCustomDefault_FieldsSetter)
        __fbthrift_inst._struct_cpp_obj = struct_cpp_obj
        __fbthrift_inst._setters[__cstring_view(<const char*>"field1")] = __MyStructWithCustomDefault_FieldsSetter._set_field_0
        return __fbthrift_inst

    cdef void set_field(__MyStructWithCustomDefault_FieldsSetter self, const char* name, object value) except *:
        cdef __cstring_view cname = __cstring_view(name)
        cdef cumap[__cstring_view, __MyStructWithCustomDefault_FieldsSetterFunc].iterator found = self._setters.find(cname)
        if found == self._setters.end():
            raise TypeError(f"invalid field name {name.decode('utf-8')}")
        deref(found).second(self, value)
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        ...
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cMyStructWithCustomDefault](deref(self._struct_cpp_obj), 0)
            return
...
cdef class __TerseStructWithCustomDefault_FieldsSetter(__StructFieldsSetter):
    ...
    cdef __TerseStructWithCustomDefault_FieldsSetter _fbthrift_create(_terse_write_types.cTerseStructWithCustomDefault* struct_cpp_obj):
        cdef __TerseStructWithCustomDefault_FieldsSetter __fbthrift_inst = __TerseStructWithCustomDefault_FieldsSetter.__new__(__TerseStructWithCustomDefault_FieldsSetter)
        __fbthrift_inst._struct_cpp_obj = struct_cpp_obj
        __fbthrift_inst._setters[__cstring_view(<const char*>"bool_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_0
        __fbthrift_inst._setters[__cstring_view(<const char*>"byte_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_1
        __fbthrift_inst._setters[__cstring_view(<const char*>"short_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_2
        __fbthrift_inst._setters[__cstring_view(<const char*>"int_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_3
        __fbthrift_inst._setters[__cstring_view(<const char*>"long_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_4
        __fbthrift_inst._setters[__cstring_view(<const char*>"float_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_5
        __fbthrift_inst._setters[__cstring_view(<const char*>"double_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_6
        __fbthrift_inst._setters[__cstring_view(<const char*>"string_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_7
        __fbthrift_inst._setters[__cstring_view(<const char*>"binary_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_8
        __fbthrift_inst._setters[__cstring_view(<const char*>"enum_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_9
        __fbthrift_inst._setters[__cstring_view(<const char*>"list_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_10
        __fbthrift_inst._setters[__cstring_view(<const char*>"set_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_11
        __fbthrift_inst._setters[__cstring_view(<const char*>"map_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_12
        __fbthrift_inst._setters[__cstring_view(<const char*>"struct_field")] = __TerseStructWithCustomDefault_FieldsSetter._set_field_13
        return __fbthrift_inst

    cdef void set_field(__TerseStructWithCustomDefault_FieldsSetter self, const char* name, object value) except *:
        cdef __cstring_view cname = __cstring_view(name)
        cdef cumap[__cstring_view, __TerseStructWithCustomDefault_FieldsSetterFunc].iterator found = self._setters.find(cname)
        if found == self._setters.end():
            raise TypeError(f"invalid field name {name.decode('utf-8')}")
        deref(found).second(self, value)
    ...
    cdef void _set_field_0(self, _fbthrift_value) except *:
        # for field bool_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 0)
            return
        if not isinstance(_fbthrift_value, bool):
            raise TypeError(f'bool_field is not a { bool !r}.')
        deref(self._struct_cpp_obj).bool_field_ref().assign(_fbthrift_value)
    ...
    cdef void _set_field_1(self, _fbthrift_value) except *:
        # for field byte_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 1)
            return
        if not isinstance(_fbthrift_value, int):
            raise TypeError(f'byte_field is not a { int !r}.')
        _fbthrift_value = <cint8_t> _fbthrift_value
    ...
    cdef void _set_field_2(self, _fbthrift_value) except *:
        # for field short_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 2)
            return
        if not isinstance(_fbthrift_value, int):
            raise TypeError(f'short_field is not a { int !r}.')
        _fbthrift_value = <cint16_t> _fbthrift_value
    ...
    cdef void _set_field_3(self, _fbthrift_value) except *:
        # for field int_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 3)
            return
        if not isinstance(_fbthrift_value, int):
            raise TypeError(f'int_field is not a { int !r}.')
        _fbthrift_value = <cint32_t> _fbthrift_value
    ...
    cdef void _set_field_4(self, _fbthrift_value) except *:
        # for field long_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 4)
            return
        if not isinstance(_fbthrift_value, int):
            raise TypeError(f'long_field is not a { int !r}.')
        _fbthrift_value = <cint64_t> _fbthrift_value
    ...
    cdef void _set_field_5(self, _fbthrift_value) except *:
        # for field float_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 5)
            return
        if not isinstance(_fbthrift_value, (float, int)):
            raise TypeError(f'float_field is not a { float !r}.')
        deref(self._struct_cpp_obj).float_field_ref().assign(_fbthrift_value)
    ...
    cdef void _set_field_6(self, _fbthrift_value) except *:
        # for field double_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 6)
            return
        if not isinstance(_fbthrift_value, (float, int)):
            raise TypeError(f'double_field is not a { float !r}.')
        deref(self._struct_cpp_obj).double_field_ref().assign(_fbthrift_value)
    ...
    cdef void _set_field_7(self, _fbthrift_value) except *:
        # for field string_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 7)
            return
        if not isinstance(_fbthrift_value, str):
            raise TypeError(f'string_field is not a { str !r}.')
        deref(self._struct_cpp_obj).string_field_ref().assign(cmove(bytes_to_string(_fbthrift_value.encode('utf-8'))))
    ...
    cdef void _set_field_8(self, _fbthrift_value) except *:
        # for field binary_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 8)
            return
        if not isinstance(_fbthrift_value, bytes):
            raise TypeError(f'binary_field is not a { bytes !r}.')
        deref(self._struct_cpp_obj).binary_field_ref().assign(cmove(bytes_to_string(_fbthrift_value)))
    ...
    cdef void _set_field_9(self, _fbthrift_value) except *:
        # for field enum_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 9)
            return
        if not isinstance(_fbthrift_value, _terse_write_types.MyEnum):
            raise TypeError(f'field enum_field value: {repr(_fbthrift_value)} is not of the enum type { _terse_write_types.MyEnum }.')
        deref(self._struct_cpp_obj).enum_field_ref().assign(<_terse_write_types.cMyEnum><int>_fbthrift_value)
    ...
    cdef void _set_field_10(self, _fbthrift_value) except *:
        # for field list_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 10)
            return
        deref(self._struct_cpp_obj).list_field_ref().assign(deref(_terse_write_types.List__i16(_fbthrift_value)._cpp_obj))
    ...
    cdef void _set_field_11(self, _fbthrift_value) except *:
        # for field set_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 11)
            return
        deref(self._struct_cpp_obj).set_field_ref().assign(deref(_terse_write_types.Set__i16(_fbthrift_value)._cpp_obj))
    ...
    cdef void _set_field_12(self, _fbthrift_value) except *:
        # for field map_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 12)
            return
        deref(self._struct_cpp_obj).map_field_ref().assign(deref(_terse_write_types.Map__i16_i16(_fbthrift_value)._cpp_obj))
    ...
    cdef void _set_field_13(self, _fbthrift_value) except *:
        # for field struct_field
        if _fbthrift_value is None:
            __reset_field[_terse_write_types.cTerseStructWithCustomDefault](deref(self._struct_cpp_obj), 13)
            return
        if not isinstance(_fbthrift_value, _terse_write_types.MyStructWithCustomDefault):
            raise TypeError(f'struct_field is not a { _terse_write_types.MyStructWithCustomDefault !r}.')
        deref(self._struct_cpp_obj).struct_field_ref().assign(deref((<_terse_write_types.MyStructWithCustomDefault?> _fbthrift_value)._cpp_obj))
