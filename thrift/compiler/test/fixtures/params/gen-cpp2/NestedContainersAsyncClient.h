...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_mapList(const std::map<int32_t, std::vector<int32_t>>& foo);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_mapSet(const std::map<int32_t, std::set<int32_t>>& foo);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_listMap(const std::vector<std::map<int32_t, int32_t>>& foo);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_listSet(const std::vector<std::set<int32_t>>& foo);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_turtles(const std::vector<std::vector<std::map<int32_t, std::map<int32_t, std::set<int32_t>>>>>& foo);
#endif
