...
cdef class Map__i32_Set__i32(thrift.py3.types.Map):
    ...
    def __getitem__(self, key):
        ...
        if iter == deref(self._cpp_obj).end():
            raise err
        cdef shared_ptr[cset[cint32_t]] citem = __reference_shared_ptr(deref(iter).second, self._cpp_obj)
...
cdef class List__Map__i32_i32(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__Map__i32_i32.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
...
cdef class Map__i32_Map__i32_Set__i32(thrift.py3.types.Map):
    ...
    def __getitem__(self, key):
        ...
        if iter == deref(self._cpp_obj).end():
            raise err
        cdef shared_ptr[cmap[cint32_t,cset[cint32_t]]] citem = __reference_shared_ptr(deref(iter).second, self._cpp_obj)
...
cdef class List__Map__i32_Map__i32_Set__i32(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__Map__i32_Map__i32_Set__i32.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
...
cdef class List__List__Map__i32_Map__i32_Set__i32(thrift.py3.types.List):
    ...
    def __getitem__(self, object index_obj):
        ...
        if isinstance(index_obj, slice):
            ...
            for index in range(*index_obj.indices(sz)):
                deref(c_inst).push_back(deref(self._cpp_obj)[index])
            return List__List__Map__i32_Map__i32_Set__i32.create(cmove(c_inst))
        else:
            index = <int?>index_obj
            size = len(self)
            # Convert a negative index
