...
cdef class __Foo_FieldsSetter(__StructFieldsSetter):
    ...
    cdef void _set_field_0(self, __fbthrift_value) except *:
        ...
        deref(self._struct_cpp_obj).myInteger_ref().assign(__fbthrift_value)
    ...
    cdef void _set_field_1(self, __fbthrift_value) except *:
        ...
        deref(self._struct_cpp_obj).myString_ref().assign(cmove(bytes_to_string(__fbthrift_value.encode('utf-8'))))
    ...
    cdef void _set_field_2(self, __fbthrift_value) except *:
        ...
        if __fbthrift_value is None:
            ...
            return
        deref(self._struct_cpp_obj).myBools_ref().assign(deref(_module_types.List__bool(__fbthrift_value)._cpp_obj))
    ...
    cdef void _set_field_3(self, __fbthrift_value) except *:
        ...
        if __fbthrift_value is None:
            ...
            return
        deref(self._struct_cpp_obj).myNumbers_ref().assign(deref(_module_types.List__i32(__fbthrift_value)._cpp_obj))
