...
class Foo:
  ...
  def to_python_struct(self):
    ...
    return thrift.python.converter.to_python_struct(test.namespace_from_package.module.thrift_types.Foo, self)
  def to_py3_struct(self):
    import test.namespace_from_package.module.types
    import thrift.py3.converter
    return thrift.py3.converter.to_py3_struct(test.namespace_from_package.module.types.Foo, self)
