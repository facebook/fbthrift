...
class TestServiceInterface(
    ...
    async def _fbthrift__handler_init(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.namespace_from_package.module.lite_types._fbthrift_TestService_init_args, args, protocol)
        value = await self.init(args_struct.int1,)
        return_struct = test.namespace_from_package.module.lite_types._fbthrift_TestService_init_result(success=value)
