...
void ServiceMetadata<::apache::thrift::ServiceHandler<::test::namespace_from_package::module::TestService>>::gen_init(ThriftMetadata& metadata, ThriftService& service) {
