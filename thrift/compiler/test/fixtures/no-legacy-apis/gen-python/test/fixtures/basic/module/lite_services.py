...
class MyServiceInterface(
    ...
    async def _fbthrift__handler_query(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(test.fixtures.basic.module.lite_types._fbthrift_MyService_query_args, args, protocol)
        value = await self.query(args_struct.u,)
        return_struct = test.fixtures.basic.module.lite_types._fbthrift_MyService_query_result(success=value)
