...
public interface LegacyService extends java.io.Closeable {
    static LegacyService createBlockingClient(
      ...
      final org.apache.thrift.ProtocolId _protocolId) {
        LegacyService.Reactive _delegate = createReactiveClient(
            _rpcClientFactory,
            _socketAddress,
            _protocolId);
    ...
    static LegacyService.Async createAsyncClient(
      final com.facebook.thrift.client.RpcClientFactory _rpcClientFactory,
      final java.net.SocketAddress _socketAddress,
      final org.apache.thrift.ProtocolId _protocolId) {
        LegacyService.Reactive _delegate = createReactiveClient(
    ...
    static LegacyService.Reactive createReactiveClient(
      final com.facebook.thrift.client.RpcClientFactory _rpcClientFactory,
      final java.net.SocketAddress _socketAddress,
      final org.apache.thrift.ProtocolId _protocolId) {
