...
public class CustomException extends Exception implements TBase, java.io.Serializable, Cloneable {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(CustomException.class, metaDataMap);
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof CustomException))
      return false;
    CustomException that = (CustomException)_that;
