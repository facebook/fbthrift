...
public class MyServiceReactiveClient 
  ...
  private static final java.util.Map<Short, com.facebook.swift.transport.payload.Reader> _foo_EXCEPTION_READERS;

  static {
    _foo_EXCEPTION_READERS = java.util.Collections.emptyMap();
  }
