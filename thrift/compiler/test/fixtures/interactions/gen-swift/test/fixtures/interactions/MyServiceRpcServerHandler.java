...
public class MyServiceRpcServerHandler 
  ...
  private final java.util.List<com.facebook.swift.transport.payload.Reader> _fooReaders;
  ...
  public MyServiceRpcServerHandler(MyService.Reactive _delegate,
    ...
    _fooReaders = _createfooReaders();

  }

  private static java.util.List<com.facebook.swift.transport.payload.Reader> _createfooReaders() {
  ...
  private static com.facebook.swift.transport.payload.Writer _createfooWriter(
      final Object _r,
      final com.facebook.swift.service.ContextChain _chain,
      final int _seqId) {
      return oprot -> {
      try {
        oprot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("foo", TMessageType.REPLY, _seqId));
              ...
              _chain.preWrite(_response);
                com.facebook.swift.transport.payload.ServerResponsePayload _serverResponsePayload =
                    com.facebook.swift.transport.util.GeneratedUtil.createServerResponsePayload(
                        _payload,
                        _createfooWriter(_response, _chain, _payload.getMessageSeqId()));
