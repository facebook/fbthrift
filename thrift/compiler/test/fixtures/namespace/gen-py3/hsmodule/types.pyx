...
cdef class HsFoo(thrift.py3.types.Struct):
    def __init__(HsFoo self, **kwargs):
        ...
        self._fields_setter = __fbthrift_types_fields.__HsFoo_FieldsSetter.create(self._cpp_obj.get())
    ...
    def __call__(HsFoo self, **kwargs):
        ...
        __fbthrift_inst._fields_setter = __fbthrift_types_fields.__HsFoo_FieldsSetter.create(__fbthrift_inst._cpp_obj.get())
