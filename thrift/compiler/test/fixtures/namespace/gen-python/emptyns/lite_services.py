...
class TestServiceInterface(
    ...
    def __get_metadata__() -> _fbthrift_metadata.ThriftMetadata:
        return emptyns.lite_metadata.gen_metadata_service_TestService()
    ...
    async def _fbthrift__handler_init(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(emptyns.lite_types._fbthrift_TestService_init_args, args, protocol)
        value = await self.init(args_struct.int1,)
        return_struct = emptyns.lite_types._fbthrift_TestService_init_result(success=value)
