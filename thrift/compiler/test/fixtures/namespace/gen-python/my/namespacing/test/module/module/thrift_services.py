...
import py3lite_module_root.my.namespacing.test.module.module.thrift_types
import py3lite_module_root.my.namespacing.test.module.module.thrift_metadata
...
class TestServiceInterface(
    ...
    def __get_metadata__() -> _fbthrift_metadata.ThriftMetadata:
        return py3lite_module_root.my.namespacing.test.module.module.thrift_metadata.gen_metadata_service_TestService()
    ...
    async def _fbthrift__handler_init(self, args: _fbthrift_iobuf.IOBuf, protocol: Protocol) -> _fbthrift_iobuf.IOBuf:
        args_struct = deserialize(py3lite_module_root.my.namespacing.test.module.module.thrift_types._fbthrift_TestService_init_args, args, protocol)
        value = await self.init(args_struct.int1,)
        return_struct = py3lite_module_root.my.namespacing.test.module.module.thrift_types._fbthrift_TestService_init_result(success=value)
