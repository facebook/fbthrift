...
template <>
class GeneratedEnumMetadata<::test::fixtures::enumstrict::EmptyEnum> {
 public:
  static void genMetadata(ThriftMetadata& metadata);
};
template <>
class GeneratedEnumMetadata<::test::fixtures::enumstrict::MyEnum> {
 public:
  static void genMetadata(ThriftMetadata& metadata);
};
template <>
class GeneratedEnumMetadata<::test::fixtures::enumstrict::MyBigEnum> {
 public:
  static void genMetadata(ThriftMetadata& metadata);
};
