...
folly::SemiFuture<folly::Unit> service2AsyncClient::semifuture_impl_methodA(apache::thrift::RpcOptions& rpcOptions) {
...
folly::SemiFuture<folly::Unit> service2AsyncClient::semifuture_impl_methodB(apache::thrift::RpcOptions& rpcOptions, int32_t x, const  ::test_cpp2::cpp_reflection::struct1& y, double z) {
...
folly::SemiFuture<int32_t> service2AsyncClient::semifuture_impl_methodC(apache::thrift::RpcOptions& rpcOptions) {
...
folly::SemiFuture<int32_t> service2AsyncClient::semifuture_impl_methodD(apache::thrift::RpcOptions& rpcOptions, int32_t i, const  ::test_cpp2::cpp_reflection::struct1& j, double k) {
...
folly::SemiFuture< ::test_cpp2::cpp_reflection::struct2> service2AsyncClient::semifuture_impl_methodE(apache::thrift::RpcOptions& rpcOptions) {
...
folly::SemiFuture< ::test_cpp2::cpp_reflection::struct2> service2AsyncClient::semifuture_impl_methodF(apache::thrift::RpcOptions& rpcOptions, int32_t l, const  ::test_cpp2::cpp_reflection::struct1& m, double n) {
