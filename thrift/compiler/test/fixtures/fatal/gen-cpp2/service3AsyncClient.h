...
private:
  folly::SemiFuture< ::test_cpp2::cpp_reflection::struct3> semifuture_impl_methodF(apache::thrift::RpcOptions& rpcOptions, int32_t l, const  ::test_cpp2::cpp_reflection::struct1& m, double n);
public:
