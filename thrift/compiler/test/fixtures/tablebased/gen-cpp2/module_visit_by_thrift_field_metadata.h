...
template <>
struct VisitByThriftId<::test::fixtures::tablebased::TrivialTypesStruct> {
  ...
  void operator()(FOLLY_MAYBE_UNUSED F&& f, size_t id, FOLLY_MAYBE_UNUSED T&& t) const {
    ...
    default:
      throwInvalidThriftId(id, "::test::fixtures::tablebased::TrivialTypesStruct");
    }
  }
};

template <>
struct VisitByThriftId<::test::fixtures::tablebased::ContainerStruct> {
  template <typename F, typename T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, size_t id, FOLLY_MAYBE_UNUSED T&& t) const {
    switch (id) {
    case 12:
    ...
    default:
      throwInvalidThriftId(id, "::test::fixtures::tablebased::ContainerStruct");
    }
  }
};

template <>
struct VisitByThriftId<::test::fixtures::tablebased::ExampleUnion> {
  template <typename F, typename T>
  void operator()(FOLLY_MAYBE_UNUSED F&& f, size_t id, FOLLY_MAYBE_UNUSED T&& t) const {
    switch (id) {
    case 1:
    ...
    case 2:
      return f(1, static_cast<T&&>(t).fieldB_ref());
    default:
      throwInvalidThriftId(id, "::test::fixtures::tablebased::ExampleUnion");
    }
  }
};
} // namespace detail
