...
struct Foo {
  ...
  5: map<string, ListWithElemAdapter (hack.adapter='\Adapter2')> (hack.adapter='\Adapter3') mapField,
  6: optional map<string, ListWithElemAdapter (hack.adapter='\Adapter2')> (hack.adapter='\Adapter3') optionalMapField,
}
