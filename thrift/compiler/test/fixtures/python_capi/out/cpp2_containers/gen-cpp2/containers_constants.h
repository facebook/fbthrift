...
namespace containers_constants {
  ...
  FOLLY_EXPORT ::std::string_view _fbthrift_schema_a84d0845b28515a9();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_a84d0845b28515a9_includes();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_a84d0845b28515a9_uris();
