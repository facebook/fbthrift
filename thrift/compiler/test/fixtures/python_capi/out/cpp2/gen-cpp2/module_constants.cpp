...
::std::string_view _fbthrift_schema_73f898e6d9db41b7() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_73f898e6d9db41b7_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_73f898e6d9db41b7_uris() {
  return {};
}
