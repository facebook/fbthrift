...
::std::string_view _fbthrift_schema_128b73613a852606() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_128b73613a852606_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_128b73613a852606_uris() {
  return {};
}
