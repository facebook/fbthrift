...
class ListStruct(_fbthrift_python_types.Struct, _fbthrift_python_abstract_types.ListStruct):
    ...
    ucharz: _typing.Final[_fbthrift_python_types.ImmutableList[small_vector_uint8]] = ...
    voxels: _typing.Final[_fbthrift_python_types.ImmutableList[fbvector2_uint8]] = ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[builtins.str, _typing.Union[_fbthrift_python_types.ImmutableList[builtins.bool], _fbthrift_python_types.ImmutableList[builtins.int], _fbthrift_python_types.ImmutableList[builtins.str], _fbthrift_python_types.ImmutableList[builtins.bytes], _fbthrift_python_types.ImmutableList[builtins.int], _fbthrift_python_types.ImmutableList[_fbthrift_python_types.ImmutableList[builtins.float]], _fbthrift_python_types.ImmutableList[small_vector_uint8], _fbthrift_python_types.ImmutableList[fbvector2_uint8], _fbthrift_python_types.ImmutableList[_fbthrift_iobuf.IOBuf]]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
class MapStruct(_fbthrift_python_types.Struct, _fbthrift_python_abstract_types.MapStruct):
    ...
    fast_list_map: _typing.Final[_fbthrift_python_types.ImmutableMap[builtins.int, fbvector_double]] = ...
    ...
    def __iter__(self) -> _typing.Iterator[_typing.Tuple[builtins.str, _typing.Union[_fbthrift_python_types.ImmutableMap[_fbthrift_MyEnum, builtins.str], _fbthrift_python_types.ImmutableMap[builtins.int, builtins.str], _fbthrift_python_types.ImmutableMap[builtins.bytes, _fbthrift_PrimitiveStruct], _fbthrift_python_types.ImmutableMap[builtins.str, builtins.float], _fbthrift_python_types.ImmutableMap[builtins.int, builtins.float], _fbthrift_python_types.ImmutableList[_fbthrift_python_types.ImmutableMap[builtins.int, builtins.int]], _fbthrift_python_types.ImmutableMap[builtins.int, _fbthrift_python_types.ImmutableList[builtins.int]], _fbthrift_python_types.ImmutableMap[builtins.int, fbvector_double], _fbthrift_python_types.ImmutableMap[builtins.bytes, _fbthrift_iobuf.IOBuf], _fbthrift_python_types.ImmutableMap[builtins.int, _fbthrift_python_types.ImmutableList[builtins.int]]]]]: ...
    def _to_python(self) -> _typing.Self: ...
...
ui64 = builtins.int
uint8 = builtins.int
class small_vector_uint8(_fbthrift_python_types.ImmutableList[builtins.int]):
    def __init__(self, __items: _typing.Sequence[builtins.int] = ...) -> None: ...

class fbvector_uint8(_fbthrift_python_types.ImmutableList[builtins.int]):
    def __init__(self, __items: _typing.Sequence[builtins.int] = ...) -> None: ...

class fbvector2_uint8(_fbthrift_python_types.ImmutableList[fbvector_uint8]):
    def __init__(self, __items: _typing.Sequence[_typing.Sequence[builtins.int]] = ...) -> None: ...

class fbvector_double(_fbthrift_python_types.ImmutableList[builtins.float]):
