...
class List__module_MyStruct(_typing.Sequence[_module_types.MyStruct]):
    def __init__(self, items: _typing.Sequence[_module_types.MyStruct]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def count(self, item: _module_types.MyStruct) -> int: ...
...
class List__List__module_MyStruct(_typing.Sequence[_typing.Sequence[_module_types.MyStruct]]):
    def __init__(self, items: _typing.Sequence[_typing.Sequence[_module_types.MyStruct]]=None) -> None: ...
    def __repr__(self) -> str: ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def count(self, item: _typing.Sequence[_module_types.MyStruct]) -> int: ...
