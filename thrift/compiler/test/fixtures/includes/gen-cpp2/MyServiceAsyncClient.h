...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_query(const  ::cpp2::MyStruct& s, const  ::cpp2::Included& i);
#endif
...
#if FOLLY_HAS_COROUTINES
  virtual folly::coro::Task<void> co_has_arg_docs(const  ::cpp2::MyStruct& s, const  ::cpp2::Included& i);
#endif
