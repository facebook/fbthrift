...
class Included final  {
 ...
 public:
  ...
  Included() :
      ...
      __fbthrift_field_MyTransitiveField(static_cast<::cpp2::Foo>(::apache::thrift::detail::make_constant< ::cpp2::Foo>(::apache::thrift::detail::wrap_struct_argument<::apache::thrift::tag::a>(static_cast<::std::int64_t>(2))))) {
  }
