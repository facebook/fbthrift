...
struct ForEachField<::cpp2::MyStruct> {
  ...
  void operator()(FOLLY_MAYBE_UNUSED F&& f, FOLLY_MAYBE_UNUSED T&&... t) const {
    ...
    f(get_metadata(0), static_cast<T&&>(t).MyIncludedField_ref()...);
    f(get_metadata(1), static_cast<T&&>(t).MyOtherIncludedField_ref()...);
    f(get_metadata(2), static_cast<T&&>(t).MyIncludedInt_ref()...);
  }
};
} // namespace detail
} // namespace thrift
