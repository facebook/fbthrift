...
::std::string_view _fbthrift_schema_da36d810d11e1f44() {
  return "";
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_da36d810d11e1f44_includes() {
  return {};
}
::folly::Range<const ::std::string_view*> _fbthrift_schema_da36d810d11e1f44_uris() {
  return {};
}
