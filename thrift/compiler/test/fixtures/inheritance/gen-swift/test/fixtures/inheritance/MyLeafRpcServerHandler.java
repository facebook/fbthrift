...
public class MyLeafRpcServerHandler  extends test.fixtures.inheritance.MyNodeRpcServerHandler
  ...
  private final java.util.List<com.facebook.swift.transport.payload.Reader> _doLeafReaders;
  ...
  public MyLeafRpcServerHandler(MyLeaf _delegate,
    ...
    this(new MyLeafBlockingReactiveWrapper(_delegate, _scheduler), _eventHandlers);
  }
  ...
  private static java.util.List<com.facebook.swift.transport.payload.Reader> _createdoLeafReaders() {
  ...
  private static com.facebook.swift.transport.payload.Writer _createdoLeafWriter(
      final Object _r,
