...
private:
  folly::SemiFuture<folly::Unit> semifuture_impl_do_leaf(apache::thrift::RpcOptions& rpcOptions);
public:
  ...
  folly::coro::Task<void> co_do_leaf() {
    ...
    if (cancelToken.canBeCancelled()) {
      co_await folly::coro::detachOnCancel(semifuture_impl_do_leaf(rpcOptions));
    } else {
      co_await semifuture_impl_do_leaf(rpcOptions);
    }
  }
  template <int = 0>
