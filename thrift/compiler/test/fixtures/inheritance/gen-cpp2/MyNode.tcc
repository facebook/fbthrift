...
void MyNodeAsyncProcessor::_processInThread_do_mid(std::unique_ptr<apache::thrift::ResponseChannel::Request> req, std::unique_ptr<folly::IOBuf> buf, std::unique_ptr<ProtocolIn_> iprot, apache::thrift::Cpp2RequestContext* ctx, apache::thrift::async::TEventBase* eb, apache::thrift::concurrency::ThreadManager* tm) {
...
template <typename ProtocolIn_, typename ProtocolOut_>
void MyNodeAsyncProcessor::process_do_mid(std::unique_ptr<apache::thrift::ResponseChannel::Request> req, std::unique_ptr<folly::IOBuf> buf, std::unique_ptr<ProtocolIn_> iprot,apache::thrift::Cpp2RequestContext* ctx,apache::thrift::async::TEventBase* eb, apache::thrift::concurrency::ThreadManager* tm) {
  ...
  try {
    ...
    if (req) {
      ...
      folly::IOBufQueue queue = serializeException("do_mid", &prot, iprot->getSeqId(), nullptr, x);
  ...
  auto callback = folly::make_unique<apache::thrift::HandlerCallback<void>>(std::move(req), std::move(c), return_do_mid<ProtocolIn_,ProtocolOut_>, throw_do_mid<ProtocolIn_, ProtocolOut_>, throw_wrapped_do_mid<ProtocolIn_, ProtocolOut_>, iprot->getSeqId(), eb, tm, ctx);
...
void MyNodeAsyncClient::do_midT(Protocol_* prot, apache::thrift::RpcOptions& rpcOptions, std::unique_ptr<apache::thrift::RequestCallback> callback) {
  ...
  MyNode_do_mid_pargs args;
  apache::thrift::clientSendT<false>(prot, rpcOptions, std::move(callback), std::move(ctx), channel_.get(), args, "do_mid", [](Protocol_* prot, MyNode_do_mid_pargs& args) { args.write(prot); }, [](Protocol_* prot, MyNode_do_mid_pargs& args) { return args.serializedSizeZC(prot); });
}
