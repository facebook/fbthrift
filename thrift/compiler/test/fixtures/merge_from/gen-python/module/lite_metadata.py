...
def _fbthrift_gen_metadata_struct_FieldsInjectedToEmptyStruct(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    struct_dict[qualified_name] = _fbthrift_metadata.ThriftStruct(name=qualified_name, fields=fields,
        is_union=False,
        structured_annotations=[
            _fbthrift_metadata.ThriftConstStruct(type=_fbthrift_metadata.ThriftStructType(name="meta.MergeFrom"), fields= { "type": _fbthrift_metadata.ThriftConstValue(cv_string="Fields"),  }),
        ])
    new_struct = metadata_struct(structs=struct_dict)
...
def _fbthrift_gen_metadata_struct_FieldsInjectedWithIncludedStruct(metadata_struct: _fbthrift_metadata.ThriftMetadata) -> _fbthrift_metadata.ThriftMetadata:
    ...
    struct_dict[qualified_name] = _fbthrift_metadata.ThriftStruct(name=qualified_name, fields=fields,
        is_union=False,
        structured_annotations=[
            _fbthrift_metadata.ThriftConstStruct(type=_fbthrift_metadata.ThriftStructType(name="meta.MergeFrom"), fields= { "type": _fbthrift_metadata.ThriftConstValue(cv_string="foo.Fields"),  }),
        ])
    new_struct = metadata_struct(structs=struct_dict)
