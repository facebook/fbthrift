...
public class SinkException1 extends Exception implements TBase, java.io.Serializable, Cloneable {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(SinkException1.class, metaDataMap);
  }
   ...
   */
  public SinkException1(SinkException1 other) {
    if (other.isSetReason()) {
      this.reason = TBaseHelper.deepCopy(other.reason);
    }
  }

  public SinkException1 deepCopy() {
    return new SinkException1(this);
  }
  ...
  public SinkException1 setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof SinkException1))
      return false;
    SinkException1 that = (SinkException1)_that;
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("SinkException1");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
