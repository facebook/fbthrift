...
public class InitialResponse implements TBase, java.io.Serializable, Cloneable, Comparable<InitialResponse> {
  ...
  static {
    FieldMetaData.addStructMetaDataMap(InitialResponse.class, metaDataMap);
  }
   ...
   */
  public InitialResponse(InitialResponse other) {
    if (other.isSetContent()) {
      this.content = TBaseHelper.deepCopy(other.content);
    }
  }

  public InitialResponse deepCopy() {
  ...
  public InitialResponse setContent(String content) {
    this.content = content;
    return this;
  }
  ...
  public boolean equals(Object _that) {
    ...
    if (this == _that)
      return true;
    if (!(_that instanceof InitialResponse))
      return false;
    InitialResponse that = (InitialResponse)_that;
  ...
  @Override
  public int compareTo(InitialResponse other) {
    if (other == null) {
  ...
  public String toString(int indent, boolean prettyPrint) {
    ...
    StringBuilder sb = new StringBuilder("InitialResponse");
    sb.append(space);
    sb.append("(");
    sb.append(newLine);
    boolean first = true;
