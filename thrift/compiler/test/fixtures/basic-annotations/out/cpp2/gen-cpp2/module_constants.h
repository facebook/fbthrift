...
namespace module_constants {
  ...
  FOLLY_EXPORT ::std::string_view _fbthrift_schema_8e9bb0eac1256f47();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_8e9bb0eac1256f47_includes();
  FOLLY_EXPORT ::folly::Range<const ::std::string_view*> _fbthrift_schema_8e9bb0eac1256f47_uris();
