...
class MyServicePrioChildAsyncClient : public ::cpp2::MyServicePrioParentAsyncClient {
 ...
 private:
  ...
  void pangT(Protocol_* prot, apache::thrift::RpcOptions rpcOptions, std::shared_ptr<apache::thrift::transport::THeader> header, apache::thrift::ContextStack* contextStack, apache::thrift::RequestClientCallback::Ptr callback);
