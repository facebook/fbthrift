...
pub mod server {
    ...
    #[derive(Clone, Debug)]
    pub struct MyServiceProcessor<P, H, R, CS> {
        service: H,
        supa: ::fbthrift::NullServiceProcessor<P, R>,
        _phantom: ::std::marker::PhantomData<(P, H, R, CS)>,
    }

    impl<P, H, R, CS> MyServiceProcessor<P, H, R, CS>
    where
    ...
    #[::async_trait::async_trait]
    impl<P, H, R, CS> ::fbthrift::ServiceProcessor<P> for MyServiceProcessor<P, H, R, CS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        H: MyService,
    ...
    #[::async_trait::async_trait]
    impl<P, H, R, CS> ::fbthrift::ThriftService<P::Frame> for MyServiceProcessor<P, H, R, CS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
    ...
    pub fn make_MyService_server<F, H, R, CS>(
        ...
        CS: ::fbthrift::ContextStack + ::std::marker::Send + ::std::marker::Sync + 'static
    {
        match proto {
            ::fbthrift::ProtocolID::BinaryProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(MyServiceProcessor::<::fbthrift::BinaryProtocol<F>, H, R, CS>::new(handler)))
            }
            ::fbthrift::ProtocolID::CompactProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(MyServiceProcessor::<::fbthrift::CompactProtocol<F>, H, R, CS>::new(handler)))
            }
    ...
    #[derive(Clone, Debug)]
    pub struct MyServicePrioParentProcessor<P, H, R, CS> {
        service: H,
        supa: ::fbthrift::NullServiceProcessor<P, R>,
        _phantom: ::std::marker::PhantomData<(P, H, R, CS)>,
    }

    impl<P, H, R, CS> MyServicePrioParentProcessor<P, H, R, CS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
    ...
    #[::async_trait::async_trait]
    impl<P, H, R, CS> ::fbthrift::ServiceProcessor<P> for MyServicePrioParentProcessor<P, H, R, CS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        H: MyServicePrioParent,
    ...
    #[::async_trait::async_trait]
    impl<P, H, R, CS> ::fbthrift::ThriftService<P::Frame> for MyServicePrioParentProcessor<P, H, R, CS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        P::Frame: ::std::marker::Send + 'static,
    ...
    pub fn make_MyServicePrioParent_server<F, H, R, CS>(
        proto: ::fbthrift::ProtocolID,
        handler: H,
    ) -> ::std::result::Result<::std::boxed::Box<dyn ::fbthrift::ThriftService<F, Handler = H, RequestContext = R> + ::std::marker::Send + 'static>, ::fbthrift::ApplicationException>
    where
        ...
        CS: ::fbthrift::ContextStack + ::std::marker::Send + ::std::marker::Sync + 'static
    {
        match proto {
            ::fbthrift::ProtocolID::BinaryProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(MyServicePrioParentProcessor::<::fbthrift::BinaryProtocol<F>, H, R, CS>::new(handler)))
            }
            ::fbthrift::ProtocolID::CompactProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(MyServicePrioParentProcessor::<::fbthrift::CompactProtocol<F>, H, R, CS>::new(handler)))
            }
            bad => ::std::result::Result::Err(::fbthrift::ApplicationException::invalid_protocol(bad)),
        }
    }
    ...
    #[derive(Clone, Debug)]
    pub struct MyServicePrioChildProcessor<P, H, R, CS, SS> {
        service: H,
        supa: SS,
        _phantom: ::std::marker::PhantomData<(P, H, R, CS)>,
    }

    impl<P, H, R, CS, SS> MyServicePrioChildProcessor<P, H, R, CS, SS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
    ...
    #[::async_trait::async_trait]
    impl<P, H, R, CS, SS> ::fbthrift::ServiceProcessor<P> for MyServicePrioChildProcessor<P, H, R, CS, SS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        H: MyServicePrioChild,
    ...
    #[::async_trait::async_trait]
    impl<P, H, R, CS, SS> ::fbthrift::ThriftService<P::Frame> for MyServicePrioChildProcessor<P, H, R, CS, SS>
    where
        P: ::fbthrift::Protocol + ::std::marker::Send + ::std::marker::Sync + 'static,
        P::Deserializer: ::std::marker::Send,
        P::Frame: ::std::marker::Send + 'static,
    ...
    pub fn make_MyServicePrioChild_server<F, H, R, CS, SMAKE, SS>(
        proto: ::fbthrift::ProtocolID,
        handler: H,
        supa: SMAKE,
    ) -> ::std::result::Result<::std::boxed::Box<dyn ::fbthrift::ThriftService<F, Handler = H, RequestContext = R> + ::std::marker::Send + 'static>, ::fbthrift::ApplicationException>
        ...
        CS: ::fbthrift::ContextStack + ::std::marker::Send + ::std::marker::Sync + 'static
    {
        match proto {
            ::fbthrift::ProtocolID::BinaryProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(MyServicePrioChildProcessor::<::fbthrift::BinaryProtocol<F>, H, R, CS, SS>::new(handler, supa(proto)?)))
            }
            ::fbthrift::ProtocolID::CompactProtocol => {
                ::std::result::Result::Ok(::std::boxed::Box::new(MyServicePrioChildProcessor::<::fbthrift::CompactProtocol<F>, H, R, CS, SS>::new(handler, supa(proto)?)))
            }
            bad => ::std::result::Result::Err(::fbthrift::ApplicationException::invalid_protocol(bad)),
        }
    }
