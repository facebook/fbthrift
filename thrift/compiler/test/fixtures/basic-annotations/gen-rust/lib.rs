...
pub mod client {
        ...
        P::Deserializer: ::std::marker::Send,
    {
        ...
        fn ping(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("ping", &args).expect("serialize failed");
        ...
        fn getRandomData(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("getRandomData", &args).expect("serialize failed");
        ...
        fn hasDataById(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("hasDataById", &args).expect("serialize failed");
        ...
        fn getDataById(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("getDataById", &args).expect("serialize failed");
        ...
        fn putDataById(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("putDataById", &args).expect("serialize failed");
        ...
        fn lobDataById(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("lobDataById", &args).expect("serialize failed");
        ...
        fn doNothing(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("doNothing", &args).expect("serialize failed");

            self.transport()
                .call(SERVICE_NAME.as_cstr(), METHOD_NAME.as_cstr(), request)
                .instrument(::tracing::info_span!("call", function = "MyService.doNothing"))
                .map_err(::std::convert::From::from)
                .and_then(|reply| {
                        let de = P::deserializer(reply);
                        (move |mut p: P::Deserializer| {
                            ...
                            match message_type {
                                ::fbthrift::MessageType::Reply => {
                                    let exn: ::tokio_shim::task::JoinHandle<(Result<crate::services::my_service::DoNothingExn, _>, _)> =
                                        ::tokio_shim::task::spawn_blocking_fallback_inline(move || (::fbthrift::Deserialize::read(&mut p), p));
                                    ::futures::future::Either::Right(exn.then(
                                        |exn| {
                                            let result = (move || {
                                                ...
                                                let exn = exn?;
                                                let result = match exn {
                                                    crate::services::my_service::DoNothingExn::Success(x) => {
                                                        ::tracing::info!("success");
                                                        ::std::result::Result::Ok(x)
                                                    },
                    ...
                    .instrument(::tracing::trace_span!("deserialize_response", method = "MyService.doNothing"))
                )
                .boxed()
        }
    }
        ...
        P::Deserializer: ::std::marker::Send,
    {
        ...
        fn ping(
            ...
            self.transport()
                .call(SERVICE_NAME.as_cstr(), METHOD_NAME.as_cstr(), request)
                .instrument(::tracing::info_span!("call", function = "MyServicePrioParent.ping"))
                .map_err(::std::convert::From::from)
                .and_then(|reply| {
                        let de = P::deserializer(reply);
                        (move |mut p: P::Deserializer| {
                            ...
                            match message_type {
                                ::fbthrift::MessageType::Reply => {
                                    let exn: ::tokio_shim::task::JoinHandle<(Result<crate::services::my_service_prio_parent::PingExn, _>, _)> =
                                        ::tokio_shim::task::spawn_blocking_fallback_inline(move || (::fbthrift::Deserialize::read(&mut p), p));
                                    ::futures::future::Either::Right(exn.then(
                                        |exn| {
                                            let result = (move || {
                                                ...
                                                let exn = exn?;
                                                let result = match exn {
                                                    crate::services::my_service_prio_parent::PingExn::Success(x) => {
                                                        ::tracing::info!("success");
                                                        ::std::result::Result::Ok(x)
                                                    },
                    ...
                    .instrument(::tracing::trace_span!("deserialize_response", method = "MyServicePrioParent.ping"))
                )
                .boxed()
        }
        ...
        fn pong(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("pong", &args).expect("serialize failed");

            self.transport()
                .call(SERVICE_NAME.as_cstr(), METHOD_NAME.as_cstr(), request)
                .instrument(::tracing::info_span!("call", function = "MyServicePrioParent.pong"))
                .map_err(::std::convert::From::from)
                .and_then(|reply| {
                        let de = P::deserializer(reply);
                        (move |mut p: P::Deserializer| {
                            ...
                            match message_type {
                                ::fbthrift::MessageType::Reply => {
                                    let exn: ::tokio_shim::task::JoinHandle<(Result<crate::services::my_service_prio_parent::PongExn, _>, _)> =
                                        ::tokio_shim::task::spawn_blocking_fallback_inline(move || (::fbthrift::Deserialize::read(&mut p), p));
                                    ::futures::future::Either::Right(exn.then(
                                        |exn| {
                                            let result = (move || {
                                                ...
                                                let exn = exn?;
                                                let result = match exn {
                                                    crate::services::my_service_prio_parent::PongExn::Success(x) => {
                                                        ::tracing::info!("success");
                                                        ::std::result::Result::Ok(x)
                                                    },
                    ...
                    .instrument(::tracing::trace_span!("deserialize_response", method = "MyServicePrioParent.pong"))
                )
                .boxed()
        }
    }
        ...
        P::Deserializer: ::std::marker::Send,
    {
        ...
        fn pang(
            ...
            let request = ::fbthrift::help::serialize_request_envelope::<P, _>("pang", &args).expect("serialize failed");

            self.transport()
                .call(SERVICE_NAME.as_cstr(), METHOD_NAME.as_cstr(), request)
                .instrument(::tracing::info_span!("call", function = "MyServicePrioChild.pang"))
                .map_err(::std::convert::From::from)
                .and_then(|reply| {
                        let de = P::deserializer(reply);
                        (move |mut p: P::Deserializer| {
                            ...
                            match message_type {
                                ::fbthrift::MessageType::Reply => {
                                    let exn: ::tokio_shim::task::JoinHandle<(Result<crate::services::my_service_prio_child::PangExn, _>, _)> =
                                        ::tokio_shim::task::spawn_blocking_fallback_inline(move || (::fbthrift::Deserialize::read(&mut p), p));
                                    ::futures::future::Either::Right(exn.then(
                                        |exn| {
                                            let result = (move || {
                                                ...
                                                let exn = exn?;
                                                let result = match exn {
                                                    crate::services::my_service_prio_child::PangExn::Success(x) => {
                                                        ::tracing::info!("success");
                                                        ::std::result::Result::Ok(x)
                                                    },
                    ...
                    .instrument(::tracing::trace_span!("deserialize_response", method = "MyServicePrioChild.pang"))
                )
                .boxed()
        }
    }
